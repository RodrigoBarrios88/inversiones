							...
							<tr>
								...
								<?php
									...
									foreach($result_secciones as $row){
										...
										$salida.= '<a class="btn btn-primary btn-block" href="FRMlistficha.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'" title = "Seleccionar Secci&oacute;n" ><i class="fa fa-chevron-right"></i></a>';
										$salida.= '</td>';
										//--
										$salida.= '</tr>';
										$i++;
