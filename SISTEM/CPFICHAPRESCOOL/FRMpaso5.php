									...
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad mantuvo firme la cabeza?</label> <br>
													<label class="respuesta"><?php echo $cabeza; ?> meses</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad se sent&oacute; sin apoyo?</label> <br>
													<label class="respuesta"><?php echo $sento; ?> meses</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad camin&oacute;?</label> <br>
													<label class="respuesta"><?php echo $camino; ?> meses</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o gateo?</label><br>
													<label class="respuesta"><?php echo $gateo; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Manifest&oacute; balance&oacute; corporal con frecuencia?</label><br>
													<label class="respuesta"><?php echo $balanceo; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o babe&oacute; con exceso?</label><br>
													<label class="respuesta"><?php echo $babeo; ?></label>
												</div>
											</div>
									</div>
								 </div>
