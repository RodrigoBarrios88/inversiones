					...
					<div class="row">
						...
						<div class="tab-content">
							...
							<div class="col-lg-12 col-xs-12 ext-center">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-reddit"></i> &nbsp;  Lactancia
										<?php echo $actualizado; ?>
									</div>
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tom&oacute; pecho?</label><br>
													<label class="respuesta"><?php echo $pecho; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tom&oacute; biber&oacute;n o pacha?</label><br>
													<label class="respuesta"><?php echo $pacha; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padeci&oacute; de v&oacute;mitos?</label><br>
													<label class="respuesta"><?php echo $vomitos; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padeci&oacute; de c&oacute;licos?</label><br>
													<label class="respuesta"><?php echo $colicos; ?> </label>
												</div>
											</div>
									</div>
								 </div>
