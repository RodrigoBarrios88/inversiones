					...
					<div class="row">
						...
						<div class="tab-content">
							...
							<div class="col-lg-12 col-xs-12 ext-center">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-hospital-o"></i> &nbsp;  Parto
										<?php echo $actualizado; ?>
									</div>
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Tipo de Parto</label><br>
													<label class="respuesta"><?php echo $tipo; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Con anestesia?</label><br>
													<label class="respuesta"><?php echo $anestesia; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Inducido?</label><br>
													<label class="respuesta"><?php echo $inducido; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Con f&oacute;rceps?</label><br>
													<label class="respuesta"><?php echo $forceps; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
