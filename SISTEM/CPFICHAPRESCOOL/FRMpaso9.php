									...
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o usa lentes?</label><br>
													<label class="respuesta"><?php echo $lentes; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Si usa, &iquest;para que los usa?</label> <br>
													<label class="respuesta"><?php echo $uso; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padece de ojos irritados?</label><br>
													<label class="respuesta"><?php echo $irritacion; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Secreci&oacute;n en los ojos?</label><br>
													<label class="respuesta"><?php echo $secrecion; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Se acerca demasiado al papel?</label><br>
													<label class="respuesta"><?php echo $se_acerca; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padece de dolor de cabeza?</label><br>
													<label class="respuesta"><?php echo $dolor; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Desviaciones oculares?</label><br>
													<label class="respuesta"><?php echo $desviacion; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Otras afecciones?</label> <br>
													<label class="respuesta"><?php echo $otro; ?> </label>
												</div>
											</div>
									</div>
								 </div>
