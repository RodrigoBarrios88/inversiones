									...
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Fue planificado?</label><br>
													<label class="respuesta"><?php echo $planificado; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Respecto a la duraci&oacute;n</label><br>
													<label class="respuesta"><?php echo $duracion; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tuvo complicaciones durante el embarazo?</label><br>
													<label class="respuesta"><?php echo $complicaciones; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Tipo de complicaciones</label> <br>
													<label class="respuesta"><?php echo $tipo_complicaciones; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tomaron radiograf&iacute;as o rayos "X"?</label><br>
													<label class="respuesta"><?php echo $rayos_x; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Sufri&oacute; depresi&oacute;n o exceso de tensi&oacute;n?</label><br>
													<label class="respuesta"><?php echo $depresion; ?></label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Otra Afecci&oacute;n?</label> <br>
													<label class="respuesta"><?php echo $otros; ?></label>
												</div>
											</div>
									</div>
								 </div>
