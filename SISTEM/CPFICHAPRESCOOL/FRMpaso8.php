					...
					<div class="row">
						...
						<div class="tab-content">
							...
							<div class="col-lg-12 col-xs-12 ext-center">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-spoon"></i> &nbsp; Alimentaci&oacute;n
										<?php echo $actualizado; ?>
									</div>
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come solo?</label><br>
													<label class="respuesta"><?php echo $solo; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come en exceso?</label><br>
													<label class="respuesta"><?php echo $exceso; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come poco?</label><br>
													<label class="respuesta"><?php echo $poco; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Al ni&ntilde;o lo obligan a comer?</label><br>
													<label class="respuesta"><?php echo $obligado; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o le exigen h&aacute;bitos en la mesa?</label><br>
													<label class="respuesta"><?php echo $habitos; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Peso (en libras): </label> <br>
													<label class="respuesta"><?php echo $peso; ?> metros.</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Talla (en metros):</label> <br>
													<label class="respuesta"><?php echo $talla; ?> libras.</label>
												</div>
											</div>
									</div>
								 </div>
