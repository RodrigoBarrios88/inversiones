									...
									<div class="panel-body">
										<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A qu&eacute; edad asisti&oacute; por primera vez al colegio?</label><br>
													<label class="respuesta"><?php echo $edad_colegio; ?> a&ntilde;o(s)</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Se adapto?</label><br>
													<label class="respuesta"><?php echo $adaptado; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Es alumno repitente?</label><br>
													<label class="respuesta"><?php echo $repitente; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Que grado a repetido?</label> <br>
													<label class="respuesta"><?php echo $repite_grado; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;En que colegios ha estado?</label> <br>
													<label class="respuesta"><?php echo $colegios_anteriores; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Porque fue retirado?</label> <br>
													<label class="respuesta"><?php echo $retirado_por; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Por qu&eacute; eligi&oacute; usted este colegio?</label><br>
													<label class="respuesta"><?php echo $porque_este; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tiene hermanos en el colegio?</label><br>
													<label class="respuesta"><?php echo $hermanos_aqui; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Quien(es) ha(n) estudiado en este colegio?</label><br>
													<label class="respuesta"><?php echo $estudiaron_aqui; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Cu&aacute;ntos hermanos tiene el ni&ntilde;o?</label><br>
													<label class="respuesta"><?php echo $hermanos; ?> hermano(s)</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Que lugar ocupa entre ellos?</label><br>
													<label class="respuesta">No. <?php echo $lugar_hermanos; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o vive con?</label><br>
													<label class="respuesta"><?php echo $vive_con; ?> </label>
												</div>
											</div>
									</div>
								 </div>
