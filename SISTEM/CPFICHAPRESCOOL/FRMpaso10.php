									...
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Afecciones y padecimientos del o&iacute;do?</label> <br>
													<label class="respuesta"><?php echo $afecciones; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Cuales? especifique</label> <br>
													<label class="respuesta"><?php echo $cuales; ?> </label>
												</div>
											</div>
											
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Hace esfuerzos para escuchar?</label> <br>
													<label class="respuesta"><?php echo $esfuerzo; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Responde cuando no esta viendo a la persona?</label> <br>
													<label class="respuesta"><?php echo $responde; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Manifiesta frecuentemente no haber escuchado una orden o instrucci&oacute;n?</label> <br>
													<label class="respuesta"><?php echo $no_escucha; ?> </label>
												</div>
											</div>
									</div>
								 </div>
