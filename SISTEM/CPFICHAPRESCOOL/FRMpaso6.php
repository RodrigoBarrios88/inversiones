									...
									<div class="panel-body">
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad empez&oacute; su dentici&oacute;n?</label> <br>
													<label class="respuesta"><?php echo $dientes; ?> meses.</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad empez&oacute; a balbucear?</label> <br>
													<label class="respuesta"><?php echo $balbuceo; ?> meses.</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad empez&oacute; a decir sus primeras palabras?</label> <br>
													<label class="respuesta"><?php echo $palabras; ?> meses.</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad empez&oacute; a decir sus primeras oraciones?</label> <br>
													<label class="respuesta"><?php echo $oraciones; ?> meses.</label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o articula bien todas las palabras?</label><br>
													<label class="respuesta"><?php echo $articula; ?> </label>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Comprende lo que se le dice?</label><br>
													<label class="respuesta"><?php echo $entiende; ?> </label>
												</div>
											</div>
									</div>
								 </div>
