			...
			<div class="panel panel-default">
				...
				<div class="panel-body"> 
					...
					<div class="text-center">
					    <br>
                        <!--<button type="button" class="btn btn-success" onclick = "Exportar();"><span class="fa fa-file-excel-o"></span> Exportar</button>		-->			</div>
					<br>
				</div>
			</div>
			<div class="row">
					<?php
						if( $materia != "" && $unidad != ""){
								echo tabla_secciones_ver_notas_sabana($cod,$pensum,$nivel,$grado,$seccion,$materia,$maestro,$unidad,$tipo,$sit);
   ...
   <script>
	   ...
	   function Exportar(){
			...
			if(materia.value !== ""){
				...
				myform.action ="CPREPORTES/EXCELsabana.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
