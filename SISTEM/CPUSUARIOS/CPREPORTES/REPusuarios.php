...
include_once('html_fns_reportes.php');
	...
	$pdf->Ln(10);
	////////////////////////////////////// ENCABEZADOS ///////////////////////////////////////////
	$pdf->SetWidths(array(10, 20, 50, 50, 50, 25, 40, 25));  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
	...
	////////////////////////////////////// CUERPO ///////////////////////////////////////////
	$pdf->SetWidths(array(10, 20, 50, 50, 50, 25, 40, 25));  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
	$pdf->SetAligns(array('C', 'C', 'C', 'L', 'L', 'J', 'C', 'C'));  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
