					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<?php if($_SESSION["GUSU"] == 1){ ?>
								<li>
									<a class="active" href="FRMdirectorio.php">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="glyphicon glyphicon-list-alt"></i> Directorio de Alumno para buscar al alumno
				</div>
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_direcotrio_alumnos($pensum); ?>
						</div>
					</div>
				</div>
            <!-- /.panel-body -->
