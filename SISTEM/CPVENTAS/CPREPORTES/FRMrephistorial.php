  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Historial de Ventas </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td class = "celda" align = "right">Factura?: <span class = "busca">*</span></td>
							<td class = "celda" align = "left" style = "vertical-align:text-top;">
								TODAS <input type = "radio" name = "fac1" id = "fac1" value = "1" checked onclick = "RadioArray('fac',1,3)" /> | | 
								CON <input type = "radio" name = "fac2" id = "fac2" value = "1" onclick = "RadioArray('fac',2,3)" /> | |
								SIN <input type = "radio" name = "fac3" id = "fac3" value = "1" onclick = "RadioArray('fac',3,3)" />
								<input type = "hidden" name = "cfac" id = "cfac" value = "" />
							</td>
						</tr>
						<tr>
