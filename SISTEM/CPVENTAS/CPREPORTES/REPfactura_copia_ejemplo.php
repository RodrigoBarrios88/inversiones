  ...
  $pdf->SetMargins($mleft,$mtop); //0.5 centimetro de margen izquierdo
	...
	//-
		...
		/////////////////// ORIGINAL //////////////////////////
				...
				$pdf->SetFont('Arial','B',10);
				$pdf->SetXY(5,54);
				$pdf->Cell(20, 5, trim("Dirección: "), 0, 0);
				//--
				$pdf->SetFont('Arial','',10);
				$pdf->SetXY(25,54);
	      ...
	      $pos_y= 75;
			  ...
			  $pdf->SetXY($pos_x,$pos_y);
				...
				$pdf->SetWidths(array(55, 10, 20, 20, 20));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
				...
				if(is_array($result)){
					...
					$pdf->SetWidths(array(105, 20));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
