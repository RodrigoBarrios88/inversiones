		...
		// coordenadas iniciales
	      ...
	      $pos_y= 71;
			  ...
			  $pdf->SetXY($pos_x,$pos_y);
				...
				$pdf->SetWidths(array(15, 82, 22, 22, 22, 22));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
				...
				$pdf->SetFont('Courier','B',6);  // AQUI LE ASIGNO EL TIPO DE LETRA Y TAMAÑO
				...
				if(is_array($result)){
					...
					foreach($result as $row){
								...
								$Rtotal+= $Rcambiar;
								//--
								$pdf->SetFont('Courier','',6);   // ASIGNO EL TIPO Y TAMAÑO DE LA LETRA
