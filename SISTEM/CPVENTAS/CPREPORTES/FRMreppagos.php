  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Historial de Pagos sobre Cr�ditos </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							<td class = "celda" align = "right"><span id = "lbf3">No. de Venta: <span class = "busca">*</span></span></td>
							<td>
								<input type = "text" class = "text" name = "vent" id = "vent" value = "" onkeyup = "enteros(this);" />
							</td>
						</tr>
						<tr>
							<td class = "celda" align = "right"><span id = "lbf1">Serie de Factura: <span class = "busca">*</span></span></td>
							<td><span id = "lbf2"><?php echo serie_html_onclick(""); ?></span></td>
							<td class = "celda" align = "right"><span id = "lbf3">No. de Factura: <span class = "busca">*</span></span></td>
							<td><input type = "text" class = "text" name = "facc" id = "facc" value = "" onkeyup = "enteros(this);" /></td>
						</tr>
						<tr>
							<td colspan = "4" align = "center">
								<div class = "boxboton" style = "width:295px;">
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReportePagos()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
								<a class="button" href="FRMreppagos.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
