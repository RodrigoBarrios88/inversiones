...
function rep_tabla_anulacion_venta($vent,$suc,$pv,$ser,$facc,$fini,$ffin){
	...
	if(is_array($result)){
			...
			$salida.= '<th width = "100px">FECHA/VENTA</th>';
			$salida.= '<th width = "120px">FECHA/REG.</th>';
...
function rep_historial_venta_descargado($vent,$suc,$pv,$grup,$ser,$facc,$fini,$ffin,$fac,$sit){
	...
	if(is_array($result)){
			...
			$salida.= '<th align = "center" width = "95px"><b>Fecha/Venta</b></th>';
			$salida.= '<th align = "center" width = "95px"><b>Fecha/Registro</b></th>';
...
function rep_historial_venta_nodescargado($vent,$suc,$pv,$grup,$ser,$facc,$fini,$ffin,$fac,$sit){
	//echo "$vent,$suc,$pv,$grup,$ser,$facc,$fini,$ffin,$fac,$sit <br>";
	$ClsVent = new ClsVenta();
	$ClsFac = new ClsFactura();
	$ClsMon = new ClsMoneda();
	if($ser != "" && $facc != ""){
	...
	$result = $ClsVent->get_det_venta_producto('',$vent,'P',0,'',$pv,$suc,'','',$fini,$ffin,$fac,$sit);
