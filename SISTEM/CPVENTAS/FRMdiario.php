    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-calendar"></i> Reporte de Ventas Diario</label></div>
                <div class="panel-body" id = "formulario">
					<form id='f1' name='f1' method='get'>
						...
						<div class="row">
							...
							<div class="col-xs-5"><label>Punto de Venta:</label> <span class = " text-info">*</span></div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<a type="button" class="btn btn-default" href = "FRMdiario.php"><span class="fa fa-eraser"></span> Limpiar</a>
			...
			<?php
				if($desde != "" && $hasta != ""){
					echo tabla_diario($suc,$pv,$desde,$hasta);
				}
			?>
			<br>
	</div>
