    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-files-o"></i> Cuentas por Cobrar</label></div>
                <div class="panel-body">
					<form id='f1' name='f1' action='FRMcreditos.php' method='get'>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<a type="button" class="btn btn-default" href = "FRMcreditos.php"><span class="fa fa-eraser"></span> Limpiar</a>
			...
			<br>
			<?php
				echo tabla_creditos_x_cobrar('',$suc,$cli,$desde,$hasta);
			?>
		<br>
	</div>
	<!-- /#page-wrapper -->
