    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-times-circle"></i> Anulaci&oacute;n de Ventas</label></div>
                <div class="panel-body" id = "formulario">
					<form id='f1' name='f1' action='FRManula.php' method='get'>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<a type="button" class="btn btn-default" href = "FRManula.php"><span class="fa fa-eraser"></span> Limpiar</a>
			...
			<?php
				if($desde != "" && $hasta != ""){
					echo tabla_anulacion_venta($vent,$suc,$pv,$cli,$desde,$hasta,$cfac,$sit);
				}
			?>
			<br>
	</div>
