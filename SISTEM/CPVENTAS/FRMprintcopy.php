    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-print"></i> Reimpresi&oacute;n de Facturas</label></div>
					...
					<form id='f1' name='f1' method='get'>
						...
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								...
								<script type="text/javascript">
								document.getElementById("ser").value = "<?php echo $ser; ?>";
							</script>
							</div>
							<div class="col-xs-5">
								<label>Numero de Factura:</label> <span class = " text-info">*</span>
								<input type = "text" class = "form-control" name = "facn" id = "facn" value="<?php echo $facn; ?>" onkeyup = "enteros(this);" />
							</div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<a type="button" class="btn btn-default" href = "FRMprintcopy.php"><span class="fa fa-eraser"></span> Limpiar</a>
			...
			<?php
				if($desde != "" && $hasta != ""){
					echo tabla_reimpresion($suc,$pv,$num,$ser,$cli,$desde,$hasta);
				}
			?>
			<br>
	    <br>
