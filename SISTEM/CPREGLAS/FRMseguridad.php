<?php
	...
	// archivo txt
	$archivo = "../recursos/seguridad.txt";
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-lock"></i> Configuraci&oacute;n Inicial para el Administrador
				</div>
            <div class="panel-body">
					...
					<br>
               <div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Intentos Maximos Permitidos al Ingreso: <span class="text-danger">*</span></div>
						<div class="col-xs-5"><input type = "text" class="form-control" name = "cont" id = "cont" value = "<?php echo $cont; ?>" onkeyup = "enteros(this)" /></div>
					</div>
					<br>
					<div class="row">
						 <div class="col-xs-12 text-center">
							  <button type="button" class="btn btn-default" onclick = "Limpiar()"><i class="fa fa-eraser"></i> Limpiar</button>
							  <button type="button" class="btn btn-primary" id = "gra" onclick = "ModificarIntentos();"><i class="fa fa-save"></i> Grabar</button>
						 </div>
					</div>
            </div>
				<!-- /.panel-body -->
