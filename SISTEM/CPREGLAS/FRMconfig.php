      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-cogs"></i> Configuraci&oacute;n Inicial del Colegio
				</div>
            <div class="panel-body">
					...
					<div class="row">
						<div class = "text-center text-primary"><hr> <label>CREDENCIALES</label> <hr></div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Nombre del Colegio: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "nombre" id = "nombre" onkeyup = "texto(this)" value = "<?php echo $nombre; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>R&oacute;tulo Baner HTML: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = 'text' class = 'form-control' name = 'rotulo' id = 'rotulo' value = '<?php echo $rotulo; ?>' />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>R&oacute;tulo Baner subpantallas HTML: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = 'text' class = 'form-control' name = 'rotulo2' id = 'rotulo2' value = '<?php echo $rotulo_sub; ?>' />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Nombre para reportes: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "nreporte" id = "nreporte" onkeyup = "texto(this)" value = "<?php echo $nombre_reporte; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Direcci&oacute;n Linea 1: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "direccion1" id = "direccion1" onkeyup = "texto(this)" value = "<?php echo $direccion1; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Direcci&oacute;n Linea 2: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
					...
					<div class="row">
						<div class="col-xs-5"><label>Municicpio: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "municipio" id = "municipio" onkeyup = "texto(this)" value = "<?php echo $municipio; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Tel&eacute;fono: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "telefono" id = "telefono" onkeyup = "texto(this)" value = "<?php echo $telefono; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Correo Electr&oacute;nico: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "correo" id = "correo" onkeyup = "texto(this)" value = "<?php echo $correo; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Website: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "website" id = "website" onkeyup = "texto(this)" value = "<?php echo $website; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Nivel MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "nivel" id = "nivel" onkeyup = "texto(this)" value = "<?php echo $nivel; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Ciclo MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "ciclo" id = "ciclo" onkeyup = "texto(this)" value = "<?php echo $ciclo; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Modalidad MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "modalidad" id = "modalidad" onkeyup = "texto(this)" value = "<?php echo $modalidad; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Jornada MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "jornada" id = "jornada" onkeyup = "texto(this)" value = "<?php echo $jornada; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>Sector MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "sector" id = "sector" onkeyup = "texto(this)" value = "<?php echo $sector; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5"><label>&Aacute;rea MINEDUC: <span class="text-danger">*</span></div>
						<div class="col-xs-6">
							<input type = "text" class = "form-control" name = "area" id = "area" onkeyup = "texto(this)" value = "<?php echo $area; ?>" />
						</div>
					</div>
					<br>
					<div class="row">
