      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-money"></i> Tasa de Cambio para Monedas
				</div>
            <div class="panel-body">
               ...
               <div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Moneda: <span class="text-danger">*</span></div>
						<div class="col-xs-5">
							<div class='input-group'>
								<?php echo Moneda_html("mon","abrir();xajax_Selecciona_Moneda_Tcambio(this.value)"); ?>
								<span class="input-group-addon btn-success" style="cursor:pointer" onclick = "AgregaMoneda();"  title="Agregar una nueva moneda" >
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Tasa de Cambio: <span class="text-danger">*</span></div>
						<div class="col-xs-5"><input type = "text" class="form-control" name = "tcamb" id = "tcamb" onkeyup = "decimales(this)" /></div>
					</div>
					<br>
					<div class="row">
						 <div class="col-xs-12 text-center">
							  <button type="button" class="btn btn-default" onclick = "Limpiar()"><span class="glyphicon glyphicon-erase"></span> Limpiar</button>
							  <button type="button" class="btn btn-primary" onclick = "GrabarTasaCambio();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						 </div>
					</div>
				</div>
				<!-- /.panel-body -->
