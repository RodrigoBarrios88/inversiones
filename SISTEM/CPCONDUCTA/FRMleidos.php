<?php
	...
	$codigo = $ClsCon->decrypt($hashkey, $id);
	
	$result = $ClsCon->get_conducta($codigo);
	if(is_array($result)){
		foreach($result as $row){
			$cod = $row["con_codigo"];
			$titulo = utf8_decode($row["con_titulo"]);
			$target = $row["con_target"];
			$tipo = $row["con_tipo_target"];
			$fecha = trim($row["con_fecha_registro"]);
	...
	$alerta = "Titulo: Reporte de Conducta, de fecha $fecha";
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMreporte.php">
										<i class="fa fa-list"></i> Listar Secciones
									</a>
								</li>
								<?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2  || $tipo_usuario == 5 ){ ?>
								<li>
									<a href="FRMgestor.php?hashkey1=<?php echo $hashkey1; ?>&hashkey2=<?php echo $hashkey2; ?>&hashkey3=<?php echo $hashkey3; ?>&hashkey4=<?php echo $hashkey4; ?>">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<?php echo tabla_lectura(10,$codigo,$nivel,$grado,$seccion); ?>
				</div>
			</div>
			<!-- /.panel-default -->
			<br>
