...
<body>
				...
				<div class="panel-heading"><i class="fa fa-edit"></i> <label>Modificar Datos del Lote</label></div>
					...
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3 text-right"><label>Articulo: </label> <label class = " text-info">*</label><label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left" id = "sart">
								<?php
									if($gru == ""){
										echo combos_vacios("art");
									}else{
										echo articulo_html($gru,"art","Submit();","select2");
									}
								?>
							</div>
							<script type="text/javascript">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "prem" id = "prem" onkeyup = "decimales(this);CalculaMargen();" onblur="CalculaMargen();" /></div>
                            <div class="col-xs-3 text-right"><label>Compra + Margen (Sugerido): </label> <label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "prec" id = "prec" onkeyup = "decimales(this);" /></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3 text-right"><label>Precio de Venta: </label> <label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "prev" id = "prev" onkeyup = "decimales(this);" /></div>
                            <div class="col-xs-3 text-right"><label>% Margen: </label> <label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "marg" id = "marg" onkeyup = "decimales(this);" /></div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" href = "FRMlote.php"><span class="glyphicon glyphicon-erase"></span> Limpiar</a>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/lotart.js"></script>
