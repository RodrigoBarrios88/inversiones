<?php
	...
	//$_POST
	$papel = ($_REQUEST["papel"] != "")?$_REQUEST["papel"] : "Letter";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-group"></i> <label>Listado de Articulos por Proveedor (Con C&oacute;digos de Barras <i class="fa fa-barcode"></i>)</label></div>
					...
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
							...
							<div class="col-xs-5 col-xs-offset-1"><label>Tama&ntilde;o de Papel (Hoja):</label> <label class = " text-info">*</label></div>
						</div>
						<div class="row">
							...
							<div class="col-xs-5">
								<select class="form-control" id = "papel" name="papel" onchange="Submit();">
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php
							if($suc != ""){
								echo tabla_lista_proveedores($suc,$papel);
							}
						?>
					</div>
				</div>
