    ...
    <div id="wrapper">
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									...
									<i class="fa fa-puzzle-piece"></i> Gestor de No hay Art&iacute;culos
									</a>
                                </li>
                                <?php } ?>
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-puzzle-piece"></i> <label>Gestor de Art&iacute;culos</label></div>
                    <div class="panel-body">
						...
						<div class="row">
                            ...
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "margen" id = "margen" onkeyup = "decimales(this)" /></div>
                        </div>
						<div class="row">
                            <hr>
                        </div>
						<div class="row">
                            <div class="col-xs-3 text-right"><label>Situaci&oacute;n: </label> </div>
                            <div class="col-xs-3 text-left">
