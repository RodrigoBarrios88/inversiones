		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-unlink"></i> Listado y Busqueda de Maestros para Des-Asignaci&oacute;n de Secciones y Materias
				</div>
				<div class="panel-body">
					<?php echo tabla_maestros_asignacion($cui,$nom,$ape,$sit); ?>
				</div>
				<!-- /.panel-body -->
			</div>
			<!-- /.panel-default -->
