    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-edit"></i> Corregir Datos del Contrato</div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-10 col-lg-offset-1">
							<a class="btn btn-block btn-social btn-vk" href="FRMeditalumno.php?cui=<?php echo $cui; ?>" > 
                                <i class="fa fa-user"></i> Datos del Alumno (para el siguiente cliclo) &nbsp; &nbsp; <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-block btn-social btn-vk" href="FRMeditgrado.php?cui=<?php echo $cui; ?>" >
                                <i class="fa fa-book"></i> Asignaci&oacute;n de Grado (para el siguiente cliclo) &nbsp; &nbsp; <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-block btn-social btn-vk" href="FRMeditnit.php?cui=<?php echo $cui; ?>" >
                                <i class="fa fa-money"></i> Datos de Facturaci&oacute;n (para el siguiente cliclo) &nbsp; &nbsp; <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-block btn-social btn-vk" href="FRMeditseguro.php?cui=<?php echo $cui; ?>" >
                                <i class="fa fa-medkit"></i> Datos del Seguro (para el siguiente cliclo) &nbsp; &nbsp; <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-block btn-social btn-vk" href="FRMeditcontrato.php?cui=<?php echo $cui; ?>" >
                                <i class="fa fa-file-text-o"></i> Datos del Firmante del Contrato &nbsp; &nbsp; <i class="fa fa-pencil"></i>
                            </a>
						</div>
					</div>
					<br><br>
