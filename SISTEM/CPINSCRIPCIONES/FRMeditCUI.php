	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"> 
					<i class="fa fa-edit"></i> Actualizaci&oacute;n de CUI del Alumno
				</div>
				<div class="panel-body">
					...
					<br>
					<div class = "row">
						<div class="col-lg-4 col-lg-offset-1"><label>CUI registrado:</label> <span class = "text-danger">*</span></div>
						<div class="col-lg-6">
					...
					<hr>
					<div class = "row">
						<div class="col-lg-4 col-lg-offset-1"><label>Nuevo CUI a registrar:</label> <span class = "text-danger">*</span></div>
						<div class="col-lg-6">
							<input class="form-control" type="text" id = "cuinew" name = "cuinew" onkeyup="enteros(this);" />
						</div>
					</div>
					<br>
					<div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <button type="button" class="btn btn-primary" onclick = "CambiaCUI();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
                        </div>
                    </div>
					<br>
				</div>
