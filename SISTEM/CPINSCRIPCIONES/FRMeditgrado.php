<?php
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			//--------
			if(strlen($cuinew)>0){
				$result = $ClsIns->get_grado_alumno('','',$cuinew);
				if(is_array($result)){
                    foreach($result as $row){
                        //$cliente = $row["cli_id"];
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"> 
					<i class="fa fa-edit"></i> Corregir Asignaci&oacute;n de Grado del Alumno (para el siguiente ciclo)
				</div>
				<div class="panel-body">
					...
					<hr>
					<div class = "row">
						<div class="col-lg-4 col-lg-offset-1"><label>Nivel:</label> <span class = "text-danger">*</span></div>
						<div class="col-lg-6">
							<?php echo inscripcion_nivel_html("nivel","xajax_Nivel_Grado(this.value,'grado','divgrado',);"); ?>
							<script>
					...
					<div class = "row">
						<div class="col-lg-4 col-lg-offset-1"><label>Grado:</label> <span class = "text-danger">*</span></div>
						<div class="col-lg-6" id = "divgrado">
							<?php
								if($nivel != ""){
									echo inscripcion_grado_html($nivel,"grado","");
								}else{
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <button type="button" class="btn btn-primary" onclick = "ActualizaGrado();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
                        </div>
                    </div>
					<br>
				</div>
