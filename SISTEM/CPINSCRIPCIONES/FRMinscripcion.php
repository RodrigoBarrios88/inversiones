    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["RECEPCON"] == 1){ ?>
								<li>
									<a href="FRMinscripcion.php">
										<i class="fa fa-certificate"></i> Inscripci&oacute;n
									</a>
                                </li>
								<?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-inbox"></i> Inscripci&oacute;n al Pr&oacute;ximo Ciclo</label></div>
                <div class="panel-body">
					<form name = "f1" id = "f1" method="get">
						<div class="row">
							<div class="col-xs-6 col-xs-offset-3"><label>Pensums a Inscribir:</label></div>
						</div>
						<div class="row">
						...
						<div class="col-lg-12" id = "result">
							<?php echo tabla_inscripcion($pensum); ?>
						</div>
					</form>
                </div>
            </div>	
