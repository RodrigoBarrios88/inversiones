            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>Situaci&oacute;n de Boletas:</label>
					    	<select class="form-control" id = "sit" name="sit">
								<option value="1" selected="selected">TODAS LAS BOLETAS</option>
								<option value="2">BOLETAS PENDIENTES DE PAGO</option>
								<option value="3">BOLETAS PAGADAS</option>
								<option value="4">BOLETAS ANULADAS</option>
							</select>
							<script type="text/javascript">
								document.getElementById("sit").value = "<?php echo $tipo; ?>";
							</script>
						</div>
					</div>
					<div class="row">
