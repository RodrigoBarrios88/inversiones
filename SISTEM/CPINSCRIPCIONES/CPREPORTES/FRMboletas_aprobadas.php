...
<body>
    ...
    <div class="panel panel-default">
		<div class="panel-heading">
			<i class="fa fa-file-text fa-fw"></i> Paso 3 Completo
		</div>
		<div class="panel-body">
			<div class = "row">
				<div class = "col-xs-10 col-xs-offset-1 text-center">
					<h5 class="alert alert-info"><i class="fa fa-dollar"></i> Reporte de Boletas Recibidas y Pagadas</h5>
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12">
					<?php echo tabla_boletas_recibidas(); ?>
				</div>
			</div>
		</div>
	</div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Boletas Aprobadas'},
                    {extend: 'print',
						...
						title: 'Reporte de Boletas Aprobadas'
                    }
                ]
