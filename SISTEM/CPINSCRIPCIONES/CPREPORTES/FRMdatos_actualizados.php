...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<i class="fa fa-file-text fa-fw"></i> Paso 1 Completo
			
		</div>
		<div class="panel-body">
			<div class = "row">
				<div class = "col-xs-10 col-xs-offset-1 text-center">
					<h5 class="alert alert-success"><i class="fa fa-check"></i> Reporte de Alumnos con Datos Actualizados (Paso # 1), pendiente de girar boletas</h5>
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12">
					<?php echo tabla_datos_actualizados(); ?>
				</div>
			</div>
		</div>
	</div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Alumnos con Datos Actualizados (Paso # 1)'},
                    {extend: 'print',
						...
						title: 'Reporte de Alumnos con Datos Actualizados (Paso # 1)'
                    }
                ]
