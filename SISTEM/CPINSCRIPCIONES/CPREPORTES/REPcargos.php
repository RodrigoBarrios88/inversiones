<?php
	...
	echo $pag;
	//--
	$titulo = "REPORTE DE CARGOS DE INSCRIPCIONES";
						...
						<div class = "row">
							<div class = "col-xs-10 col-xs-offset-1 text-center">
								<h5 class="alert alert-info">
									<i class="fa fa-plus"></i> <i class="fa fa-dollar"></i> Reporte de Cargos por Boletas de Inscripci&oacute;n
								</h5>
							</div>
						</div>
						<div class = "row">
							<div class = "col-xs-12">
								<?php
									if($desde != "" && $hasta != ""){
										echo tabla_cargos($periodo,$desde,$hasta,$sit,$pag);
									}else{
