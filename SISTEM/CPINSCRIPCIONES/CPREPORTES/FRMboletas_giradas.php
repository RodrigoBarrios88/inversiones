	...
	<nav class="navbar navbar-default navbar-fixed-top" style = "z-index:500;">
        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text fa-fw"></i> Paso 2 Completo
				
			</div>
			<div class="panel-body">
				<div class = "row">
					<div class = "col-xs-10 col-xs-offset-1 text-center">
						<h5 class="alert alert-info"><i class="fa fa-file-text-o"></i> Reporte de Boletas Giradas, pendientes de pago</h5>
					</div>
				</div>
				<div class = "row">
					<div class = "col-xs-12">
						<?php echo tabla_boletas_giradas(); ?>
					</div>
				</div>
			</div>
		</div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Boletas Giradas'},
                    {extend: 'print',
						...
						title: 'Reporte de Boletas Giradas'
                    }
                ]
