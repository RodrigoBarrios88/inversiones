	    ...
	    <br>
            <div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<hr>
					<div class = "row">
						<div class="col-lg-4 col-lg-offset-1"><label>El ni&ntilde;o(a) tiene seguro?</label> <span class = "text-danger">*</span></div>
						<div class="col-lg-6">
							&nbsp; <label><input type="radio" id = "segurosi" name = "seguro" /><label for="segurosi" id = "labelsi" > Si</label></label> 
							&nbsp; <label><input type="radio" id = "segurono" name = "seguro" /><label for="segurono" id = "labelno" > No</label></label>
							<script>
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <button type="button" class="btn btn-primary" onclick = "ActualizaSeguro();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
                        </div>
                    </div>
					<br>
				</div>
