    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-file-text-o"></i> Abrobaci&oacute;n de Contratos</div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-12 text-right">
							<a class="btn btn-default" href="CPREPORTES/FRMboletas_aprobadas.php" target = "_blank" ><i class="fa fa-print" ></i> Reporte</a>
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_contratos_aprobacion(); ?>
						</div>
					</div>
                </div>
            </div>	
