    ...
    <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									<a href="FRMimpresion_boletas.php">
										<i class="fa fa-print"></i> Re-Impresi&oacute;n de Boletas de Inscripci&oacute;n
									</a>
                                </li>
								<?php } ?>
								<?php if($_SESSION["BOLINSCRIP"] == 1){ ?>
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-print"></i> Re-Impresi&oacute;n de Boletas de Inscripcion</div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-12 text-center">
							<button type="button" class="btn btn-default" onclick = "window.location.reload();" title="Re-Cargar la P&aacute;gina" ><i class="fa fa-refresh fa-2x text-info"></i></button>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_solicitud_boletas(); ?>
						</div>
					</div>
                </div>
            </div>	
