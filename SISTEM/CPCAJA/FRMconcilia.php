<?php
	include_once('xajax_funct_caja.php');
	$id = $_SESSION["codigo"];
...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									<a href="FRMcaja.php">
										<i class="fa fa-inbox"></i> Cajas Monetarias
									</a>
								</li>
								<?php } ?>
								<?php if($_SESSION["SALDOCAJA"] == 1){ ?>
								<li>
									<a href="FRMsaldo.php">
								...
								<?php } ?>
								<?php if($_SESSION["INCAJA"] == 1){ ?>
								<li>
									<a href="FRMcajaingreso.php">
										<i class="fa fa-sign-in"></i> Ingresos
									</a>
								</li>
								<?php } ?>
								<?php if($_SESSION["OUTCAJA"] == 1){ ?>
								<li>
									<a href="FRMcajaegreso.php">
								...
								<li>
									<a href="FRMconcilia.php">
										<i class="fa fa-file-text-o "></i> Movimientos de Caja
									</a>
								</li>
								<?php } ?>
								<hr>
								<?php if($_SESSION["SALDOCAJA"] == 1){ ?>
								<li>
									<a href="CPREPORTES/FRMsaldos.php">
								...
								<?php if($_SESSION["SALDOCAJA"] == 1){ ?>
								<li>
									<a href="CPREPORTES/FRMmovimiento.php">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-file-text-o "></i> Cajas Monetarias (Movimientos de Caja)</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMconcilia.php" ><span class="glyphicon glyphicon-erase"></span> Limpiar</a>
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								if($cod != "" || $suc != "" || $mon != ""){
									echo tabla_caja_movimiento($cod,$suc,$mon);
								}else{
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								if($cod != ""){
									echo tabla_movimientos($caja,$suc,$desde,$hasta);
								}
							?>
						</div>
					</div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/finanzas/movcaja.js"></script>
