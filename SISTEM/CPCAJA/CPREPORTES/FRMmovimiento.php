            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Caja:</label></div>
					</div>
					<div class="row">
    ...
    <script>
		function Reporte(){
			...
			if(caja.value !== "" && suc.value !== ""){
				...
				abrir();
				if(caja.value ===""){
					caja.className = "form-control alert-info";
				}else{
				...
				msj = '<h5>Debe Seleccionar la Empresa y la Caja a consultar</h5><br><br>';
