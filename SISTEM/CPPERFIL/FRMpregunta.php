        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							<label>Pregunta: </label> <span class="text-danger">*</span> <br>
							<input type = "text" class="form-control" name = "preg" id = "preg" onkeyup = "texto(this)" value = "<?php echo $preg; ?>" />
						</div>
						<div class="col-lg-5 col-xs-12">
							<label>Respuesta: </label> <span class="text-danger">*</span> <br>
							<input type = "text" class="form-control" name = "resp" id = "resp" onkeyup = "texto(this)" value = "<?php echo $resp; ?>" />
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "ModificarPreg()"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
				</div>
				<!-- /.panel-body -->
