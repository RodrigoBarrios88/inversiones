        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-camera"></i> Cargar Fotograf&iacute;a
				</div>
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-4 col-xs-offset-4">
							<button type="button" class="btn btn-default btn-block" onclick = "window.location.reload();"><span class="fa fa-refresh"></span></button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4 col-xs-offset-4">
