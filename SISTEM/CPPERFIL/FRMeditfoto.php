<?php
	...
	if(file_exists('../../CONFIG/Fotos/USUARIOS/'.$foto.'.jpg') && $foto != ""){
		...
		$foto = "../../CONFIG/Fotos/USUARIOS/nofoto.png";
	}
...
<body>
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-6 col-xs-12">
							...
							<br>
							<div class="btn-group">
								<label title="Download image" id="download" class="btn btn-primary btn-block">
	...
	<script>
        $(document).ready(function(){
			...
			function redirige(){
				cerrar();
				swal("Excelete!", "La imagen fue editada satisfactoriamente...", "success").then((value)=>{ window.location.href = 'FRMfoto.php'; });
			}
