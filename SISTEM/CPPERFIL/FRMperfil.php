				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							<label>Nombre de Registro: </label> <br>
					...
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							...
							<input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this);" value = "<?php echo $nombre_pantalla; ?>" />
							<input type = "hidden" name = "cod" id = "cod" value = "<?php echo $id; ?>" />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							<label>Email Alterno: </label> <span class="text-danger">*</span> <br>
							<input type = "text" class="form-control text-libre" name = "mail" id = "mail" onkeyup = "texto(this);" value = "<?php echo $mail; ?>" />
						</div>
						<div class="col-lg-5 col-xs-12">
							<label>Tel&eacute;fono: </label> <span class="text-danger">*</span> <br>
							<input type = "text" class="form-control" name = "tel" id = "tel" onkeyup = "enteros(this);" value = "<?php echo $tel; ?>" />
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "ModificarPerfil();"><span class="fa fa-save"></span> Grabar</button>
						</div>
					</div>
				</div>
				<!-- /.panel-body -->
