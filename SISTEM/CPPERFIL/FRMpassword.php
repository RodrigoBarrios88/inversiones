...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="FRMperfil.php"><i class="glyphicon glyphicon-file"></i> Datos Generales</a>
                                </li>
                                <li>
                                    <a href="FRMpassword.php"><i class="glyphicon glyphicon-question-sign"></i> Seguridad y Contrase&ntilde;a</a>
                                </li>
                                <li>
                                    <a href="FRMpregunta.php"><i class="glyphicon glyphicon-lock"></i> Pregunta Clave</a>
                                </li>
                                <li>
                                    <a href="FRMfoto.php"><i class="fa fa-camera"></i> Fotograf&iacute;a</a>
                                </li>
								<hr>
                                <li>
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-10 col-xs-12 col-lg-offset-1">
							<label>Nombre: </label> <span class="text-danger">*</span> <br>
					...
					<div class="row">
						<div class="col-lg-10 col-xs-12 col-lg-offset-1">
							<label>Usuario: </label> <span class="text-danger">*</span> <br>
							<input type = "text" class="form-control text-libre" name = "usu" id = "usu" value = "<?php echo $usuario; ?>" readonly />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-10 col-xs-12 col-lg-offset-1">
							<label>Contrase&ntilde;a: </label> <span class="text-danger">*</span> <br>
					...
					<div class="row">
						<div class="col-lg-10 col-xs-12 col-lg-offset-1">
							<label>Confirme Contrase&ntilde;a: </label> <span class="text-danger">*</span> <br>
					...
					<div class="row">
						<div class="col-lg-10 col-xs-12 col-lg-offset-1">
							<small>Fortaleza de la Contrase&ntilde;a</small> <br>
							<div class="progress">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "ModificarPass();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
				</div>
				<!-- /.panel-body -->
   ...
   <!-- Modal -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/seguridad/perfil.js"></script>
