    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label>Formulario Gestor de Plazas</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Nombre Abreviado:</label></div>
						<div class="col-xs-5"><label>Nombre Completo:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "dct" id = "dct" onkeyup = "texto(this)" />
						</div>	
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "dlg" id = "dlg" onkeyup = "texto(this)" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Salario Base por Hora</div>
						<div class="col-xs-5"><label>Horas Promedio a Laborar:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "salario" id = "salario" onkeyup = "decimales(this)" />
						</div>	
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "horas" id = "horas" onkeyup = "decimales(this)" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Subordinado a:</label></div>
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>
								1era. Jerarquia?: 
								<input type = "checkbox" name = "ind" id = "ind" onclick = "Top_Jerarquia(this,'sub','jer','descsub')"/>
							</label>
							&nbsp;
							<label class="hidden">
								Independencia o Asistente?:
								<input type = "checkbox" class = "textct" name = "ind" id = "ind" />
							</label>
						</div>
					</div>
					<br>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_plazas($plaza,$dct,$dlg,$suc,$dep); ?>
				</div>
			</div>
		</div>
	    </div>
