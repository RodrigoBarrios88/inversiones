<?php
	include_once('ajax_funct_grupos.php');
	$id = $_SESSION["codigo"];
    ...
    <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="CPREPORTES/FRMreplistado.php">
										<i class="glyphicon glyphicon-print"></i> Reporte de Grupos
									</a>
                                </li>
								<hr>
								<li>
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-book"></i> Formulario Gestor de Grupos</div>
            <div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Nombre (Grupo): </label> <span class="text-danger">*</span>
							<input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this);" />
							<input type = "hidden" name = "cod" id = "cod" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1" id = "aarea">
							<label>&Aacute;rea: </label> <span class="text-danger">*</span>
							<?php echo Area_html("area","Getsegmento()"); ?>
						</div>
						<div class="col-xs-5">
						<label >Segmento: </label> <span class="text-danger">*</span>
						</div>
						<div class="col-xs-5" id = "ssegmento2">
						<select class ="select 2 form-control" id = "ssegmento" >
