...
<body>
    <div id="wrapper">
		...
		<div class="panel-heading"><label>Listado de Contrase&ntilde;as Temporales para Actualizaci&oacute;n de Datos</label></div>
                    <div class="panel-body">
						<form name = "f1" id = "f1" action="REPtemp_pass.php" method="post" target = "_blank">
						<div class="row">
							<div class="col-xs-12 col-xs-12 text-right text-danger">* Campos Obligatorios</div>
						</div>
                        <div class="row">
                            <div class="col-xs-2 text-right"><label>Nomina: </label> <span class="text-info">*</span></div>
                            <div class="col-xs-4 text-left"><input type = "text" class="form-control" name = "nomina" id = "nomina" onkeyup = "enteros(this)" /></div>
                        </div>
                        <br>
                        <div class="row">
