<?php
	...
	$result = $ClsGruCla->get_grupo_clase($grupo);
    if(is_array($result)){
	...
	<nav class="navbar navbar-default navbar-fixed-top" style = "z-index:500;">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text fa-fw"></i> Listado de Alumnos por Grupo (<strong><?php echo $grupo_desc; ?></strong>)
			</div>
			<div class="panel-body">
				<div class = "row">
					<div class = "col-xs-12">
						<?php
							if($grupo != ""){
								echo tabla_grupos_alumnos($grupo);
							}
						?>
					</div>
				</div>
