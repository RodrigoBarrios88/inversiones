      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list-alt"></i> Ficha T&eacute;cnica del Alumno
					...
					<div class="row">
						<div class="col-lg-4 col-xs-12 text-center">
							<div class="panel panel-default">
									...
									<div class="row">
										<div class="col-xs-12">
											<form action="EXEcarga_imagen.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
												<button type="button" class="btn btn-primary btn-block" onclick = "FotoJs();" title = "Cambiar Fotograf&iacute;a"><i class="fa fa-image"></i> <i class="fa fa-plus"></i>  Cambiar Fotograf&iacute;a...</button>
								...
								<!--	<div class="row">
										<div class="col-xs-12">
											<a class="btn btn-primary btn-block" href = "FRMfoto.php?hashkey=<?php echo $hashkey; ?>" title = "Tomar Fotograf&iacute;a"><i class="fa fa-camera"></i> <i class="fa fa-star"></i>  Tomar Fotograf&iacute;a...</a>
										</div>	
									</div> -->
									<br>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<br>
									<a href="../CPFICHAPRESCOOL/FRMficha.php?hashkey=<?php echo $hashkey; ?>" title="Ver ficha preescolar del Alumno">
										<i class="fa fa-file-text-o fa-5x text-muted"></i> <br>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-6 col-xs-12">
											...
											<label class = "form-control"><?php echo $recoge; ?></label>
										</div>
										<div class="col-lg-6 col-xs-12">
											<label>Autorizaci&oacute;n de Redes Sociales: <small class="text-muted">(publicaci&oacute;n)</small> </label>
											<label class = "form-control"><?php echo $redesociales; ?></label>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-lg-12 col-xs-12">
											<label>Tel&eacute;fono(s) de Emergencia:  </label>
									...
									<div class="row">
										<div class="col-lg-12 col-xs-12">
											<label>&iquest;Cuenta con seguro m&eacute;dico externo?  </label>
											<label class = "form-control"><?php echo $seguro; ?></label>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-6 col-xs-12">
											<label>No. de Poliza:  </label>
											<label class = "form-control"><?php echo $poliza; ?></label>
										</div>
										<div class="col-lg-6 col-xs-12">
											<label>Aseguradora:  </label>
											<label class = "form-control"><?php echo $aseguradora; ?></label>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-6 col-xs-12">
											<label>Plan:  </label> 
											<label class = "form-control"><?php echo $plan; ?></label>
										</div>
										<div class="col-lg-6 col-xs-12">
											<label>Asegurado Principal:  </label> 
											<label class = "form-control"><?php echo $asegurado; ?></label>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12 col-xs-12">
											<label>Instrucciones Especiales: </label>
											<textarea class = "form-control" disabled><?php echo $instrucciones; ?></textarea>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12 col-xs-12">
											<label>Comentarios:  </label> 
											<textarea class = "form-control" disabled><?php echo $comentarios; ?></textarea>
										</div>
									</div>
									<hr>
									<div class="row">
										<div class="col-lg-6 col-xs-12">
											<label>Nit a Facturar:  </label> 
											<label class = "form-control"><?php echo $nit; ?></label>
										</div>
										<div class="col-lg-6 col-xs-12">
											<label>Nombre del Cliente:  </label> 
											<label class = "form-control"><?php echo $clinombre; ?></label>
										</div>	
									</div>
									<div class="row">
										<div class="col-lg-12 col-xs-12">
											<label>Direcci&oacute;n de Facturaci&oacute;n:  </label> 
											<label class = "form-control"><?php echo $clidireccion; ?></label>
										</div>	
									</div>
								</div>
							 </div>
