<?php
	...
	switch($acc){
		case 1: $titulo2 = "Actualizaci&oacute;n de Informaci&oacute;n"; break;
		case 2: $titulo2 = "Asignaci&oacute;n de Alumno a Grupos Extracurriculares"; break;
		case 3: $titulo2 = "Actualizaci&oacute;n de Fotograf&iacute;a"; break;
		case 4: $titulo2 = "Ficha T&eacute;cnica del Alumno"; break;
		case 5: $titulo2 = "Bit&aacute;cora Psicopedag&oacute;gica del Alumno"; break;
		case 6: $titulo2 = "Inhabilitar Alumnos en el Sistema (Quitar del Listado)"; break;
		case 7: $titulo2 = "Habilitar Alumnos Inhabilitados (Activar de Nuevo)"; break;
	}
	
	//--
	$result = $ClsAcadem->get_seccion_alumno($pensum,$nivel,$grado,$seccion);
	if(is_array($result)){
		foreach($result as $row){
			$grado_desc = ucfirst(strtolower(utf8_decode($row["gra_descripcion"])));
			$seccion_desc = ucfirst(strtolower(utf8_decode($row["sec_descripcion"])));
		}
	}
	
	$titulo = "$grado_desc Secci&oacute;n $seccion_desc";
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-edit"></i>Listado de Alumnos de <?php echo $titulo; ?>, para <?php echo $titulo2; ?>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_alumnos($pensum,$nivel,$grado,$seccion,$acc); ?>
						</div>
					</div>
				</div>
				<!-- /.panel-body -->
