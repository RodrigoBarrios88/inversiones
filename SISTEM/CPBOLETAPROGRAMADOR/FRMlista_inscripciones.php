    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["NEWCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMlista_inscripciones.php">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-inbox"></i> Inscripci&oacute;n al Pr&oacute;ximo Ciclo</div>
                <div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-12" id = "result">
							<?php echo tabla_alumnos_inscripcion($pensum,'',''); ?>
						</div>
						</form>
					</div>
                </div>
