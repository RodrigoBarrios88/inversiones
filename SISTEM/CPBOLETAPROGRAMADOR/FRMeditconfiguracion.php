   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-edit"></i>  Editar Configuraci&oacute;n para Programar Boletas de Cobro</div>
            <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Mes de Inicio:</label> <span class="text-danger">*</span>
						...
						<div class="col-xs-5">
							<label>D&iacute;a de Pago:</label> <span class="text-danger">*</span>
							<input type="text" class="form-control" id="dia" name="dia" onkeyup="enteros(this);" maxlength = "2" >
							<input type="hidden" id="periodo" name="periodo" value="<?php echo $periodo; ?>" >
						</div>
					</div>
					<br>
                  ...
                  <div class="col-xs-12 text-center">
							<a type="button" class="btn btn-default" id = "limp" href = "FRMeditconfiguracion.php"><i class="fa fa-eraser"></i> Limpiar</a>
							<button type="button" class="btn btn-primary" onclick = "ModificarConfiguracion();"> <i class="fa fa-save"></i> Grabar</button>
						</div>
               </div>
					</form>
					<br>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								echo tabla_configuraciones_boletas_cobro($codigo,$division,$grupo,$tipo,$periodo);
							?>
						</div>
					</div>
				</div>
