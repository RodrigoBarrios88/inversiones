	...
	<div class="container">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li><a href="../CPNOTASPROM/FRMunidades.php"><span class="fa fa-edit" aria-hidden="true"></span> Unidades de Calificaci&oacute;n</a></li>
								<?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
						...
						<?php if($_SESSION["MOD_academico3"] == 1){ //permisos al colegio?>
							...
							<?php } ?>
						<?php } ?>
						<?php if($_SESSION["MOD_academico32"] == 1 && $_SESSION["MOD_tareas"] == 1){ ?>
							<?php if($tipo_usuario == 2 || $tipo_usuario == 1 || $tipo_usuario == 5){ ?>
							<li class="dropdown">
		...
		<div id = "contenedor" class="jumbotron">
			...
			<div class="text-center" >
				<?php if($_SESSION["MOD_academico3"] == 1){ ?>
				<h2 class='text-primary'>M&oacute;dulo Acad&eacute;mico</h2>
				<?php } ?>
				<?php if($_SESSION["MOD_academico32"] == 1){ ?>
