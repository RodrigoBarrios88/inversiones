    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-subscript"></i> Formulario Gestor de Reglones Contables</label></div>
					...
					<form id='f1' name='f1' method='get'>
						...
						<div class="row">
                            <div class="col-xs-5 col-xs-offset-1">
								...
								<input type = "text" class = "form-control" name = "dlg" id = "dlg" value = "<?php echo $dlg; ?>" onkeyup = "texto(this);" />
								<input type = "hidden" name = "cod" id = "cod" value = "<?php echo $cod; ?>" />
							</div>
                            <div class="col-xs-5">
								<label>Nombre Corto: </label> <span class="text-danger">*</span> 
								<input type = "text" class = "form-control" name = "dct" id = "dct" value = "<?php echo $dct; ?>" onkeyup = "texto(this);" />
							</div>
                        </div>
                        <div class="row">
                            <div class="col-xs-5 col-xs-offset-1">
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" id = "limp" href = "FRMreglon.php"><span class="fa fa-eraser"></span> Limpiar</a>
                                <button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarReglon();"><span class="fa fa-save"></span> Grabar</button>
                            </div>
                        </div>
					</form>
                </div>
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php echo tabla_reglones('',$partida,'','',1); ?>
					</div>
				</div>
            </div>
             <!-- /.panel-default -->
		...
		$(document).ready(function() {
			$('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Reglones Contables'},
                    ...
                    {extend: 'print',
						...
						title: 'Reporte de Reglones Contables'
                    }
                ]
			});
	    });
