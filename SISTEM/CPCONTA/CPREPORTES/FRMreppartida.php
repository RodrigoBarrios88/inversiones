    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Listado de Partidas Contables </h3>
					<table>
						<tr>
						...
						<tr>
							<td class = "celda" align = "right">Nombre (Partida): <span class = "requerido">*</span><span class = "busca">*</span></td>
							<td colspan = "3"><input type = "text" class = "textmd" name = "nom" id = "nom" onkeyup = "texto(this)" /><input type = "hidden" name = "cod" id = "cod" /></td>
						</tr>
						<tr>
							<td class = "celda" align = "right">Tipo: <span class = "requerido">*</span><span class = "busca">*</span></td>
							<td>
								<select id = "tipo" name = "tipo" class = "combo" onchange = "ComboTipoClase(this.value);">
									<option value = "">Seleccione</option>
									<option value = "E">PARTIDA DE EGRESOS</option>
									<option value = "I">PARTIDA DE INGRESOS</option>
								</select>
							</td>
							<td class = "celda" align = "right">Clase: <span class = "requerido">*</span><span class = "busca">*</span></td>
							<td align = "right">
								<span id = "sclase">
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReportePartida()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
								<a class="button" href="FRMpartida.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
