        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<label><i class="fa fa-superscript"></i> Formulario Gestor de Clasificaci&oacute;n de Partidas Contables</label>
				</div>
					...
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" id = "limp" href = "FRMclase.php"><span class="fa fa-eraser"></span> Limpiar</a>
                                <button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarClase();"><span class="fa fa-save"></span> Grabar</button>
                            </div>
                        </div>
					</form>	
                </div>
		...
		$(document).ready(function() {
			$('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Clasisifcaci\u00F3n de Partidas'},
                    ...
                    {extend: 'print',
						...
						title: 'Reporte de Clasisifcaci\u00F3n de Partidas'
                    }
                ]
			});
	    });
