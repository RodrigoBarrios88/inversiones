        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<label><i class="fa fa-superscript"></i> Formulario Gestor de Partidas Contables</label>
				</div>
                <div class="panel-body">
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-5">
								<label>Clasificaci&oacute;n: </label> <span class="text-danger">*</span>
								<div id = "sclase">
									<?php
										if($tipo != ""){
											echo clase_partida_html($tipo,'','clase','');
										}else{
											echo combos_vacios('clase');
										}
									?>
								</div>
								<script>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" id = "limp" href = "FRMpartida.php"><span class="fa fa-eraser"></span> Limpiar</a>
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php echo tabla_partidas('',$tipo,'','',1); ?>
					</div>
				</div>
            </div>
            <!-- /.panel-default -->
		...
		$(document).ready(function() {
			$('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Partidas Contables'},
                    ...
                    {extend: 'print',
						...
						title: 'Reporte de Partidas Contables'
                    }
                ]
			});
	    });
