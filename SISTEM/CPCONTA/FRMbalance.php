    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-book"></i> Balance General</div>
					...
					<form name = "f1" name = "f1" method="get" >
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								...
								<a type="button" class="btn btn-primary" target="_blank" href = "CPREPORTES/REPbalance.pdf"><span class="glyphicon glyphicon-print"></span> Generar</a>
