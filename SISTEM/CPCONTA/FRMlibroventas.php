    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-book"></i> Libro de Ventas</label></div>
                <div class="panel-body" id = "formulario">
					<form name = "f1" name = "f1" method="get">
						...
						<div class="row">
							...
							<div class="col-xs-5">
								<label>R&eacute;gimen Tributario:</label> <span class = " text-info">*</span>
						...
						<br>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>No. de Contador:</label> </div>
							<div class="col-xs-5"><label>Nombre del Contador:</label> </div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
