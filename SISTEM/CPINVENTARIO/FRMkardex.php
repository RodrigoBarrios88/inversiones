...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-list-alt"></i> <label>Kardex de Inventario de Art&iacute;culos</label></div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/kardex.js"></script>
