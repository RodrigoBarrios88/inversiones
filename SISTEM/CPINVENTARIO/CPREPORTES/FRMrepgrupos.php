    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Listado de Grupo de Art&iacute;culos </h3>
					<table>
						<tr>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteGrupo(1)" ><img src="../../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteGrupo(2)" ><img src="../../../CONFIG/images/icons/excel.png" class="icon" > Exportar</a>
								<a class="button" href="FRMrepgrupos.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
