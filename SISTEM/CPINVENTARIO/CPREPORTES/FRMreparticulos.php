    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Listado de Art&iacute;culos </h3>
					<table>
						<tr>
						...
						<tr>
							<td class = "celda" align = "right">Codigo Interno: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "barc" id = "barc" onkeyup = "texto(this);"  /></td>
						...
						<tr>
							...
							<td><?php echo Grupo_Art_html(); ?><input type = "hidden" name = "cod" id = "cod" /></td>
							<td class = "celda" align = "right">Marca: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "marca" id = "marca" onkeyup = "texto(this)" /></td>
						</tr>
						<tr>
							<td class = "celda" align = "right">Nombre: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "artnom" id = "artnom" onkeyup = "texto(this)" /></td>
							<td class = "celda" align = "right">Descripci�n: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "desc" id = "desc" onkeyup = "texto(this)" /></td>
						</tr>
						<tr>
							<td colspan = "4" align = "center">
								<div class = "boxboton" style = "width:300px;">
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteArticulo(1)" ><img src="../../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteArticulo(2)" ><img src="../../../CONFIG/images/icons/excel.png" class="icon" > Exportar</a>
								<a class="button" href="FRMreparticulos.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
