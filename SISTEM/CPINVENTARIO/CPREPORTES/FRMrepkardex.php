    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Kardex de Inventario para Imprimir</h3>
					<table>
						<tr>
						...
						<tr>
							...
							<td with = "30%"><?php echo Empresas_html(); ?></td>
							<td class = "celda" align = "right">Codigo Int.: <span class = "busca">*</span></td>
							<td with = "30%"><input type = "text" class = "text" name = "barc" id = "barc" onkeyup = "texto(this);"  /></td>
						</tr>
						<tr>
							<td class = "celda" align = "right">Grupo: <span class = "busca">*</span></td>
							<td width = "30%"><?php echo Grupo_Art_Onclick('gru','art','sart'); ?><input type = "hidden" name = "cod" id = "cod" /></td>
							<td class = "celda" align = "right">Articulo: <span class = "busca">*</span></td>
							<td width = "30%">
								<span id = "sart" >
									<select id = "art" name = "art" class = "combo">
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteKardex(1)" ><img src="../../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteKardex(2)" ><img src="../../../CONFIG/images/icons/excel.png" class="icon" > Exportar</a>
								<a class="button" href="FRMrepkardex.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
