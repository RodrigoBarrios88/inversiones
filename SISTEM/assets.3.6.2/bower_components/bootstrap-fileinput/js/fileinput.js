...
(function (factory) {
    ...
    tModal = '<div class="modal-dialog modal-lg" role="document">\n' +
        ...
        '      <h3 class="modal-title">{heading} <small><span class="kv-zoom-title bg-primary"></span></small></h3>\n' +
        '    </div>\n' +
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgZoomModalHeading: '<img src="../../CONFIG/images/logo.png" alt="logo" width="30px" />>',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) Excede el maximo tamaño. <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debe de seleccionar almenos <b>{n}</b> {files} para subirlos.',
        msgFilesTooMany: 'El Numero de archivos seleccionados <b>({n})</b> excede el limite permitido <b>{m}</b>.',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Restricciones de seguridad no permiten la visualizacion del archivo "{name}".',
        msgFileNotReadable: 'El archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'La visualizacion del archivo "{name}" fue abortada.',
        msgFilePreviewError: 'Un error ha ocurrido en la previsualizacion del archivo "{name}".',
        msgInvalidFileType: 'Tipo de Archivo invalido "{name}". Solo "{types}" son permitidos.',
        msgInvalidFileExtension: 'Extension del archivo "{name}" invalida. Solo "{extensions}" son permitidas.',
        msgUploadAborted: 'La carga del archivo fue abortada.',
        msgUploadThreshold: 'Procesando...',
        msgValidationError: 'Validation Error',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Carga del archivo {index} de {files} - {name} - {percent}% Completa.',
        msgSelected: '{n} {files} Seleccionado',
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: 'El ancho de la imagen "{name}" debe de ser por lo menos de {size} px.',
        msgImageHeightSmall: 'El Alto de la imagen "{name}" debe de ser por lo menos de {size} px.',
        msgImageWidthLarge: 'El ancho de la imagen "{name}" no puede exceder de {size} px.',
        msgImageHeightLarge: 'El Alto de la imagen "{name}" no puede exceder de {size} px.',
        msgImageResizeError: 'Could not get the image dimensions to resize.',
        msgImageResizeException: 'Error while resizing the image.<pre>{errors}</pre>',
        dropZoneTitle: 'Arrastre archivos aqui &hellip;',
        dropZoneClickTitle: '<br>(o haga click para seleccionar el archivo {files})',
        previewZoomButtonTitles: {
            prev: 'Ver archivo anterior',
            next: 'Ver siguiente archivo',
            toggleheader: 'Encabezado',
