//funciones javascript y validaciones
	...
	function Asignar_Nota(fila){
		...
		if(pensum.value !=="" && nivel.value !=="" && grado.value !=="" && materia.value !=="" && unidad.value !=="" && seccion.value !=="" && alumno.value !==""){
			xajax_Asignar_Nota_Alumno(alumno.value,pensum.value,nivel.value,grado.value,materia.value,unidad.value,zona.value,nota.value,seccion.value,tipo.value,fila);
		}else{
			if(pensum.value ===""){
