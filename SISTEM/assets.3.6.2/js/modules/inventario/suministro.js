//funciones javascript y validaciones
			...
			function PromtCaptura(){
				...
				$.post("../promts/suministro/get_masa.php",{variable1:n1}, function(data){
			...
			function DownloadFormato(){
				window.location = '../promts/suministro/download_formato.php';
			}
			...
			function ModPrecio(){
				...
				gru = document.getElementById('gru');
				precio = document.getElementById("precost");
				margen = document.getElementById("margen");
				mon = document.getElementById("mon");
	...
	///////////// Articulos en Masa
			...
			function GrabarMasa(){
				...
				if(filas > 0){
					...
					xajax_Grabar_Masa(gru,suc,arrnombre,arrdesc,arrmarca,arrprov,arrprec,arrmon,arrtcambio,arrcant,filas);
				}else{
