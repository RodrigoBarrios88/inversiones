//funciones javascript y validaciones
			...
			function Ver_Kardex_A(suc,gru,art){
				...
				$.post("../promts/inventariosuministro/kardex1.php",{empresa:suc,grupo:gru,articulo:art}, function(data){
			...
			function Ver_Kardex_B(suc,gru,art){
				var n1 = 1;
				//Realiza una peticion de contenido a la contenido.php
				$.post("../promts/inventariosuministro/kardex2.php",{empresa:suc,grupo:gru,articulo:art}, function(data){
				// Ponemos la respuesta de nuestro script en el DIV recargado
				$("#Pcontainer").html(data);
				});
				abrirModal();
