        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el Curso a asignar la tarea
				</div>
								...
								<?php
									if(is_array($result_cursos)){
										...
										foreach($result_cursos as $row){
											...
											$salida.= '<a class="btn btn-primary btn-block" href="FRMtematarea.php?hashkey='.$hashkey.'&acc='.$acc.'" title = "Seleccionar Curso" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
										}
