<?php
	...
	$ClsTar = new ClsTarea();
	$result = $ClsTar->get_tarea_curso_archivo('',$tarea,'');
	...
	if(is_array($result)){
		...
		foreach($result as $row){
			...
			$arrdoc[$cantidad]["archivo"] = trim($row["arch_codigo"])."_".trim($row["arch_tarea"]).".".trim($row["arch_extencion"]);
    ...
    <div class="visualizador">
		...
		<div class="row">
			<div class="col-xs-1 col-xs-offset-1">
				<a class="btn btn-block btn-info" href = "FRMgestortarea.php?hashkey='<?php echo $hashkey; ?>" title = "Regresar a Tareas"><i class="fa fa-reply"></i></a>
			</div>
			...
			<div class="col-xs-1 col-xs-offset-1">
				<button type="button" class="btn btn-outline btn-primary" onclick = "NewFile(<?php echo $tarea; ?>,1);" title="Cargar material de auxiliar o Gu&iacute;a"><i class="fa fa-cloud-upload"></i> <i class="fa fa-file-picture-o"></i></button>
			</div>
		</div>
		<br>
					...
					<div class="grid-item col-xs-6">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<div>
									<a href="#" class="btn btn-danger btn-xs" role="button" title="Eliminar Archivo" onclick = "Eliminar_Archivo(<?php echo $arrdoc[$i]["codigo"]; ?>,<?php echo $arrdoc[$i]["tarea"]; ?>,'<?php echo $arrdoc[$i]["archivo"]; ?>');"><i class="fa fa-trash"></i></a> 
									<a href="EXEdownload_archivo_tarea.php?archivo=<?php echo $arrdoc[$i]["archivo"]; ?>" class="btn btn-primary btn-xs" role="button" title="Descargar Archivo"><i class="fa fa-download"></i></a>
								</div>
							</div>
						</div>
					</div>
