        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el Tema en el Curso donde se asignar&aacute; la tarea
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-xs-5 col-xs-offset-6 text-rigth">
							<a class="btn btn-primary btn-block" href="IFRMtareas.php?hashkey1=<?php echo $hashkey; ?>" target = "_blank" title = "Ver Todas las Tareas" >
						...
						<div class="col-xs-10 col-xs-offset-1">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									...
									<th width = "50px" class = "text-center">ACTIVIDADES</td>
									<th width = "50px" class = "text-center">ACTIVIDADES ACUMULADAS</td>
									...
									if(is_array($result_temas)){
										...
										foreach($result_temas as $row){
											...
											if(is_array($result_tareas)){
												$actividades = 0;
												$zona = 0;
												foreach($result_tareas as $row_tareas){
													$zona+= trim($row_tareas["tar_porcentaje_zona"]);
													$actividades++;
												}	
											}else{
												$actividades = 0;
											...
											//zona
											$salida.= '<td class = "text-center">'.$zona.' Punto(s).</td>';
											//boton
											$salida.= '<td class = "text-center">';
											if($acc == "gestor"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMgestortarea.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "calificar"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMlistartareas.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "ver"){
											$salida.= '<a class="btn btn-primary btn-block" href="IFRMtareas.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'" target = "_blank" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<h6 class="alert alert-info text-center"> Total de Actividades en el Curso: <label><?php echo $total_actividades; ?></label></h6>
							<h6 class="alert alert-info text-center"> Actividades Totales Acumuladas: <label><?php echo $total_zona; ?> Punto(s).</label></h6>
						</div>
					</div>
					<br>
				</div>
