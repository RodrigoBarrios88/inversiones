<?php
	...
	$tarea = $ClsCur->decrypt($hashkey, $usuario);
	
	$result = $ClsTar->get_tarea_curso($tarea);
	if(is_array($result)){
						...
						<ul class="nav" id="side-menu">
							<li class="active">
								...
								<ul class="nav nav-second-level">
									...
									<?php if($tipo_usuario == 2 || $tipo_usuario == 5){ ?>
									<li>
										<a class="active" href="FRMreenviar.php?FRMreenviar.php?hashkey=<?php echo $hashkey; ?>" >
										<i class="fa fa-send"></i> Re-envair Tarea
										</a>
									</li>
									<?php } ?>
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-3 col-lg-offset-9 text-right">
							<button type="button" class="btn btn-info btn-outline" onclick = "ReEnviarTodos(<?php echo $curso; ?>,<?php echo $tarea; ?>);" ><i class="fa fa-group"></i> <i class="fa fa-send-o"></i> a Todos </button>
						</div>
					</div>
					<div class="row">
						<?php echo tabla_reenvio_tareas($curso,$tarea); ?>
					</div>
					<br>
				</div>
			</div>
