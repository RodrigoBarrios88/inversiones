...
//---------- Horarios y Asistencia ---------//
	...
	function insert_asistencia($horario,$fecha,$alumno,$asistencia,$comentario){
		$fecha = $this->regresa_fecha($fecha);
		...
		$sql.= " VALUES ($horario,'$fecha','$alumno','$fsis','$usuario',$tipo_usuario,$asistencia,'$comentario'); ";
		//echo $sql;
		return $sql;
	}
	
	function modifica_asistencia($horario,$fecha,$alumno,$asistencia,$comentario){
		$fecha = $this->regresa_fecha($fecha);
		$fsis = date("Y-m-d H:i:s");
		$tipo_usuario = $_SESSION['tipo_usuario'];
		$tipo_usuario = ($tipo_usuario != "")?$tipo_usuario:5;
