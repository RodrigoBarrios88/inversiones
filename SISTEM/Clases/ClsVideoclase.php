...
///////////////////////////// VIDEOLLAMADAS //////////////////////////////////////
    ...
    function get_videoclase($codigo,$target = '',$tipo = '',$plataforma = '',$fecha = '',$fini = '',$ffin = '',$usuario = '') {
          ...
          if(strlen($tipoclase)>0) {
               $sql.= " AND vid_tipoclase = $tipoclase";
          }
          if(strlen($codprimario)>0) {
               $sql.= " AND vid_codprimario IN($codprimario)";
          }
	...
	function get_videoclase_recurrente($codprimario) {
          $nombre = trim($nombre);
          $target = trim($target);
          $anio1 = date("Y");
          $anio2 = date("Y");
          ...
          $sql= "SELECT * ";
          $sql.= " FROM  app_videoclase ";
          $sql.= " WHERE vid_codprimario = $codprimario";
	...
	function insert_videoclase($codigo,$nombre,$descripcion,$fini,$ffin,$target,$tipo,$plataforma,$link,$schedule,$event,$partnerId,$usuario = '',$tipoclass,$vidprimaria){
          $nombre = trim($nombre);
          ...
          $sql.= " VALUES ($codigo,'$nombre','$descripcion','$fini','$ffin','$fsist','$fsist','$target',$tipo,'$plataforma','$link','$schedule','$event','$partnerId',$usuario,1,$tipoclass,$vidprimaria);";
          //echo $sql;
          return $sql;
	}
	...
	function delete_videoclase_recurrente($codigo){
          $sql = "DELETE FROM app_videoclase_detalle_grupos ";
          $sql.= " WHERE det_videoclase = $codigo;";
          $sql = "DELETE FROM app_videoclase_detalle_secciones ";
          $sql.= " WHERE det_videoclase = $codigo;";
          ...
          $sql = "DELETE FROM app_videoclase ";
          $sql.= " WHERE vid_codprimario = $codigo;";
