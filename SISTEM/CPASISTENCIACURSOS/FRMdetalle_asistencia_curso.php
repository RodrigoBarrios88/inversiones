<?php
	...
	$result = $ClsAsist->get_horario_asistencia_curso($horario,$fecha);
	if(is_array($result)){
	...
	$titulo = "DETALLE DE ASISTENCIA DEL CURSO $curso_desc PARA EL DIA $dia_desc $fecha de $hora";
        ...
        <div class="row">
           ...
           <div class="col-xs-3">
                ...
                <div class="list-group">
                    ...
                    <?php } ?>
					<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
					<a href="FRMlist_cursos.php" class="list-group-item active"><i class="fa fa-search"></i> Asistencia por Curso Libre</a>
				    <?php } ?>
					<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<?php
									if($horario != "" && $fecha){
										echo tabla_detalle_asistencia_curso($horario,$fecha);
									}else{
