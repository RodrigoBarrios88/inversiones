<?php
	...
	$result = $ClsCur->get_curso_alumno('',$alumno);
	if(is_array($result)){
		foreach($result as $row){
	...
	$periodos = $ClsHor->count_horario_cursos('','',$dia,'','','',$curso);
	$asistencias = $ClsAsist->count_asistencia_cursos('',$fecha,$alumno);
	$ausencias = $ClsAsist->count_ausencia_alumno_cursos('','',$alumno,$mes);
?>
<!DOCTYPE html>
<html lang="en">
										...
										<div class="panel panel-default">
											...
											<div id="collapse1" class="panel-collapse collapse">
												<div class="panel-body">
													<?php
														if($dia != ""){
															echo tabla_periodos_alumno($dia);
														}else{
