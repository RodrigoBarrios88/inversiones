                       ...
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                               <?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
								...
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
								<li>
                                    <a href="FRMlist_cursos_confirmacion.php">
									<i class="fa fa-check-square-o"></i> Confirmaci&oacute;n de Asistencia
									</a>
                                </li>
                                <?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el Curso a revisar confirmaci&oacute;n de asistencia
				</div>
								...
								<?php
									if(is_array($result_cursos)){
										...
										foreach($result_cursos as $row){
											...
											$salida.= '<a class="btn btn-primary btn-block" href="FRMconfirmacion_asistencia_curso.php?hashkey='.$hashkey.'&acc='.$acc.'" title = "Seleccionar Curso" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
										}
