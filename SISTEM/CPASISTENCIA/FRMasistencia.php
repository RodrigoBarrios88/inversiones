<?php
	...
	$titulo = "TOMA DE ASISTENCIA DE $grado_desc SECCI&Oacute;N $seccion_desc PARA EL DIA $dia_desc $fecha";
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
								<li>
									<a href="FRMasistencia.php?hashkey=<?php echo $hashkey; ?>">
         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					<i class="fa fa-check-square-o"></i> Tomar Asistencia
				</div>
