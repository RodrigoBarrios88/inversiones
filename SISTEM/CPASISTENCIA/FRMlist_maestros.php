				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Busca Asistencias Tomadas para los periodos del maestro
						</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
										...
										<div class="col-xs-5"><label>Fecha a buscar:</label> <i class="fa fa-search"></i></div>
									</div>
									<div class="row">
				...
				<div class="col-xs-12">
					<div class="panel panel-default">
						...
						<?php
							if($fecha != ""){
								if($maestro){
									echo tabla_asistencia_maestro($fecha,$maestro);
								}else{
