        ...
        <div class="row">
             ...
             <div class="col-xs-3">
                ...
                <div class="list-group">
                    ...
                    <a href="../CPENCUESTAS/IFRMencuestas.php" class="list-group-item active"><i class="fa fa-paste"></i> Encuestas (Revisi&oacute;n)</a>
            ...
            <div class="col-xs-9">
                ...
                <div class="thumbnail">
                    <div class="caption-full">
						<div class="row">
							<div class="col-xs-8 col-xs-offset-1">
								<h4><a href="javascript:void(0);"><?php echo $titulo; ?></a> (Revisi&oacute;n)</h4>
							</div>
							<div class="col-xs-3 text-right">
								<button type="button" class="btn btn-success" onclick = "ConfirmNotificar(<?php echo $encuesta; ?>);"><span class="fa fa-bell"></span> Notificar</button>
							</div>
						</div>
						<div class="row">
						...
						if(is_array($result)){
							...
							foreach ($result as $row){
								...
								if($tipo == 1){
									...
									$salida.='<div class="form-group">';
										$salida.='<textarea class = "form-control" name = "respuesta'.$i.'" id = "respuesta'.$i.'"  onkeyup = "texto(this)"  disabled >'.$respuesta.'</textarea>';
									$salida.='</div>';
								}
                    ...
                    <div class="ratings">
                        ...
                        <p>
                            Visualizado el <?php echo date("d/m/Y"); ?> a las <?php echo date("H:i"); ?>
                        </p>
                    </div>
					<br>
                </div>
