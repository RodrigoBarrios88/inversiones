            ...
            <div class="col-xs-9">
                <div class="well">
                    <div class="text-right">
						<a href="FRMmodencuesta.php" class="btn btn-primary btn-outline"><i class="fa fa-pencil"></i> Editar Encuestas</a>
                        <a href="FRMnewencuesta.php" class="btn btn-success btn-outline"><i class="fa fa-plus"></i> Nueva Encuesta </a>
                    </div>
                    <?php
						//////////////////////////////////////// GENERAL ///////////////////////////////////////////
