         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body" id = "formulario">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>Fecha Limite:</label> <span class = "text-danger">*</span>
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<textarea class = "form-control" name = "desc" id = "desc" rows="4"  onkeyup = "textoLargo(this)" /><?php echo $desc; ?></textarea>
						</div>
					</div>
					<hr>
					<div class="row">
			...
			<div class="row">
				<div class="col-xs-12">
					<?php
						echo tabla_encuestas($cod,$target,$tipo_target,$destinatarios);
					?>
				</div>
			</div>
	    <!-- /.panel-default -->
