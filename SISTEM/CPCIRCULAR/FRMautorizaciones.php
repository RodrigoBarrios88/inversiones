<?php
	...
	$codigo = $ClsCir->decrypt($hashkey, $id);
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			$target = $row["cir_target"];
			$tipo = $row["cir_tipo_target"];
			$fecha = trim($row["cir_fecha_publicacion"]);
			$fecha = cambia_fechaHora($fecha);
		}	
	}
	
	$alerta = "Circular: $titulo, de fecha $fecha";
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a class="active" href="FRMautorizacion.php">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-group"></i> <label>Autorizaciones o Confirmaciones de Padres y Encargados</label></div>
                <div class="panel-body">
					<h5 class="alert alert-info text-center">
						<?php echo $alerta; ?>
					</h5>
					<?php echo tabla_alumnos_autorizaciones($codigo); ?>
				</div>
			</div>
			<br>
			<!-- /.panel-default -->
