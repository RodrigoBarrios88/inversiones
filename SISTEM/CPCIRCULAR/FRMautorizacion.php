    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-file-text-o"></i> <label>Circulares que requieren autorizaci&oacute;n o confirmaci&oacute;n</label></div>
                <div class="panel-body" id = "formulario">
					<?php
						echo tabla_circular_autorizacion($cod,$target,$tipo);
					?>
				</div>
			</div>
	    <!-- /.panel-default -->
