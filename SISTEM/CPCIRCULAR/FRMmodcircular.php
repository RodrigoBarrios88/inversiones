      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-file-text-o"></i> Actualizar Circular
				</div>
            <div class="panel-body">
				<form action="EXEmodificar.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							...
							&nbsp; <label><input type="radio" id = "autorizacionno" name = "autorizacion" /><label for="autorizacionno" id = "lautorizacionno" > No</label></label>
						</div>
					</div>
					<div class="row">
					...
					<hr>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Cambiar Archivo (PDF):</label> <span class = "text-danger">*</span></div>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<div class="form-group">
								...
								<input type = "hidden" id="documentoold" name = "documentoold" />
								<input type = "hidden" id="docname" name = "docname" />
							</div>
						</div>
						<div class="col-xs-5" id = "olddoc">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<?php
						echo tabla_circular($cod,$target,$tipo);
					?>
					<form name = "f2" name = "f2" ></form>
				</div>
			</div>
			<!-- /.panel-default -->
			<br>
