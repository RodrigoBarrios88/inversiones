      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-group"></i> Actualizaci&oacute;n de Participantes
				</div>
				...
				<form action="EXEmodtarget.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<input type = "text" class = "form-info" name = "titulo" id = "titulo"  value = "<?php echo $titulo; ?>" disbaled />
						</div>
					</div>
					<hr>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-5 text-center">
							...
							<?php
								...
								if($target == "SELECT"){
									if($tipo == 1){
										$result = $ClsCir->get_det_circular_secciones($codigo,'','','','');
									}else if($tipo == 2){
										$result = $ClsCir->get_det_circular_grupos($codigo,'');
									}
								}else{
