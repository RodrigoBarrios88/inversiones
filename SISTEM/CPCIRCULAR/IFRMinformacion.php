...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="#"><i class="fa fa-paste"></i> Circular</a>
					</li>
					<li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                <p class="lead"><i class="fa fa-group-item"></i> Informaci&oacute;n de Circulares</p>
                <div class="list-group">
					<a href="../CPINFO/IFRMinformacion.php" class="list-group-item active"><i class="fa fa-calendar"></i> Informaci&oacute;n de Circulares</a>
            ...
            <div class="col-xs-9">
                <div class="well">
                    ...
                    <div class="text-right">
                        <a class="btn btn-success"><i class="fa fa-thumbs-up"></i> Circulares </a>
                    </div>

                    <?php
								//////////////////////////////////////// GENERAL ///////////////////////////////////////////
								$result = $ClsCir->get_circular("","","0","");
								if(is_array($result)){
									foreach($result as $row){
										$cod = $row["cir_codigo"];
										$usu = $_SESSION["codigo"];
										...
										$tlink = trim($row["cir_autorizacion"]);
										$autorizacion = ($tlink == "#")?"javascript:void(0);":$tlink;
										$target = ($tlink == "#")?"":"_blank";
										$desc = utf8_decode($row["cir_descripcion"]);
										$publicacion = trim($row["cir_fecha_publicacion"]);
										$ffin = trim($row["cir_fecha_publicacion"]);
										//--
										$fechaini = explode(" ",$publicacion); 
										$fecini = $fechaini[0];
								...
								//////////////////////////////////////// GRADOS Y SECCIONES ///////////////////////////////////////////
								$result = $ClsCir->get_det_circular_secciones('',$pensum,$info_nivel,$info_grado,$info_seccion);
								if(is_array($result)){
									foreach($result as $row){
										$cod = $row["cir_codigo"];
										$usu = $_SESSION["codigo"];
								...
								//////////////////////////////////////// GRUPOS ///////////////////////////////////////////
								$result = $ClsCir->get_det_circular_grupos('',$info_grupo);
								if(is_array($result)){
									foreach($result as $row){
										$cod = $row["cir_codigo"];
										$usu = $_SESSION["codigo"];
