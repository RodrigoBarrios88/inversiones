...
<body>
				...
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							...
							<input type = "text" class="form-control" name = "dir" id = "dir" onkeyup = "texto(this);" />
						</div>
					</div>
					<div class = "row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Departamento:</label> <span class = "text-danger">*</span>
							<?php echo departamento_html("dep","xajax_depmun(this.value,'mun','divmun');"); ?>
						</div>
						<div class="col-lg-5">
							...
							<?php
								if($dep != ""){
									echo municipio_html($dep,'mun','');
								}else{
									echo combos_vacios("mun");
								}
							?>
							</div>
						</div>
   ...
   <!-- Modal -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/instalaciones/sede.js"></script>
