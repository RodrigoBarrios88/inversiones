<?php
	include_once('xajax_funct_aula.php');
...
<body>
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMsede.php">
									<i class="fa fa-building-o"></i> Gestor de Sedes
									</a>
								</li>
								<?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="FRMaula.php">
									<i class="fa fa-university"></i> Gestor de Aulas
									</a>
								</li>
								<?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					Gestor de Aulas e Instalaciones
				</div>
				...
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Tipo:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5  col-xs-offset-1">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<button type="button" class="btn btn-default" id = "limp" onclick = "location.reload();"><span class="fa fa-eraser"></span> Limpiar</button>
   ...
   <!-- Modal -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/instalaciones/aula.js"></script>
