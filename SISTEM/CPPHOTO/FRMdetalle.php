<?php
	...
	if(is_array($result)){
		...
		$list.='<button type="button" class="list-group-item active" onclick="targetAlbum('.$codigo.');" >Alumnos agregados en este album <i class="fa fa-plus"></i> <i class="fa fa-group"></i></button>';
		foreach($result as $row){
   ...
   <div id="wrapper">
					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<?php } ?>
								<li>
									<a class="active" href="FRMalbum.php">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-xs-5 col-lg-offset-1 col-xs-6">
							<a class="btn btn-default" href="FRMalbum.php">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<form action="EXEalbum.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
								<button type="button" class="btn btn-primary btn-block" id = "btn-foto" onclick = "FotoJs();" title = "Fotos del Album">
									<i class="fa fa-plus"></i> <i class="fa fa-camera"></i> Agregar Fotos al Album
								</button>
								<input id="fotos" name="fotos" type="file" class="hidden" onchange="ValidaFoto();" >
								<input type = "hidden" id="codigo" name = "codigo" value="<?php echo $codigo; ?>" />
								<input type = "hidden" id="cuantos" name = "cuantos" value="1" />
								<p id = "etiqueta"></p>
							</form>
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<h4 class="text-info text-justify"><?php echo $descripcion; ?></h4>
						</div>
					</div>
					<?php
						$ClsPho = new ClsPhoto();
							...
							<div>
								<div class="thumbnail text-center">
									...
									<div class="thumbnail-control">
										<a href="javascript:void(0);" onclick="deleteFoto(<?php echo $codigo; ?>,'<?php echo $imagen; ?>');" class="fa fa-trash fa-2x text-danger pull-right"></a>
									</div>
								</div>
							</div>
					<?php
			...
			<!-- /.panel-default -->
			<div id="fab">
				<a class="open-fab-primary" href="javascript:void(0);" onclick = "FotoJs();" title="Agregar fotos al album">
