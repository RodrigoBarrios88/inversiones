...
<html>
	...
	<body>
		<div align = "center">
			...
			<h3>Reporte de Historial de Compras y Gastos</h3>
		<p>
	...
	<?php 
		if($tipo == "C"){
			...
			echo rep_tabla_historial_compra($cod,"C",$suc,$doc,$fini,$ffin,''); 
		}else if($tipo == "G"){
			echo "<p><b>Gastos:</b></p> ";
			echo rep_tabla_historial_compra($cod,"C",$suc,$doc,$fini,$ffin,'');
		}else{
			...
			echo rep_tabla_historial_compra($cod,"G",$suc,$doc,$fini,$ffin,'');
		}
