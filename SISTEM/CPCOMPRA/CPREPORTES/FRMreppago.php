  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado"> Reporte de Pagos de Compras y Gastos </h3>
			<br>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td>
								<input type = "text" class = "text" name = "cod" id = "cod" onkeyup = "enteros(this);KeyEnter(this,BuscarCompra);" />
								</td>
							<td class = "celda" align = "right">Documento Resp.: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "ref" id = "ref" onkeyup = "texto(this);KeyEnter(this,BuscarCompra);" /></td>
						</tr>
						<tr>
							<td colspan = "4" align = "center">
								<div class = "boxboton" style = "width:200px;">
									...
									<a class="button" href="FRMreppago.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
