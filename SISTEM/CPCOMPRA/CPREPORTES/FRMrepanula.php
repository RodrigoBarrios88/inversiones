  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Reporte de Anulaci�n de Compras y Gastos </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td class = "celda" align = "right">Clasificaci�n: <span class = "busca">*</span></td>
							<td align = "left">
								<select id = "class" name = "class" class = "combo">
						...
						<tr>
							<td class = "celda" align = "right"># Transacci�n: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "cod" id = "cod" onkeyup = "enteros(this)" /></td>
							<td class = "celda" align = "right">Documento Resp.: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "ref" id = "ref" onkeyup = "texto(this)" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReporteAnula()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
								<a class="button" href="FRMrepanula.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
