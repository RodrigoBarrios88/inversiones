  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Listado de Creditos por Pagar </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td class = "celda" align = "right">Doc. Compra: <span class = "busca">*</span></td>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
									<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReporteCredit()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
									<a class="button" href="FRMrepcreditos.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
