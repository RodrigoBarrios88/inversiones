    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-history"></i> Historial de Compras o Gastos</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								if($desde != "" && $hasta != ""){
									echo tabla_historial_compra($cod,$class,$prov,$suc,$doc,$desde,$hasta,$sit,"H");
								}
							?>
						</div>
					</div>
