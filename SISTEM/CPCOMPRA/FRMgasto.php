    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-dollar"></i> Registro de gastos</label></div>
				...
				<form id='f1' name='f1' method='get' action="FRMcompra_detalle.php" target="IFdetalle">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<input type = "hidden" name = "class" id = "class" value = "G" />
					...
					<br>
					<div class="row">
						<div class="alert alert-info text-center" role="alert"><em>Detalle de Gasto</em></div>
					</div>
					<br>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Listar Gastos Adquiridos con este Proveedor:</label> <span class = " text-info">*</span></div>
						<div class="col-xs-5"><label>Codigo de Importaci&oacute;n de Gastos Anteriores:</label> <span class = " text-info">*</span>&nbsp; <i class="fa fa-qrcode"></i></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<button type="button" class="btn btn-default btn-block" onclick = "ImportarProductosProveedor('G');"><span class="fa fa-download"></span> <span class="fa fa-navicon"></span></button>
						</div>
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "importar" id = "importar" onkeyup = "enteros(this);KeyEnter(this,ImportarCompra);" />
							<input type = "hidden" name = "tipoCompra" id = "tipoCompra" value = "G" />
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Partida de Egresos:</label> <span class = " text-danger">*</span></div>
						<div class="col-xs-5 "><label id = "cntreg">Regl&oacute;n de Compra:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php echo partida_html_demas("6","par","xajax_Combo_Reglon(this.value,'reg','sreg')"); ?>
							<input type = "hidden" name = "tip" id = "tip" value = "S"/>
						</div>
						<div class="col-xs-5" id = "sreg">
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1" id = "lb1"><label id = "cntart">Descripci&oacute;n:</label> <span class = " text-info">*</span></div>
					</div>
					<div class="row">
	    ...
	    <div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					 <iframe id = "IFdetalle" name = "IFdetalle" src="FRMcompra_detalle.php?tipoCompra=G"></iframe>
				</div>
			</div>
	    </div>
