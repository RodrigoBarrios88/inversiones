   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper">
         <br>
			<div class="panel panel-default">
				...
				<div class="panel-body"> 
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>Link <small>(Enlace)</small>:</label>
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<button type="button" class="btn btn-default" id = "limp" onclick = "window.location.reload();"><i class="fa fa-eraser"></i> Limpiar</button>
			...
			<div class="row">
				<div class="col-lg-12">
					<?php echo tabla_multimedia($codigo,$tipo,$categoria,$ordenado_por); ?>
				</div>
			</div>		
		</div>
      <!-- /#page-wrapper -->
