					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a class="active" href="FRMlist_asignotas.php">
			...
			<div class="row">
					<?php
						...
						if($pensum != "" && $nivel != "" && $grado != "" && $materia != "" && $seccion != "" && $unidad != ""){
							...
							echo tabla_secciones_alumnos_notas($pensum,$nivel,$grado,$seccion,$materia,$unidad,$calificacion,1);
							
							/*if($calificacion == 1){
								echo tabla_secciones_alumnos_notas($pensum,$nivel,$grado,$seccion,$materia,$unidad,$calificacion,1);
							}else if($calificacion == 2){
								echo tabla_secciones_alumnos_notas_literales($pensum,$nivel,$grado,$seccion,$materia,$unidad,$calificacion,1);
							}else if($calificacion == 3){
								echo tabla_secciones_alumnos_notas_tipificacion($pensum,$nivel,$grado,$seccion,$materia,$unidad,$calificacion,1);
							}else{
								echo "";
							}*/
						}
