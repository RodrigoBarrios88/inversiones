...
<body>
					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 5 || $tipo_usuario == 1){ ?>
								<li>
									<a class="active" href="FRMlista_diplomas.php">
               ...
               <div class="panel-body">
                  ...
                  <div class="row">
                     <div class="col-xs-10 col-xs-offset-1 text-center">
                        <button type="button" class="btn btn-primary btn-block" id = "busc" onclick = "Diplomas();"><span class="glyphicon glyphicon-print"></span> Imprimir Todos</button>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-12" id = "result">
                  <?php
                     ...
                     if($pensum != "" && $nivel != "" && $grado != "" && $seccion != ""){
                        echo tabla_secciones_alumnos_diplomas($pensum,$nivel,$grado,$seccion);
                     }
                  ?>
               </div>
            </div>
   ...
   <script>
		...
		function Diplomas(){
			...
			myform.action = "CPREPORTES/REPdiploma_masa.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
		}
