...
<body>
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
            <div class="panel-heading"> 
               ...
               Estad&iacute;sticas por Materias, Grado y Secci&oacute;n
            </div>
            <div class="panel-body"> 
               ...
               <div class="row">
                  <div class="col-xs-5 col-xs-offset-1"><label>Nota M&iacute;nima:</label></div>
               </div>
               <div class="row">
                  <div class="col-xs-5 col-xs-offset-1">
   ...
   <script>
      function Reporte(){
         ...
         myform.action ="CPREPORTES/GRAPnotas_materias_seccion.php";
         myform.submit();
         myform.action ="";
         myform.target ="";
      }
