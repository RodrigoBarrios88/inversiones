...
<body>
    <div id="wrapper">
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									...
									<i class="fa fa-edit"></i> Gestor de Unidades
									</a>
                                </li>
								<?php } ?>
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
                                <li>
                                    <a href="FRMrepunidad.php">
        ...
        <div id="page-wrapper">
            <form name = "f1" id = "f1" action="REPunidades.php" method="get" target = "_blank">
            <br>
            <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								<?php echo pensum_html("pensum","xajax_Pensum_Nivel(this.value,'nivel','divnivel','');"); ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-primary" id = "busc" onclick = "Submit();"><span class="fa fa-search"></span> Buscar</button>
                            </div>
                        </div>
						<br>
					</div>
