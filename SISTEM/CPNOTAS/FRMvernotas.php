					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a class="active" href="FRMlist_vernotas.php">
				...
				<div class="panel-body"> 
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<?php if($pensum != "" && $nivel != "" && $grado != "" && $materia != "" && $seccion != "" && $unidad != ""){ ?>
							<a class="btn btn-default" target="_blank" href="CPREPORTES/REPvernotas.php?pensum=<?php echo $pensum; ?>&nivel=<?php echo $nivel; ?>&grado=<?php echo $grado; ?>&seccion=<?php echo $seccion; ?>&materia=<?php echo $materia; ?>&unidad=<?php echo $unidad; ?>">
			...
			<div class="row">
					<?php
						...
						if($pensum != "" && $nivel != "" && $grado != "" && $materia != "" && $seccion != "" && $unidad != ""){
							if($calificacion == 1){
								echo tabla_secciones_ver_notas($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else if($calificacion == 2){
								//echo tabla_secciones_alumnos_notas_literales($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else if($calificacion == 3){
								//echo tabla_secciones_alumnos_notas_tipificacion($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else{
								echo "";
							}
						}
