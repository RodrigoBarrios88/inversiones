					...
					<ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 5 || $tipo_usuario == 1){ ?>
								<li>
									<a class="active" href="FRMlist_editnotas.php">
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Modificaci&oacute;n o Actualizaci&oacute;n de Notas 
				</div>
			...
			<div class="row">
					<?php
						...
						if($pensum != "" && $nivel != "" && $grado != "" && $materia != "" && $seccion != "" && $unidad != ""){
							if($calificacion == 1){
								echo tabla_secciones_alumnos_modificaciones($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else if($calificacion == 2){
								echo tabla_secciones_alumnos_modificaciones_literales($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else if($calificacion == 3){
								echo tabla_secciones_alumnos_modificaciones_tipificacion($pensum,$nivel,$grado,$seccion,$materia,$unidad,1);
							}else{
								echo "";
							}
						}
