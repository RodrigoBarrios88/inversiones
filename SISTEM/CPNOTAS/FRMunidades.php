					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="../CPACADEMICO/FRMimportpensum.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPACADEMICO/FRMpensum.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPACADEMICO/FRMnivel.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPACADEMICO/FRMgrado.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPACADEMICO/FRMseccion.php">
								...
								<li>
									<a href="CPREPORTES/FRMrepunidad.php">
										<i class="fa fa-print"></i> Reporte de Unidades
									</a>
								</li>
								<?php } ?>
								<hr>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					<i class="fa fa-edit"></i> Gestor de Unidades de Calificaci&oacute;n (Semestres, Trimestres, Bimestres, etc.)
				</div>
				...
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							...
							<input type = "text" class = "form-control" name = "porcent" id = "porcent" onkeyup="decimales(this)" />
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarUnidad();"><span class="fa fa-save"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarUnidad();"><span class="fa fa-save"></span> Grabar</button>
						</div>
					</div>
					<br>
				</form>
			...
			<div class="row">
				<div class="col-lg-12" id="result">
					<?php echo tabla_unidades($pensum,$nivel,$unidad); ?>
				</div>
			</div>
		</div>
      <!-- /#page-wrapper -->
