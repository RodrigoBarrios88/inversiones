...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <hr>
								<li>
                                    <a href="FRMboleta_temporal.php">
									<i class="fa fa-money"></i> Boletas Temporales
									</a>
                                </li>
                                <li>
                                    <a href="FRMboleta_pagada_temporal.php">
									<i class="fa fa-dollar"></i> Boletas Pagadas
									</a>
                                </li>
                                <hr>
								<li>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Depurador de Boletas Temporales
						</div>
						<div class="panel-body"> 
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
										<div class="col-xs-5 col-xs-offset-1"><label>No. de Cuenta:</label></div>
									</div>
									<div class="row">
										<div class="col-xs-5 col-xs-offset-1">
											<input type= "text" class="form-control" id = "ncuenta" name  = "ncuenta" onkeyup="enteros(this);" />
										</div>
									</div>
									<hr>
									<div class="row">
    ...
    <script>
		function Reporte(){
			...
			myform.action ="REPboleta_pagada_temporal.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
		}
