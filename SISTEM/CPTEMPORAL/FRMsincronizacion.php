    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label>Formulario de Sincronizaci&oacute;n de Alumnos Temporales</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-success" id = "gra" onclick = "Sincronizar();"><span class="fa fa-refresh"></span> Sincronizar</button>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<?php
								if($nivel != "" && $grado != "" && $seccion != ""){
									echo tabla_depuracion_alumnos($pensum,$nivel,$grado,$seccion);
								}
							?>
						</div>
					</div>
