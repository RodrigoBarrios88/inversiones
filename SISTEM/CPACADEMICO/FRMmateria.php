...
<body>
    <div id="wrapper">
		...
		<form name = "f1" id = "f1" method="get">
					...
					<div class="panel panel-default">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarMateria();"><span class="fa fa-save"></span> Grabar</button>
								<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarMateria();"><span class="fa fa-save"></span> Grabar</button>
								<button type="button" class="btn btn-danger" id = "limp" onclick = "window.location.reload();"><span class="fa fa-times"></span> Cancelar</button>
							</div>
						</div>
						<br>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<?php echo tabla_materias($pensum,$nivel,$grado,$tipo,1); ?>
				</div>
			</div>
		</form>
		</div>
