					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="CPREPORTES/FRMrepasiggrado.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
									<a href="CPREPORTES/FRMrepasigseccion.php">
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Asignaci&oacute;n de Secciones 
				</div>
				...
				<div class="col-lg-12" id = "result">
					<?php
						if($pensum != "" && $nivel != "" && $grado != ""){
							echo tabla_secciones_alumnos(1,$pensum,$nivel,$grado,$tipo);
						}
					?>
				</div>
			</div>
