					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="CPREPORTES/FRMrepnivel.php">
										<i class="fa fa-print"></i> Reporte de Niveles
									</a>
								</li>
								<?php } ?>
								<hr>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body"> 
					<div class="row">
						...
						<div class="col-xs-5"><label>Descripci&oacute;n:</label></div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarNivel();"><span class="fa fa-save"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarNivel();"><span class="fa fa-save"></span> Grabar</button>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_niveles($pensum,'','1'); ?>
						</div>
					</div>		
				</div>
				<br>
