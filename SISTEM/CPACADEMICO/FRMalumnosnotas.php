							...
							<div class="row">
                                    ...
                                    <div class="row">
										<div class="col-xs-5 col-xs-offset-1">
											<select id = "tipo" name = "tipo" class = "form-control" onchange="Submit();">
												...
												<option value = "1" selected >EVALUACION DE UNIDAD</option>
								...
								<div class="row">
									<div class="col-xs-12 text-center">
										...
										<a class="btn btn-default" onclick="confirmTarjetaNotasMasa(1);" title = "Desplegar Listado" ><span class="fa fa-print text-primary"></span> &nbsp; <strong class="text-primary">Imprimir </strong></a> 
									</div>
								</div>
                            <hr>
							<div class="row">
