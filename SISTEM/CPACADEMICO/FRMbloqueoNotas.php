...
<body>
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="FRMbloqueoNotas.php">
										<i class="fa fa-tag"></i> Visualizaci&oacute;n de Notas
									</a>
								</li>
								<?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Hablitar Notas de Alumnos
				</div>
				<div class="panel-body"> 
						<div class="col-lg-12">
							<?php echo tabla_bloqueo($pensum_vigente); ?>
						</div>
					</div>		
				</div>
				<br>
   ...
   <!-- /#wrapper -->
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/academico/bloqnotas.js"></script>
