   ...
   <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="CPREPORTES/FRMrepseccion.php">
										<i class="fa fa-print"></i> Reporte de Secciones
									</a>
								</li>
								<?php } ?>
								<hr>
		...
		<div id="page-wrapper">
				...
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<a class="btn btn-default" id = "limp" href = "FRMseccion.php"><i class="fa fa-eraser"></i> Limpiar</a>
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarSeccion();"><i class="fa fa-save"></i> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarSeccion();"><i class="fa fa-save"></i> Grabar</button>
						</div>
					</div>
					</form>
					<br>
			...
			<div class="row">
				<div class="col-lg-12">
					<?php echo tabla_secciones($pensum,$nivel,$grado,$tipo,1); ?>
				</div>
			</div>
		</div>
      <!-- /#page-wrapper -->
