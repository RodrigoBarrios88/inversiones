        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la Secci&oacute;n a listar las Notas
				</div>
				<br>
				<div class="row">
							...
							<?php
								if(is_array($result_secciones)){
									...
									foreach($result_secciones as $row){
										...
										$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMalumnosnotas.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
										$salida.= '</td>';
										//--
										$salida.= '</tr>';
										$i++;
