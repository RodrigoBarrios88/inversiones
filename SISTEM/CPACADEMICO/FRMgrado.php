					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="CPREPORTES/FRMrepgrado.php">
										<i class="fa fa-print"></i> Reporte de Grados
									</a>
								</li>
								<?php } ?>
								<hr>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					<i class="fa fa-tag"></i> Gestor de Grados
				</div>
				...
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<a class="btn btn-default" id = "limp" href = "FRMgrado.php"><i class="fa fa-eraser"></i> Limpiar</a>
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarGrado();"><i class="fa fa-save"></i> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarGrado();"><i class="fa fa-save"></i> Grabar</button>
						</div>
					</div>
					<br>
				</form>
			...
			<div class="row">
				<div class="col-lg-12">
					<?php echo tabla_grados($pensum,$nivel,'','1'); ?>
				</div>
			</div>
		</div>
      <!-- /#page-wrapper -->
