         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Importar Programa Acad&eacute;mico
				</div>
				<div class="panel-body"> 
					<form name = "f1" id = "f1" method="get">
					<div class="row">
						<div class="col-xs-6 col-xs-offset-3"><label>Pensums Anteriores:</label></div>
					</div>
					<div class="row">
					...
					<hr>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Nombre a Definir:</label></div>
						<div class="col-xs-5"><label>A&ntilde;o:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type="text" class="form-control" id="desc" name="desc" onkeyup="texto(this)" />
						</div>
						<div class="col-xs-5">
							<input type="text" class="form-control" id="anio" name="anio" onkeyup="enteros(this)" maxlength="4" />
						</div>
					</div>
					</form>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" onclick = "Confirm_Importar_Pensum();"><span class="fa fa-save"></span> Grabar</button>
						</div>
					</div>
					<br>
				</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php
						if($pensum != ""){ 
							echo tabla_pensum_para_importar($pensum);
						}
					?>
					<!-- TREEVIEW CODE -->
