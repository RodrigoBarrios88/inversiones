                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									...
									<i class="fa fa-bookmark"></i> Gestor de Programa Acad&eacute;mico
									</a>
                                </li>
								<?php } ?>
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
                                <li>
                                    <a href="FRMreppensum.php">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Reporte de Programa Acad&eacute;mico
						</div>
						<br>
						<div class="row">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<?php
								if($pensum != ""){ 
									echo tabla_pensum_grafico($pensum);
								}
							?>
							<!-- TREEVIEW CODE -->
