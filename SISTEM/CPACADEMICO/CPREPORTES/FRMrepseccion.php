...
<body>
    <div id="wrapper">
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									...
									<i class="fa fa-bookmark"></i> Gestor de Secciones
									</a>
                                </li>
								<?php } ?>
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
                                <li>
                                    <a href="FRMrepseccion.php">
        ...
        <div id="page-wrapper">
            <form name = "f1" id = "f1" action="REPseccion.php" method="post" target = "_blank">
            <br>
            <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								<?php echo pensum_html("pensum","xajax_Pensum_Nivel(this.value,'nivel','divnivel','Combo_Nivel_Grado();');"); ?>
								<input type = "hidden" name = "cod" id = "cod" />
							</div>
							<div class="col-xs-5" id = "divnivel">
								<?php echo combos_vacios("nivel"); ?>
							</div>
						</div>
						<div class="row">
