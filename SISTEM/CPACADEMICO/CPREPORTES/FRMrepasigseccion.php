...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="../FRMasiggrado.php">
									<i class="glyphicon glyphicon-user"></i> Asignaci&oacute;n de Grados
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="../FRMasigseccion.php">
									<i class="glyphicon glyphicon-user"></i> Asignaci&oacute;n de Secciones
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMrepasiggrado.php">
									<i class="glyphicon glyphicon-print"></i> Reporte de Alumnos por Grados
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMrepasigseccion.php">
									<i class="glyphicon glyphicon-print"></i> Reporte de Alumnos por Secciones
									</a>
                                </li>
                                <?php } ?>
								<hr>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Asignaci&oacute;n de Secciones (Listado de Alumnos)
						</div>
    ...
    <script>
		function Reporte(){
			...
			if(pensum.value !=="" && nivel.value !=="" && grado.value !== "" && seccion.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="REPasigseccion.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
