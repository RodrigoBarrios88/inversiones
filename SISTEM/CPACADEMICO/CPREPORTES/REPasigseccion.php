	...
	<nav class="navbar navbar-default navbar-fixed-top" style = "z-index:500;">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text fa-fw"></i> Listado de Alumnos por Secciones (<strong><?php echo $grado_desc; ?></strong>)
			</div>
					...
					<div class = "col-xs-12">
						<?php
							if($pensum != "" && $nivel != "" && $grado != ""){
								echo tabla_secciones_alumnos(1,$pensum,$nivel,$grado,$seccion,$tipo);
							}
						?>
					</div>
				</div>
