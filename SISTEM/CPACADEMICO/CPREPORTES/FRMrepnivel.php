...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../FRMnivel.php">
									<i class="fa fa-bookmark"></i> Gestor de Niveles
									</a>
                                </li>
								<?php } ?>
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
                                <li>
                                    <a href="FRMrepnivel.php">
        ...
        <div id="page-wrapper">
            <form name = "f1" id = "f1" action="REPnivel.php" method="post" target = "_blank">
            <br>
            <div class="row">
				<div class="col-lg-12">
