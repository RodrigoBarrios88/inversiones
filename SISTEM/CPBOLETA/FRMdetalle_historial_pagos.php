                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["CARGAELECTRO"] == 1){ ?>
								<li>
									<a class="active" href="FRMhistorial_cargas.php">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-table"></i> Formulario Lector de Cargas Electr&oacute;nicas
				</div>
            <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="row">
							<div class="col-xs-12 text-center">
								<a class="btn btn-outline btn-success" title="Generar Facturas" href="../CPBOLETAFACTURAS/FRMgestor_facturas.php?hashkey=<?php echo $hashkey; ?>" ><i class="fa fa-dollar"></i> Generar Facturas</a>  
								<a class="btn btn-outline  btn-info" title="Generar Recibos" href="../CPBOLETAFACTURAS/FRMgestor_recibos.php?hashkey=<?php echo $hashkey; ?>" ><i class="fa fa-check"></i> Generar Recibo</a>
							</div>
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_carga_electronica($carga); ?>
						</div>
					</div>
					</form>
					<br>
