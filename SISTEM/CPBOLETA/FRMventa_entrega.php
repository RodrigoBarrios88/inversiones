                    ...
                    <ul class="nav" id="side-menu">
						<li class="active">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMventa_entrega.php">
										<i class="fa fa-shopping-cart"></i> Entrega de Uniformes
									</a>
								</li>
								<?php } ?>
				...
				<div class="panel-body" id = "formulario">
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								echo tabla_boletas_venta($periodo,$division,$grupo,$referencia,$alumno,$desde,$hasta);
							?>
						</div>
					</div>
				</div>
