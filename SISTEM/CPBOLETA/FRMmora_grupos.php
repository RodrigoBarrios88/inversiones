    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-search"></i> Buscar Grupos de Boletas de Mora</div>
            <div class="panel-body">
				<form id='f1' name='f1' method='get'>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php echo empresa_html("empresa","Sumbit();"); ?>
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							 <a class="btn btn-default" href = "FRMmora_grupos.php"><i class="fa fa-eraser"></i> Limpiar</a>
			...
			<div class="row">
				<?php
						if($desde != '' && $hasta != ''){
							...
							echo tabla_grupos_mora($cue,$ban,$empresa,$desde, $hasta);
						}
					?>
