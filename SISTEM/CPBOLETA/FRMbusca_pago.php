    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["NEWCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMbusca_pago.php">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-search"></i> Buscador de Pagos Efectuados</label></div>
					...
					<div class="row">
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" href = "FRMbusca_pago.php"><i class="fa fa-eraser"></i> Limpiar</a>
							...
							<?php
								if($periodo != ""){
									if($boleta != "" || $referencia != "" || $alumno != ""){
										echo tabla_lista_pagos($boleta,$cue,$ban,$alumno,$referencia,$periodo);
