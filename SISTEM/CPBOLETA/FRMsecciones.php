                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["BOLEXT"] == 1){ ?>
									<li>
										<a href="FRMsecciones.php?acc=BOLEXT">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xs-6 text-right">
							<a class="btn btn-default" title="Limpiar" href = "FRMdirectorio.php?acc=<?php echo $acc; ?>&pensum=<?php echo $pensum; ?>"><span class="fa fa-group"></span> Directorio de Alumnos</a>
						</div>
					</div>
					<br>	
							...
							<tr>
								...
								<?php
									...
									foreach($result_secciones as $row){
										...
										$salida.= '<a class="btn btn-primary btn-block" href="FRMlistalumno.php?acc='.$acc.'&hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'" title = "Seleccionar Secci&oacute;n" ><i class="fa fa-arrow-right "></i></a>';
										$salida.= '</td>';
										$salida.= '</tr>';
										$i++;
									}
