    ...
    <div id="wrapper">
                  ...
                  <ul class="nav" id="side-menu">
							<li class="active">
								...
								<ul class="nav nav-second-level">
									...
									<li>
										<a class="active" href="FRMsecciones.php?acc=BOLEXT">
											<i class="fa fa-file-text"></i> Boletas Extraordinarias
										</a>
									</li>
									<?php } ?>
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-money"></i> Gestor de Boletas Extraordinarias</div>
            <div class="panel-body" id = "formulario">
				<form id='f1' name='f1' method='get'>
					<div class="row">
						...
						<div class="col-xs-5 col-xs-12 text-right">
							<span class = "text-danger">* Campos de Obligatorios</span>
						</div>
					</div>
					<hr>	
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							...
							<input type="text" class="form-info" value = "<?php echo $nivel_desc; ?>" readonly />
						</div>
						<div class="col-lg-5 col-xs-12">
							<label>Grado:</label> <span class="text-danger">*</span>
							<input type="text" class="form-info" value = "<?php echo $grado_desc; ?>" readonly />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-5 col-xs-12 col-lg-offset-1">
							<label>Alumno:</label>
							<input type="text" class="form-info" id="nombre" value = "<?php echo $alumno; ?>" readonly />
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<label>Motivo:</label>
							<input type="text" class="form-control" id="motivo" name="motivo" value = "<?php echo $motivo; ?>" onkeyup="texto(this);" maxlength="250" />
						</div>
					</div>
					<hr>
					<div class="row">
					...
					<div class="row">
						<div class="row">
							<div class="col-xs-12 text-center">
								<a class="btn btn-default" title="Limpiar" href = "FRMboletaextra.php?hashkey=<?php echo $hashkey; ?>&pensum=<?php echo $pensum; ?>"><span class="fa fa-eraser"></span> Limpiar</a>
								<button type="button" class="btn btn-primary" id = "grab" onclick = "BoletaExtraordinaria();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							</div>
						</div>
               </div>
				</form>
