...
<body>
   ...
   <div id="page-wrapper">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-upload"></i> Carga Electr&oacute;nica</div>
			<div class="panel-body" id = "formulario">
				<form action="EXEcarga.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right text-danger">* Campos Obligatorios</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Adjuntar Archivo:</label> </div>
					</div>
					<div class="row">
						...
						<div class="col-xs-5 text-center">
							<a class="btn btn-outline btn-success btn-block" href="CARGAS/download_formato.php" target="_blank" ><i class="fa fa-download"></i> <i class="fa fa-file-excel-o"></i> Descargar Formato de Carga Electr&oacute;nica</a>
						</div>	
					</div>
					<br>
					<div class="row">
