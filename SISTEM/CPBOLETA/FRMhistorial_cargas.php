...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-table"></i> Historial de Cargas Electr&oacute;nicas</div>
                <div class="panel-body" id = "formulario">
					<form id='f1' name='f1' action='#' method='get'>
						<div class="row">
							<div class="col-lg-12" id = "result">
								<?php echo tabla_historial_cargas(); ?>
							</div>
						</div>
					</form>
					<br>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/colegiatura/carga.js"></script>
