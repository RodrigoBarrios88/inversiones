        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-print"></i> Reporte de Descuentos &nbsp; &nbsp; <i class="fa fa-minus"></i> <i class="fa fa-dollar"></i><i class="fa fa-dollar"></i><i class="fa fa-dollar"></i>
				</div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Mes:</label> <span class = "text-info">*</span></div>
						<div class="col-xs-5"><label>Nivel:</label> <span class = "text-info">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<select class="form-control" id = "mes" name = "mes" onchange="Submit();">
								<option value="13">- Todo el a&ntilde;o -</option>
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMdescuentos.php"><span class="fa fa-eraser"></span> Limpiar</a> 
    ...
    <script>
		function Reporte(){
			...
			if((anio.value !== "" || periodo.value != "") && division.value !== "" && grupo.value !== ""){
				...
				myform.action ="REPdescuentos.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
				...
				if(periodo.value ===""){
					periodo.className = "form-control alert-info";
				}else{
		...
		function Excel(){
			...
			if((anio.value !== "" || periodo.value != "") && division.value !== "" && grupo.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="EXCELdescuentos.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
