<?php
	...
	$anio = $_REQUEST["anio"];
	$periodo = ($periodo == "" && $anio == "")?$periodo_vigente:$periodo;
...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["NEWCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMsolventes.php">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-print"></i> Reporte de Solventes (Alumnos que tienen saldo 0 a favor)
				</div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Hasta (Fecha de Corte):</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMsolventes.php"><span class="fa fa-eraser"></span> Limpiar</a> 
    ...
    <script>
		function Reporte(){
			...
			if((anio.value !== "" || periodo.value != "") && hasta.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="REPsolventes.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
