    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-print"></i> Reporte de Ingresos &nbsp; &nbsp; <i class="fa fa-plus"></i> <i class="fa fa-dollar"></i><i class="fa fa-dollar"></i><i class="fa fa-dollar"></i></div>
    ...
    <script>
		...
		function Excel(){
			...
			if(cuenta.value !== "" && desde.value !== "" && hasta.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="EXCELingresos.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
