					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<a class="btn btn-default" href = "FRMlistpagos.php"><i class="fa fa-eraser"></i> Limpiar</a> 
								<button type="button" class="btn btn-primary" id = "busc" onclick = "Reporte();"><i class="fa fa-search"></i> Buscar</button>
								<button type="button" class="btn btn-success" id = "excel" onclick = "Excel();"><i class="fa fa-file-excel-o"></i> Excel</button>
							</div>
						</div>
					</div>
				</div>
   ...
   <!-- Bootstrap Core JavaScript -->
    ...
    <script>
		function Reporte(){
			...
			if(cuenta.value !== "" && desde.value !== "" && hasta.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="REPlistpagos.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
				...
				swal("Ohoo!", "Debe seleccionar las fechas a consultar y el numero de cuenta...", "info");
			}
		}
		...
		function Excel(){
			...
			if(cuenta.value !== "" && desde.value !== "" && hasta.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="EXCELlistpagos.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
