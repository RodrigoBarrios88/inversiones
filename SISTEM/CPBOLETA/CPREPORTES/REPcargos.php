<?php
	...
	if($mes == 13){
		$longitud = " de todo el a&ntilde;o";
	}else{
		$mes_nombre = strtolower(Meses_Letra($mes));
		$longitud = " del mes de $mes_nombre";
	}
	
	/// habilitando para pruebas de estrés...
	$nombre = "Prueba";
	$valida = 1;
			...
			<div class = "row">
				<div class = "col-xs-10 col-xs-offset-1 text-center">
					<h5 class="alert alert-info">
						<i class="fa fa-dollar"></i> Reporte de Cargos <?php echo $longitud; ?> | Divisi&oacute;n <?php echo $division_desc; ?> | Grupo <?php echo $grupo_desc; ?>
					</h5>
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12">
					<?php
						echo tabla_cargos($division,$grupo,$tipo,$anio,$periodo,$mes,$nivel,$grado,$seccion);
					?>
				</div>
			</div>
		</div>
        ...
        $(document).ready(function(){
           $('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Cargos'},
                    {extend: 'print',
