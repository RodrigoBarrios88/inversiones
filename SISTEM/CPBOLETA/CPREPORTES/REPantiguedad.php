<?php
	...
	if($grupo != "" && $division != ""){
		...
		if(is_array($result)){
			...
			$cuenta_titulo = " / Divisi&oacute;n: $division_desc - $grupo_desc";
		}
	}
...
<body>
    ...
    <div class="panel panel-default">
		<div class="panel-heading">
			<i class="fa fa-calendar"></i> Reporte de Antiguedad de Saldos
		</div>
		<div class="panel-body">
			<div class = "row">
				<div class = "col-xs-12 text-center">
					<h5 class="alert alert-danger">
						<i class="fa fa-calendar"></i> Reporte de Antiguedad de Saldos a la fecha <?php echo $cuenta_titulo; ?>
					</h5>
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12">
					<?php
						echo tabla_antiguedad_saldos($division,$grupo,$periodo,$tipo,$desde,$hasta);
					?>
				</div>
			</div>
		</div>
        ...
        $(document).ready(function(){
           $('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Antiguedad de Saldos'},
                    {extend: 'pdf', title: 'Reporte de Antiguedad de Saldos'},
                    ...
                    {extend: 'print',
						...
						title: 'Reporte de Antiguedad de Saldos'
                    }
                ]
