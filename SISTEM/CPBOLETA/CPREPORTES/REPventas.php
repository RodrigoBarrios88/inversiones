...
<body>
    ...
    <div class="panel panel-default">
		<div class="panel-heading">
			<i class="fa fa-plus"></i> <i class="fa fa-dollar"></i> Reporte de Ventas con Boleta de Pago
		</div>
		<div class="panel-body">
			<div class = "row">
				<div class = "col-xs-10 col-xs-offset-1 text-center">
					<h5 class="alert alert-info">
						<i class="fa fa-plus"></i> Reporte de Ventas Con Boleta de Pago / Divisi&oacute;n: <?php echo $division_desc; ?> - <?php echo $grupo_desc; ?>
					</h5>
				</div>
			</div>
			<div class = "row">
				<div class = "col-xs-12">
					<?php
						echo tabla_ventas($periodo,$division,$grupo,$referencia,$alumno,$desde,$hasta);
					?>
				</div>
			</div>
		</div>
