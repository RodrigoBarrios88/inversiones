    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class = "row">
				<div class = "col-xs-12">
					<?php
						if($desde != "" && $hasta != "" && $grupo != "" && $division != ""){
							echo tabla_boletas_cobro($division,$grupo,$tipo,$periodo,$desde,$hasta);
						}else{
							echo '<h5 class="alert alert-warning text-center">Debe de seleccionar una divisi&oacute;n especifica para listar el reporte...</h5>';
						}
					?>
				</div>
			</div>
            ...
            $('#dataTables-example').DataTable({
                ...
                buttons: [
					...
					{extend: 'print',
						...
						title: 'Reporte de Boletas de Pagos Programados'
                    }
                ]
            });
