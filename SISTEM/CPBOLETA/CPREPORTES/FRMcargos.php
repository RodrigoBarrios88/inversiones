        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-print"></i> Reporte de Cargos &nbsp; &nbsp; <i class="fa fa-plus"></i> <i class="fa fa-dollar"></i><i class="fa fa-dollar"></i><i class="fa fa-dollar"></i>
				</div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMcargos.php"><span class="fa fa-eraser"></span> Limpiar</a> 
