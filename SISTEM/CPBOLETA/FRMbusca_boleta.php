    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-search"></i> Buscador de Boletas Programadas</div>
							...
							<?php
								if($periodo != ""){
									if($boleta != "" || $referencia != "" || $alumno != ""){
										echo tabla_lista_boletas_cobro($boleta,$cue,$ban,$alumno,$referencia,$periodo);
									}else{
