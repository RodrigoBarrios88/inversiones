    ...
    <div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<form action="EXEmodificar.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
				...
				<hr>
				<div class="row">
					<div class="col-xs-5 col-xs-offset-1"><label>Cambiar o cargar una imagen:</label> <small class = "text-info">(Opcional)</small></div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<?php
					echo tabla_informacion($cod,$target,$tipo);
				?>
			</div>
		</div>
	    <!-- /.panel-default -->
