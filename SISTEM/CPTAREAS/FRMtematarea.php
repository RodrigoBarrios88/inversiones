        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la materia donde se asignar&aacute; la tarea
				</div>
								...
								<?php
									if(is_array($result_materias)){
										...
										foreach($result_materias as $row){
											...
											if($acc == "gestor"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMtarea.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "calificar"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMlistartareas.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "ver"){
											$salida.= '<a class="btn btn-primary btn-block" href="IFRMtareas.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'" target = "_blank" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
