<?php
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			$fecha_respuesta = cambia_fechaHora($row["tar_fecha_resolucion_alumno"]);
        	...
        	<div class="panel-body col-xs-4">
        		...
        		<div class="row">
        			...
        			<div class="col-xs-10 ">
        				...
        				<span class="form-info"><?php if( $fecha_respuesta !=''){ echo $fecha_respuesta; }else{echo "pendiente de Entrega"; } ?></span>
        			</div>
        		</div>
        		<div class="row">
        			<div class="col-xs-10 ">
        		...
        		<div class="row">
        			<div class="col-xs-12">
        				...
        				<textarea class="form-control" id = "obs" name = "obs" onkeyup="texto(this)" rows="6" onkeyup="textoLargo(this)" ><?php echo $obs; ?></textarea>
        			</div>
        		</div>
        		<div class="row">
	...
	if(is_array($result)){
		...
		foreach($result as $row){
			...
			if($extension === "jpg"|| $extension === "png" || $extension === "jpeg" ){
                $iframe = '<img src="../../../../CONFIG/DATALMSALUMNOS/TAREAS/MATERIAS/'.$archivo.'" width="100%" height="600"  />'; 
			}else{
			    $iframe = '<iframe src="//docs.google.com/gview?url=https://'.$_SERVER['HTTP_HOST'].'/CONFIG/DATALMSALUMNOS/TAREAS/MATERIAS/'.$archivo.'&embedded=true" width="100%" height="600"></iframe>';
