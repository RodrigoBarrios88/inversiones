<?php
	...
	$ClsTar = new ClsTarea();
	$result = $ClsTar->get_tarea_archivo('',$tarea,'');
    ...
    <div class="">
		...
		<div class="row">
			<div class="col-xs-1 col-xs-offset-1">
				<button type="button" class="btn btn-block btn-default" onclick ="window.close();" title = "Cerrar"><i class="fa fa-times"></i> Cerrar</button>
			</div>
