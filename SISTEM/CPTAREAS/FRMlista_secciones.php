                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									...
									<i class="fa fa-search"></i> Visualizar Tareas
									</a>
                                </li>
                                <?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la Secci&oacute;n a asignar el tema
				</div>
				<br>
						...
						<div class="col-xs-10 col-xs-offset-1">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									...
									<th width = "200px" class = "text-center">NIVEL</td>
								...
								<?php
									if(is_array($result_secciones)){
										...
										foreach($result_secciones as $row){
											...
											$salida.= '<a class="btn btn-primary btn-block" href="FRMtematarea.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'&acc='.$acc.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
										}
