         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Gestor de Reporte de Enfermedad
				</div>
				<div class="panel-body"> 
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<input type = "hidden" id="texto" name = "texto" value = "(Reporte de Enfermedad)
							Estimados Se&ntilde;ores:
							Nos dirigimos a ustedes para informarles con mucha pena que su hijo(a) se sinti&oacute; mal, a continuaci&oacute;n los detalles (click)" />
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Sintomas:</label> <span class="text-danger">*</span></div>
						<div class="col-xs-5"><label>Hora del suceso:</label> <span class="text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "sintomas" id = "sintomas" onkeyup="texto(this)" maxlength="50" />
						</div>
						<div class="col-xs-5">
							<div class="form-group">
								<div class="input-group clockpicker" data-autoclose="true">
									<input type="text" class="form-control" name = "hora" id = "hora" value="<?php echo date("H:i"); ?>" readonly >
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1"><label>&iquest;Se aviso a los padres en el momento? &iquest;A quien?:</label> <span class="text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "aviso" id = "aviso" value = "No" onkeyup="texto(this);" maxlength="30" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1"><label>Medida tomada de inmediato y medicamento autorizado:</label> <span class="text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "medida" id = "medida" onkeyup="texto(this);" maxlength="100" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Dosis:</label> <em class="text-muted">(no obligatorio)</em></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "dosis" id = "dosis" onkeyup="texto(this);" maxlength="50" />
						</div>
					</div>
					<br>
					<div class="row">
