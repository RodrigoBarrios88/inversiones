...
function mail_constructor($nombre, $mail, $usu, $pass, $mensaje){	
	return $salida = '
<!DOCTYPE html>
<html lang="en">
				...
				<tr>		
					<td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align = "center">
									<h1>&iquest;Solicitaste tu Contrase&ntilde;a?</h1>
								</td>
							</tr>
							<tr>
								<td>
                            ...
                            <tr>
								<td>
									<label style="font-size: 18px;font-weight: bold;">Usuario:</label>
									<p>'.$usu.'</p>
								</td>
							</tr>
							<tr>
								<td>
									<label style="font-size: 18px;font-weight: bold;">Contrase&ntilde;a:</label>
									<p>'.$pass.'</p>
								</td>
							</tr>
							<tr>
