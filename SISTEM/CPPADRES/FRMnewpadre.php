   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-user"></i> Formulario Gestor de Padres</div>
            <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<input type = "text" class = "form-control" name = "dir" id = "dir" value = "<?php echo $dir; ?>" onkeyup = "texto(this)" />
						</div>	
						<div class="col-xs-5">
							<label>Lugar de Trabajo: </label>
							<input type = "text" class = "form-control" name = "trab" id = "trab" value = "<?php echo $trab; ?>" onkeyup = "texto(this)" />
						</div>	
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-2 text-right">
							<button type="button" class="btn btn-primary btn-outline" id = "btn-edit" onclick = "redirigeEdicion();" disabled ><i class="fa fa-pencil"></i> Editar Completo</button>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_padres($cod,$nom,$ape,$sit,1); ?>
						</div>
					</div>
				</div>
         </div>
