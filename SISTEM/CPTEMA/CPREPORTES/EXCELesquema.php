<?php
	...
	$titulo = "Dosificaci&oacute;n Curricular de $materia_desc para $grado_desc Secci&oacute;n $seccion_desc";
		...
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-file-text fa-fw"></i> Listado de Temas, con sus diferentes actividades
				...
				<div class="panel-body">
					...
					<div class = "row">
						<div class = "col-xs-12">
							<?php
								if($materia != ""){
									echo tabla_esquema($pensum,$nivel,$grado,$seccion,$materia,$unidad);
								}
							?>
						</div>
					</div>
		...
		$(document).ready(function() {
			$('#dataTables-example').DataTable({
				...
				buttons: [
					'copyHtml5',
					'csvHtml5',
					 {extend: 'excel', title: 'Dosifiacion Curricular'}
				]
			});
		});
    </script>	
