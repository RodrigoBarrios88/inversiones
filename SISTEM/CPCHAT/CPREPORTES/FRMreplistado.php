                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a class="active" href="FRMreplistado.php">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading">
					<i class="glyphicon glyphicon-print"></i> Reporte y Listado de Usuarios de Chat
				</div>
				...
				<form name = "f1" id = "f1" action="REPlista.php" method="post" target = "_blank">
                    ...
                    <div class="row">
                        <div class="col-xs-5 col-xs-offset-1">
							<label>Tipo de Usuario: </label> <span class="text-info">*</span>
							<select class="form-control" name = "tipo" id = "tipo">
								<option value="">Todos</option>
								<option value="1">Autoridad</option>
								<option value="2">Maestro</option>
							</select>
						</div>
                        <div class="col-xs-5">
							<label>Nombre: </label> <span class="text-info">*</span>
