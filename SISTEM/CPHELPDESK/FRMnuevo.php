   ...
   <div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus-circle"></i> Formulario para Nuevo Reporte de Incidentes</div>
			<div class="panel-body" id = "formulario">
				...
				<div class="row">
					<div class="col-xs-10 col-xs-offset-1">
						...
						<input type = "text" class = "form-control" name = "persona" id = "persona" onkeyup = "texto(this);" />	
					</div>
				</div>
				<div class="row">
					<div class="col-xs-10 col-xs-offset-1">
