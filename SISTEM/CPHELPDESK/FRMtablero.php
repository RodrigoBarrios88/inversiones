		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-exclamation-circle"></i> Tablero de Incidentes
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_incidentes(); ?>
						</div>
					</div>
				</div>
			</div>
			<!-- /.panel-default -->
			<div id="fab">
				<a class="open-fab-primary" href="FRMnuevo.php" title="Agregar un Incidente">
