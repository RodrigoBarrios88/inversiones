    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-money"></i> Generaci&oacute;n de Cheques</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"><span class = " text-danger">* Campos de Obligatorios</span> </div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php echo banco_html("ban","xajax_Combo_Cuenta_Banco(this.value,'cue','scue','xajax_Last_Cheque(this.value,document.getElementById(\'ban\').value);');"); ?>
						...
						<div class="col-xs-5" id = "scue">
							<?php
								if($ban != ""){
									echo cuenta_banco_html($ban,"cue","xajax_Last_Cheque(this.value,$ban);");
								}else{
