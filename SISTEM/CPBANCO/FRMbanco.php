    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-bank"></i> Formulario Gestor de Bancos</label></div>
                <div class="panel-body" id = "formulario">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right text-danger">* Campos Obligatorios</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Nombre Corto: </label> <span class = "text-danger">*</span></div>
						<div class="col-xs-5"><label>Nombre Completo:  </label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Pais: </label> <span class = "text-danger">*</span></div>
						<div class="col-xs-5"><label>Situaci&oacute;n: </label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php echo paises_html("pai"); ?>
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_bancos($cod,$dct,$dlg,$pai,$sit); ?>
						</div>
					</div>
				</div>
            </div>
