    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-sign-in"></i> Depositos a Cajas Bancarias</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_cuenta_banco($cod,$ban,$num,$tip,$mon,$pai,$sit,"ACD"); ?>
						</div>
					</div>
					<br>
				</div>
