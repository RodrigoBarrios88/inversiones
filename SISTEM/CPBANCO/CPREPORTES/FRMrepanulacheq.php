    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Cheques Anulados </h3>
					<table>
						<tr>
						...
						<tr>
							...
							<td>
								<?php echo Banco_html_Onclick("ban","cue","scue"); ?>
							...
							<td>
								<span id = "scue" >
									<select id = "cue" name = "cue" class = "combo">
						...
						<tr>
							<td class = "celda" align = "right">Desde (Fecha): <span class = "busca">*</span></td>
							...
							<td class = "celda" align = "right">Hasta (Fecha): <span class = "busca">*</span></td>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReporteAnulaCheques()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
								<a class="button" href="FRMrepanulacheq.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
