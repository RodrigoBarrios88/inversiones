    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-history"></i> Historial de Cheques</label></div>
                <div class="panel-body">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMhistcheque.php"><span class="fa fa-eraser"></span> Limpiar</a>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								if($desde != "" && $hasta != ""){
									echo tabla_historial_cheques($cod,$cue,$ban,$num,$quien,$desde,$hasta,$sit); 
								}else{
									echo '<div class="alert alert-warning alert-dismissable text-center">';
									echo '	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
									echo '	<h5>Seleccione el rango de fechas a revisar ...</h5>';
									echo '</div>';
								}
							?>
						</div>
