    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-edit"></i> Actualizaci&oacute;n de Datos de Cuentas Bancarias</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_cuenta_banco($cod,$ban,$num,$tip,$mon,$pai,$sit,"MOD"); ?>
						</div>
					</div>
				</div>
            </div>
