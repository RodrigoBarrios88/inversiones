		...
		<div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-search"></i> Visualizador de Facturas y Recibos derivadas de Cargas Electr&oacute;nicas
				</div>
            <div class="panel-body">
					<?php echo tabla_facturas_carga($carga); ?>
					<br>
					<?php echo tabla_recibos_carga($carga); ?>
				</div>
         </div>
			<!-- /.panel-default -->
			<br>
