    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
			...
			<div class="row">
               <div class="col-xs-12 text-center">
						<a class="btn btn-outline btn-default" title="Imprimir" href = "../../CONFIG/BOLETAS/REPcuenta.php?hashkey=<?php echo $hashkey; ?>&periodo=<?php echo $periodo; ?>&cuenta=<?php echo $cuenta; ?>" target="_blank"><span class="fa fa-print"></span> Estado de Cuenta Condensado</a> 
						<a class="btn btn-outline btn-default" title="Imprimir" href = "../../CONFIG/BOLETAS/REPcuenta_detallado.php?hashkey=<?php echo $hashkey; ?>&periodo=<?php echo $periodo; ?>&cuenta=<?php echo $cuenta; ?>" target="_blank"><span class="fa fa-print"></span> Estado de Cuenta Detallado</a>
						<a class="btn btn-outline btn-success" title="Imprimir" href = "../CPBOLETA/FRMpago.php?hashkey=<?php echo $hashkey; ?>&periodo=<?php echo $periodo; ?>&cuenta=<?php echo $cuenta; ?>"><i class="fa fa-money"></i> <i class="fa fa-user"></i> Gestor de Pagos por Alumno</a>
               </div>
            </div>
			<hr>
			<div class="row">
