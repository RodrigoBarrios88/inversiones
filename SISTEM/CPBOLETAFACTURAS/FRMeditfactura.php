<?php
	...
	$bolcodigo = $ClsBol->decrypt($hashkey3,$usuario);
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			//monto
			$monto = number_format($row["fac_monto"],2,'.','');
			//motivo
			$motivo = $row["fac_descripcion"];
			//cuenta
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["PAGOCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMlista_facturas.php">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" id = "formulario">
					...
					<div class="row" id="lbf2">
						...
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "facc" id = "facc" value = "<?php echo $numero; ?>" disabled />
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-primary" id = "grab" onclick = "ModificarFactura();"><span class="fa fa-save"></span> Grabar</button>
								<a type="button" class="btn btn-default" target = "_blank" href="CPREPORTES/REPfactura.php?hashkey1=<?php echo $hashkey1; ?>&hashkey2=<?php echo $hashkey2; ?>&hashkey3=<?php echo $hashkey3; ?>" ><span class="fa fa-print"></span> Imprimir</a>
                            </div>
                        </div>
                    </div>
				</div>
