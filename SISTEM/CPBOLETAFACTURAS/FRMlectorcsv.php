...
<body>
                ...
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							<h5>&iquest;Desea Grabar estas facturas?</h5>
							<a class="btn btn-default" href = "FRMlist_cargas.php"><i class="fa fa-times"></i> Cancelar</a>
							<button type="button" class="btn btn-primary" onclick = "GrabarFACE();"><i class="fa fa-save"></i> Grabar</button>
						</div>
					</div>
					<hr>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								//echo "$archivo <br>";
								echo tabla_lectora_csv($archivo);
							?>
						</div>
					</div>
					</form>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/colegiatura/face.js"></script>
