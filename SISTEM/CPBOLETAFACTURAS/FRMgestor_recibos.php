		...
		<div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-file-text-o"></i> Gestor de Recibos derivadas de Cargas Electr&oacute;nicas
				</div>
            <div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Fecha de Recibo:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
					...
					<div class="row">
						 <div class="col-xs-12 text-center">
							  <a class="btn btn-default" href = "FRMlist_cargas.php"><span class="fa fa-eraser"></span> Limpiar</a>
							  <button type="button" class="btn btn-primary" id = "grab" onclick = "GrabarRecibosCarga();"><span class="fa fa-save"></span> Grabar</button>
						 </div>
					</div>
				</div>
         </div>
