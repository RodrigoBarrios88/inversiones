    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["PAGOCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMbusca_factura.php">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-search"></i> Buscador de Facturas</label></div>
                <div class="panel-body">
					...
					<div class="row">
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-default" href = "FRMbusca_factura.php"><i class="fa fa-eraser"></i> Limpiar</a>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								if($suc != ""){
									if($referencia != "" || $alumno != "" || $facc != ""){
										echo tabla_lista_facturas($suc,$ser,$facc,$alumno,$referencia,$carga);
										//echo "$cue,$ban,$alumno,$referencia,$anio";
									}else{
										echo '<h5 class = "alert alert-info text-center">';
										echo '<i class = "fa fa-check-circle"></i> Selecciones un # de factura, # de boleta o CUI de alumno para filtrar...';
										echo '</h5>';
									}
								}else{
									echo '<h5 class = "alert alert-info text-center">';
