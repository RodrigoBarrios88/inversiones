    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-search"></i> Buscar Boletas para Generar Factura</div>
                <div class="panel-body">
				<form id='f1' name='f1' method='get'>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<a class="btn btn-default" href = "FRMsecciones.php?acc=FAC"><span class="fa fa-search"></span> <span class="fa fa-user"></span> Buscar Boletas por Alumno</a>
						</div>
					</div>
					<div class="row">
				...
				<div class="panel-body">
					<?php
						if($desde != '' && $hasta != ''){
							...
							echo tabla_boletas($cue,$ban,$referencia,$desde,$hasta,"FAC");
						}
					?>
				</div>
			</div>
