<?php
	...
	$codigo = Agrega_Ceros($carga);
	
	$titulo = "REPORTE DE CARGA ELECTR&Oacute;NICA No. $codigo";
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-file-text fa-fw"></i> Reporte de Carga Electr&oacute;nica
					...
					<div class="panel-body">
						...
						<div class = "row">
							<div class = "col-xs-12">
								<?php
									if($carga != ""){
										echo tabla_detalle_carga_electronica($carga);
									}else{
										echo '<h5 class="alert alert-warning text-center">Debe de seleccionar una Carga Electr&oacute;nica Activa...</h5>';
									}
								?>
							</div>
						</div>
	...
	$(document).ready(function() {
		$('#dataTables-example').DataTable({
			...
			buttons: [
				'copyHtml5',
				'csvHtml5',
				 {extend: 'pdf', title: 'Detalle de Carga Electronica'},
				 {extend: 'excel', title: 'Detalle de Carga Electronica'}
			]
		} );
	} );
    </script>	
