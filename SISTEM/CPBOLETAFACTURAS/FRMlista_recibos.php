    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-search"></i> Buscar Recibos a Editar</div>
                <div class="panel-body">
				<form id='f1' name='f1' method='get'>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<a class="btn btn-default" href = "FRMsecciones.php?acc=REC"><span class="fa fa-search"></span> <span class="fa fa-user"></span> Buscar Recibos por Alumno</a>
						</div>
					</div>
					<div class="row">
					...
					<div class="row" id="lbf1">
						...
						<div class="col-xs-5"><label>Serie de Recibos:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row" id="lbf2">
						...
						<div class="col-xs-5">
							<?php echo serie_recibo_html("serie","Submit();"); ?>
							<script>
				...
				<div class="panel-body">
					<?php
						if($desde != '' && $hasta != ''){	
							...
							echo tabla_recibos($num,$ser,$suc,$referencia,$desde,$hasta);
						}
					?>
				</div>
			</div>
