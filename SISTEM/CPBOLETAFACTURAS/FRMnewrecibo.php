    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["PAGOCUOTAS"] == 1){ ?>
								<li>
									<a class="active" href="FRMlista_boleta_recibos.php">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-file-text-o"></i> Gestor de Recibos Derivados de Boletas de Pago </label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row" id="lbf1">
						...
						<div class="col-xs-5"><label>N&uacute;mero del Recibo:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row" id="lbf2">
						...
						<div class="col-xs-5">
							<?php
								if($suc != '' && $pv != '' && $serie != ''){	
									$numero = $ClsRec->max_recibo_base($suc,$pv,$serie);
								}else{
									$numero = "";
								}
							?>
							<input type = "text" class = "form-control" name = "numero" id = "numero" value = "<?php echo $numero; ?>" onkeyup = "enteros(this);" />
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-primary" id = "grab" onclick = "GrabarRecibo();"><span class="fa fa-save"></span> Grabar</button>
                            </div>
                        </div>
                    </div>
				</div>
