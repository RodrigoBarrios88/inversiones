...
<body>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Estad&iacute;sticas Semanal de Tiempo de Uso por Aula o Instalaci&oacute;n
						</div>
						<div class="panel-body"> 
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
										<div class="col-xs-5 col-xs-offset-1"><label>Tipo:</label> </div>
									</div>
									<div class="row">
    ...
    <script>
		function Reporte(){
			...
			myform.action ="GRAPHhor_aula_grafica_semanal.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
		}
