                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMhor_maestro_grafica_diaria.php">
									<i class="fa fa-bar-chart-o"></i> Estad&iacute;sticas Diaria por Maestro
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMhor_maestro_grafica_semana.php">
									<i class="fa fa-bar-chart-o"></i> Estad&iacute;sticas Semanal por Maestro
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMhor_aula_grafica_diaria.php">
									<i class="fa fa-bar-chart-o"></i> Estad&iacute;sticas Diaria por Aula
									</a>
                                </li>
                                <?php } ?>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMhor_aula_grafica_semana.php">
									<i class="fa fa-bar-chart-o"></i> Estad&iacute;sticas Semanal por Aula
									</a>
                                </li>
                                <?php } ?>
								<hr>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body"> 
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
										<div class="col-xs-5 col-xs-offset-1"><label>D&iacute;a:</label></div>
										<div class="col-xs-5"><label>Tipo:</label> </div>
									</div>
									<div class="row">
										...
										<div class="col-xs-5">
											<select class = "form-control" id = "tipo" name = "tipo" onchange="Submit();">
												...
												<option value = "S">SAL&Oacute;N DE CLASE</option>
												<option value = "A">AULA AL AIRE LIBRE</option>
												<option value = "G">GIMNASIO</option>
												<option value = "T">AUDITORIUM O TEATRO</option>
    ...
    <script>
		function Reporte(){
			...
			if(dia.value !== ""){
				...
				myform.action ="GRAPHhor_aula_grafica_diaria.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
				abrir();
				msj = '<h5>Debe Seleccionar el d&iacute;a a graficar</h5><br><br>';
