<?php
	...
	$result = $ClsMae->get_maestro($maestro,'','',1);
	if(is_array($result)){
		foreach($result as $row){
			$nombre = utf8_decode($row["mae_nombre_completo"]);
		}
	}
	...
	$titulo = "Periodos libres de $nombre para el d&iacute;a $dia_desc";
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-file-text fa-fw"></i> Periodos libres por Maestros
					...
					<div class="panel-body">
						...
						<div class = "row">
							<div class = "col-xs-12">
								<?php
									if($maestro != "" && $dia != ""){
										echo tabla_libres_maestro($maestro,$dia,$ini,$fin);
									}
								?>
							</div>
						</div>
	...
	$(document).ready(function() {
		 $('.dataTables-example').DataTable({
			...
			buttons: [
				'copyHtml5',
				'csvHtml5',
				 {extend: 'pdf', title: 'Periodos Libres por Maestro'},
				 {extend: 'excel', title: 'Periodos Libres por Maestro'}
			]
		} );
	} );
    </script>	
