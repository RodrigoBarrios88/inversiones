			...
			<form name = "f1" id = "f1" action="#" method="get">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<label>Gestor de Periodos (Por Grados)</label>
					</div>
                    <div class="panel-body">
						...
						<div class="row">
							<div class="col-xs-12 col-xs-12 text-right">
								<a href = "FRMperiodos.php">Periodos por Niveles Educat&iacute;vos?</a>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								<?php echo pensum_html("pensum","xajax_Pensum_Nivel(this.value,'nivel','divnivel','Combo_Tipo_Periodo();');"); ?>
								<?php if($pensum != ""){ ?>
							...
							<div class="col-xs-5" id = "divnivel">
								<?php
									if($pensum != ""){
										echo nivel_html($pensum,"nivel","Combo_Tipo_Periodo();");;
									}else{
						...
						<div class="row">
                            ...
                            <div class="col-xs-5" id = "divtipo">
								<?php
									if($pensum != "" && $nivel != ""){
										echo tipo_periodo_html($pensum,$nivel,"tipo","Submit();");
									}else{
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-primary" id = "grab" onclick = "GrabarPerGrado();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
                                <button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarPerGrado();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
                            </div>
                        </div>
                    </div>
				    <!-- /.panel-body -->
			    ...
			    <div class="panel-body">
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php
								if($dia != "" && $pensum != "" && $nivel != "" && $grado != ""){
									echo tabla_periodos($dia,$tipo,$pensum,$nivel,$grado);
								}
							?>
						</div>
					</div>
