				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMperiodo.php">
										<i class="fa fa-calendar-o"></i> Gestor de Periodo Fiscal
									</a>
								</li>
								<?php } ?>
                        ...
                        <li>
								...
								<?php if($_SESSION["NEWCUOTAS"] == 1){ ?>
								<li>
									<a href="../CPBOLETAPROGRAMADOR/FRMeditconfiguracion.php">
								...
								<?php if($_SESSION["NEWCUOTAS"] == 1){ ?>
								<li>
									<a href="../CPBOLETAPROGRAMADOR/FRMlista_inscripciones.php">
         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Nuevo Periodo Fiscal en Blanco
				</div>
				<div class="panel-body"> 
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarPeriodo();"><span class="fa fa-save"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarPeriodo();"><span class="fa fa-save"></span> Grabar</button>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-lg-12">
							<?php echo tabla_periodo($codigo,$anio); ?>
						</div>
					</div>		
				</div>
				<br>
