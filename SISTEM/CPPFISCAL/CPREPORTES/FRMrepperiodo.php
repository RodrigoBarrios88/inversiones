<?php
	include_once('xajax_funct_periodo.php');
	...
	$periodo = ($periodo == "")?$periodo_default:$periodo;
...
<head>
	...
	<link href="../../assets.3.6.2/css/plugins/BootTree/boottree.css" rel="stylesheet">
...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../FRMperiodo.php">
									<i class="fa fa-bookmark"></i> Gestor de Periodo Fiscal
									</a>
                                </li>
								<?php } ?>
								<?php if($tipo_usuario == 5 || $tipo_usuario == 2 || $tipo_usuario == 1){ ?>
                                <li>
                                    <a href="FRMrepperiodo.php">
									<i class="fa fa-print"></i> Reporte de Periodo Fiscal
									</a>
                                </li>
								<?php } ?>
                                <hr>
        ...
        <div id="page-wrapper">
					...
					<div class="panel panel-default">
						...
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1">
								<?php echo periodo_html("periodo", "Submit();"); ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-outline btn-danger" id = "busc" onclick = "Reporte();"><span class="fa fa-file-pdf-o"></span> Imprimir</button>
                            </div>
                        </div>
						<br>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><i class="fa fa-list-ol"></i> Divisi&oacute;n del Programa de Educaci&oacute;n Integral</div>
    ...
    <!-- BootTree JavaScript -->
    <script src="../../assets.3.6.2/js/plugins/BootTree/boottree.js"></script>
    ...
    <script type="text/javascript" src="../../assets.3.6.2/js/modules/finanzas/periodo.js"></script>
	...
	<script>
		function Reporte(){
			...
			if(periodo.value !== ""){
				...
				myform.action ="REPperiodo.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
				abrir();
				msj = '<h5>Debe Seleccionar el programa acad&eacute;mico</h5><br><br>';
				msj+= '<button type="button" class="btn btn-primary" onclick = "cerrar();" ><span class="fa fa-ok"></span> Aceptar</button> ';
