...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-th"></i> <label>Gestor de Grupos de Suministros</label></div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/grupsumi.js"></script>
