            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-dollar"></i> <label>Actualizaci&oacute;n de Precios</label></div>
					...
					<form id='f1' name='f1' action='FRMartprecio.php' method='post'>
						...
						<div class="row">
                            <div class="col-xs-5 col-xs-offset-1">
								<?php echo grupo_suministro_html("gru","xajax_Combo_Grupo_Articulo(this.value,'art','sart','')"); ?>
						...
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Precio:</label></div>
							<div class="col-xs-5"><label>Moneda:</label></div>
						</div>
						<div class="row">
                            <div class="col-xs-5 col-xs-offset-1">
								<input type = "text" class="form-control" name = "precost" id = "precost" onkeyup = "decimales(this);" />
