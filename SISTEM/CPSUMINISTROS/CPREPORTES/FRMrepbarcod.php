    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><label>Generar Codigos de Barra para Impresi&oacute;n</label></div>
                    <div class="panel-body">
					<form id='f1' name='f1' action='FRMrepbarcod.php' method='get'>
						<div class="row">
                        ...
                        <div class="row">
							...
							<div class="col-xs-3 text-right"><label>Cantidad: </label> <label class = " text-info">*</label><label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left">
								<input type = "text" class = "form-control" onkeyup = "enteros(this);KeyEnter(this,Submit);" name = "cant" id = "cant" value = "<?php echo $cant; ?>" onblur = "Submit();" />
							</div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3 text-right"><label>Grupo: </label> <label class = " text-info">*</label><label class = " text-danger">*</label></div>
                            <div class="col-xs-3 text-left">
								<?php echo grupo_suministro_html("gru","Submit();"); ?>
								<input type = "hidden" name = "cod" id = "cod" />
								<script type="text/javascript">
                            ...
                            <div class="col-xs-3 text-left" id = "sart">
								<?php
									if($gru == ""){
										...
										echo suministro_html($gru,"art","Submit();");
									}
								?>
							</div>
							<script type="text/javascript">
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php
							if($gru != "" && $suc != ""){
								echo tabla_articulos_barcode($cod,$grup,$cant);
							}
						?>
					</div>
				</div>
