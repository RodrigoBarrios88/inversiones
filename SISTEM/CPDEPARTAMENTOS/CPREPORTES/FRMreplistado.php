...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									<a href="../FRMdepartamentos.php">
										<i class="fa fa-flag"></i> Departamentos
									</a>
								</li>
								<?php } ?>
								<?php if($_SESSION["GDEPA"] == 1){ ?>
								<li>
									<a href="FRMreplistado.php">
										<i class="glyphicon glyphicon-print"></i> Reporte de Departamentos
									</a>
								</li>
								<?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><label>Reportes de Departamentos</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <button type="button" class="btn btn-primary" id = "gra" onclick = "Submit();"><span class="fa fa-print"></span> Imprimir</button>
                        </div>
                    </div>
					<br>
				</div>
    ...
    <script type="text/javascript" src="../../assets.3.6.2/js/modules/organizacion/departamento.js"></script>
