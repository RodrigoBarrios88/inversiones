<?php
	include_once('xajax_funct_departamentos.php');
	$id = $_SESSION["codigo"];
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label>Formulario Gestor de Departamentos</label></div>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_departamentos($cod,$suc,$dct,$dlg,1); ?>
				</div>
			</div>
		</div>
	    </div>
