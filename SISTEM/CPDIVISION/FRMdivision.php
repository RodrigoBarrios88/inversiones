<?php
	include_once('xajax_funct_division.php');
	$id = $_SESSION["codigo"];
   ...
   <div id="wrapper">
					...
					<ul class="nav" id="side-menu">
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMgrupo.php">
										<i class="fa fa-th-large"></i> Gestor de Grupos
									</a>
								</li>
								<?php } ?>
								<?php if($_SESSION["GCUEBANCO"] == 1){ ?>
								<li>
									<a href="FRMdivision.php">
										<i class="fa fa-square"></i> Divisiones de Boletas
									</a>
								</li>
								<?php } ?>
								<hr>
		...
		<div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-square"></i> Gestor de Divisiones de Boletas de Pago</div>
            <div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<?php echo division_grupo_html("grupo",""); ?>
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Nombre o Descripci&oacute;n:</label> <span class = "text-danger">*</span>
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/divisiones/division.js"></script>
