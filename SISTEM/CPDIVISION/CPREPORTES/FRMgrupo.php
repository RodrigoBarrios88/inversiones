    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Formulario Gestor de Divisions </h3>
					<table>
						<tr>
						...
						<tr>
							...
							<td><input type = "text" class = "text" name = "dct" id = "dct" onkeyup = "texto(this)" /><input type = "hidden" name = "cod" id = "cod" /></td>
						...
						<tr>
							<td class = "celda" align = "right">Pais: <span class = "busca">*</span></td>
							<td><?php echo Paises_html(); ?></td>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReporteDivisions()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
								<a class="button" href="FRMrepbanco.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
