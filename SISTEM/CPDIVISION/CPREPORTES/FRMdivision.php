    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Apertura de Divisions Bancarias </h3>
					<table>
						<tr>
						...
						<tr>
							<td class = "celda" align = "right">Division: <span class = "busca">*</span></td>
							<td><?php echo Division_html(); ?></td>
							<td class = "celda" align = "right">No. Division: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "num" id = "num" onkeyup = "enteros(this)" /></td>
						</tr>
						<tr>
							<td class = "celda" align = "right">Tipo de Division: <span class = "busca">*</span></td>
							<td><?php echo Tipo_Division_html("tip"); ?></td>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "rep" onclick = "ReporteCueDivisions()" ><img src="../../../CONFIG/images/icons/printer_add.png" class="icon" > Reporte</a>
