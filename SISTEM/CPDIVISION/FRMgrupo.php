   ...
   <div id="wrapper">
		...
		<div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-th-large"></i> Formulario Gestor de Grupos de Boletas de Pago</div>
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/divisiones/grupo.js"></script>
