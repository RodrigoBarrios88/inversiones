...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-list-alt"></i> <label>Kardex de Inventario de Suministros</label></div>
                <div class="panel-body">
				<form id='f1' name='f1' action='FRMkardex.php' method='post'>
					<div class="row">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php
						if($suc != "" || $gru != "" || $art != ""){
							echo tabla_articulos_kardex($suc,$barc,$art,$gru,$nom,$desc,$marca,$cumed,$umed,$sit);
						}
					?>
				</div>
			</div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/kardexsuministro.js"></script>
