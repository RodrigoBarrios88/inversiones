  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Historial de Transacciones en Inventario </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td><?php echo Empresas_html(); ?></td>
							<td class = "celda" align = "right">Tipo de Transacci�n: <span class = "busca">*</span></td>
							<td>
								<select id = "tipo" name = "tipo" class = "combo">
									<option value = "">Seleccione</option>
									<option value = "1">CARGA A INVENTARIO</option>
									<option value = "2">DESCARGA A INVENTARIO</option>
								</select>
							</td>
						</tr>
						<tr>
							<td class = "celda" align = "right">Motivo de la Transaci�n: <span class = "busca">*</span></td>
							<td>
								<select id = "clase" name = "clase" class = "combo">
									<option value = "">Seleccione</option>
									<option value = "C">POR COMPRA</option>
									<option value = "P">POR PRODUCCI�N</option>
									<option value = "D2">POR DESCARGO RECHAZO</option>
									<option value = "D">POR DONACI�N</option>
									<option value = "V">POR VENTA</option>
								</select>
							</td>
							<td class = "celda" align = "right">Documento Resp.: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "doc" id = "doc" onkeyup = "texto(this)" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteHist(1)" ><img src="../../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteHist(2)" ><img src="../../../CONFIG/images/icons/excel.png" class="icon" > Exportar</a>
