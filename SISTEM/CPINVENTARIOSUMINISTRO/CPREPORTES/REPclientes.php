...
<html>
	...
	<body>
		<div align = "center" id = "print" style = "width:1056px;">
			<input type = "button" class = "boton" value = "Imprimir" onclick = "pageprint();" />
			<br>
		</div>	
		<div align = "center" id = "container" class = "divlandscape">
			...
			<?php echo rep_tabla_clientes($nit,$nom); ?>
		</div>
	</body>
</html>
