    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-sign-out"></i> <label>Descarga de Art&iacute;culos a Inventario</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Fecha de Descarga:</label></div>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Motivo de la Descarga:</label> <span class = " text-danger">*</span></div>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<select id = "clase" name = "clase" class = "form-control">
									<option value = "D2">POR DESCARGO RECHAZO</option>
									...
									<option value = "B">BONIFICACI&Oacute;N DE VENTA</option>
					...
					<div class="row">
						...
						<div class="col-xs-5" id = "cnt4">
							<?php echo suministro_transaccion_html('art',"Articulo();"); ?>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "cant" id = "cant" onkeyup = "enteros(this);KeyEnter(this,NewFilaDescarga);" />
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            <button type="button" class="btn btn-primary" onclick = "NewFilaDescarga();"><span class="fa fa-plus"></span> <span class="fa fa-shopping-cart"></span></button>
                        </div>
                    </div>
					<br>
				</div>
