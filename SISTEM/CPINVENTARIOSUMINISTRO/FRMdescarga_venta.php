...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-sign-out"></i> <label>Descarga a Inventario por Venta</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Serie de Factura:</label> <span class = " text-info">*</span></div>
						<div class="col-xs-5"><label>No. de Factura:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php echo serie_html("ser"); ?>
						</div>
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "facc" id = "facc" onkeyup = "texto(this);KeyEnter(this,BuscarVenta);" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>No. Venta:</label> <span class = " text-info">*</span></div>
						<div class="col-xs-5"><label>Documento de Respaldo:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "vent" id = "vent" value = "" onkeyup = "enteros(this);KeyEnter(this,BuscarVenta);" />
							<input type = "hidden" name = "ventC" id = "ventC" value = "" />
							<input type = "hidden" name = "clase" id = "clase" value = "V" />
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Empresa:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
						...
						<div class="col-xs-5">
							...
							<script type="text/javascript">
								document.getElementById('suc').value = '<?php echo $_SESSION["empresa"]; ?>';
							</script>
						</div>
					</div>
					<hr>
		...
		<div class="panel-body">
			<div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <button type="button" class="btn btn-primary" onclick = "ConfirmDescargaJS();"><span class="fa fa-cloud-download"></span> Descarga </button>
                </div>
            </div>
		</div>
	    </div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/inventariosuministro.js"></script>
