    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-sign-in"></i> <label>Carga a Inventario por Compra</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>No. Compra:</label> <span class = " text-info">*</span></div>
						<div class="col-xs-5"><label>Documento de Respaldo:</label> <span class = " text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<input type = "text" class = "form-control" name = "comp" id = "comp" value = "" onkeyup = "enteros(this);KeyEnter(this,BuscarCompra);" />
							<input type = "hidden" name = "compC" id = "compC" value = "" />
							<input type = "hidden" name = "clase" id = "clase" value = "C" />
						</div>
						<div class="col-xs-5">
							<input type = "text" class = "form-control" name = "doc" id = "doc" onkeyup = "texto(this);KeyEnter(this,BuscarCompra);" />
						</div>
					</div>
					<div class="row">
			...
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php
						...
						//echo tabla_busca_compra_carga(1148);
					?>
				</div>
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <button type="button" class="btn btn-success" onclick = "ConfirmCargaCompraJS();"><span class="fa fa-cloud-upload"></span> Cargar </button>
                </div>
            </div>
		</div>
	    </div>
