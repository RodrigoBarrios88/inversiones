	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-lg-5 col-xs-offset-1">
					<label>e-mail:</label>
					<input type = "text" class = "form-control text-libre" name = "cmail1" id = "cmail1" />
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xs-12 text-center">
				   <button type="button" class="btn btn-default" id = "limp" onclick = "cerrarModal();"><span class="fa fa-remove"></span> Cancelar</button>
					<button type="button" class="btn btn-primary" id = "busc" onclick = "GrabarCliente();"><span class="fa fa-save"></span> Grabar</button>
				 </div>
			</div>
			<br>
		</div>		
