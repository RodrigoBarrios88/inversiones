...
<html>
	...
	<body>
		<form action="EXEcarga_archivo_tema.php" name = "f1" name = "f1" method="post" enctype="multipart/form-data">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-10 col-xs-offset-1">
						...
						<input type = "hidden" id = "Filecurso" name = "Filecurso" value = "<?php echo $curso; ?>" />
