...
<div class="panel panel-default">
	<div class="panel-heading">
		<i class="fa fa-paste"></i> Observaci&oacute;n para las Tarjetas de Calificaciones
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-10 col-xs-offset-1 text-center">
				<h4>&iquest;Desea agregar una observaci&oacute;n en esta tarjeta de calificaciones?</h4><br>
				<h5>
		...
		<div class="row">
			<div class="col-xs-12 text-center">
				...
				<button type="button" class="btn btn-primary" id = "limp" onclick = "Observaciones2('Individual',<?php echo $fila; ?>,<?php echo $boton; ?>);"> <span class="fa fa-check"></span> Aceptar </button>
			</div>
		</div>
		<br>
	</div>
