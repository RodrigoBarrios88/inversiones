...
<html>
	...
	<body>
		<form action="EXEcarga_archivo_tarea.php" name = "f2" name = "f2" method="post" enctype="multipart/form-data">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-10 col-xs-offset-1">
						...
						<input type = "hidden" id = "Filetarea" name = "Filetarea" value = "<?php echo $tarea; ?>" />
						<input type = "hidden" id = "Filecodigo" name = "Filecodigo" />
