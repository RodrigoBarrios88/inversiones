...
<html>
	...
	<form action="EXElectorcsv.php" name = "f2" name = "f2" method="post" enctype="multipart/form-data">
		<div class="panel panel-default">
			<div class="panel-heading"><label>Cargar Listado de Nuevos Servicios</label></div>
			<div class="panel-body">
				...
				<hr>
                <div class="row">
                    <div class="col-xs-5 col-xs-offset-1"><label>Grupo de Servicios: </label> <label class = " text-danger">*</label></div>
                    <div class="col-xs-5"><label>Seleccione el archivo (*.csv): </label> <label class = " text-danger">*</label></div>
                </div>
				<div class="row">
                    <div class="col-xs-5 col-xs-offset-1">
						<?php echo grupo_serv_html("gru1",""); ?>
					</div>
                    <div class="col-xs-5">
