...
<html>
	...
	<body>
		<div class="panel panel-default">
			<div class="panel-heading"><label><i class="fa fa-dollar"></i> Descuentos</label></div>
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-xs-12">
						<?php echo tabla_descuentos($nomina,$personal); ?>
					</div>
				</div>
				<br>
				<div class="row">
...
function tabla_descuentos($nomina,$personal){
	$ClsPlaAsi = new ClsPlanillaAsignaciones();
	$result = $ClsPlaAsi->get_descuentos($nomina,$personal,'');
