...
<html>
	...
	<body>
		<div class="panel panel-default">
			<div class="panel-heading"><label><i class="fa fa-money"></i> Monto por Horas Laboradas</label></div>
...
function tabla_horas_laboradas($nomina,$personal){
	...
	if(is_array($result)){
			...
			$salida.= '<th class = "text-center" width = "25px">MONTO BASE</td>';
		...
		foreach($result as $row){
			...
			$salida.= '<th class = "text-center">'.$moneda.' '.$Total.'</th>';
			$salida.= '</tr>';
			$i--;
			$salida.= '</table>';
			$salida.= '</div>';
