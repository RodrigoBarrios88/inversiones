		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php } ?>
					...
					<div class="col-xs-3 text-right"><label>Monto de la Venta: </label><span class = "text-danger">*</span></div>
					<div class="col-xs-3">
						<input type = "text" class = "form-control" name = "montv1" id = "montv1" value = "<?php echo $total." / MONEDA:".$montext; ?>" readonly />
				...
				<div class="row">
					...
					<div class="col-xs-3"><input type = "text" class = "form-control" name = "montp1" id = "montp1"  value = "<?php echo $saldo; ?>" onkeyup = "decimales(this)"  /></div>
