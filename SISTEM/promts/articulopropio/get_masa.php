...
<html>
	...
	<form action="EXElectorcsv.php" name = "f2" name = "f2" method="post" enctype="multipart/form-data">
		<div class="panel panel-default">
			<div class="panel-heading"><label>Cargar Listado de Nueva Mobiliario y Equipo</label></div>
			<div class="panel-body">
				...
				<hr>
				<div class="row">
                    <div class="col-xs-5 col-xs-offset-1"><label>Grupo: </label> <label class = " text-danger">*</label></div>
                    <div class="col-xs-5"><label>Empresa a Cargar: </label> <label class = " text-danger">*</label></div>
                </div>
				<div class="row">
                    <div class="col-xs-5 col-xs-offset-1">
						<?php echo grupo_articulo_propio_html("gru1"); ?>
					</div>
                    <div class="col-xs-5">
                ...
                <div class="row">
                    <div class="col-xs-5 col-xs-offset-1"><label>Seleccione el archivo (*.xml): </label> <label class = " text-danger">*</label></div>
                </div>
				<div class="row">
                    <div class="col-xs-5 col-xs-offset-1">
