    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
					<div class="panel-heading"><label><i class="fa fa-print"></i> Reporte de Inventario de Mobiliario y Equipo</label></div>
					...
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
                            <div class="col-xs-3 text-right"><label>Empresa: </label> <label class = " text-info">*</label></div>
                        ...
                        <div class="row">
                            <div class="col-xs-3 text-right"><label>Grupo: </label> <label class = "text-info">*</label></div>
                            <div class="col-xs-3 text-left">
                            ...
                            <div class="col-xs-3 text-right"><label>Articulo: </label> <label class = "text-info">*</label></div>
						...
						<div class="row">
                            <div class="col-xs-3 text-right"><label>Descripci&oacute;n: </label> <label class = " text-info">*</label></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "desc" id = "desc" onkeyup = "texto(this)" readonly /></div>
                            <div class="col-xs-3 text-right"><label>Marca: </label> <label class = " text-info">*</label></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "marca" id = "marca" onkeyup = "texto(this)" readonly /></div>
                        </div>
						<hr>
						<div class="row">
