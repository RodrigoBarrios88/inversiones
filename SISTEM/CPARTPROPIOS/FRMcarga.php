   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-sign-in"></i> Carga a Inventario de Mobiliario y Equipo</div>
            <div class="panel-body">
				<form id='f1' name='f1' action='FRMcarga.php' method='get'>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>Cantidad: </label> <label class = " text-danger">*</label>
         ...
         <!-- /.panel-default -->
			...
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_inicio_carga($cant); ?>
				</div>
			</div>
			<br>
			<div class="row">
				 <div class="col-xs-12 text-center">
					  ...
					  <button type="button" class="btn btn-primary" onclick = "ConfirmCargaJS();"><span class="fa fa-cloud-upload"></span> Cargar</button>
				 </div>
			</div>
	      <br>
      </div>
