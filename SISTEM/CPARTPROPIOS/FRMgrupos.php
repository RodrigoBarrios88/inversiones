...
<body>
   <div id="wrapper">
      ...
      <div id="page-wrapper">
            ...
            <div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-th"></i> Gestor de Grupos de Mobiliario y Equipo</div>
               <div class="panel-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-5">
								<label>% de Depreciaci&oacute;n: </label> <span class = " text-danger">*</span>
   ...
   <!-- /#wrapper -->
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/grupropio.js"></script>
