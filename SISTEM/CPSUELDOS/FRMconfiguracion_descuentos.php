    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["PLANILLA"] == 1){ ?>
                                <li>
									<a class="active" href="FRMlist_personal_configuracion.php?acc=2">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Descuentos Regulares</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarDescuento();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarDescuento();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
					</form>
					<br>
					<div class="row">
						<div class="col-lg-12">
							<?php
								echo tabla_personal_descuentos_regurlaes($dpi);
							?>
						</div>
					</div>
				</div>
