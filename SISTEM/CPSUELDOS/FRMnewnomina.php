    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Formulario de Apertura de Nominas de Pago</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<textarea class = "form-control" name = " obs" id = "obs" onkeyup = "texto(this)"></textarea>
						</div>	
					</div>
					</form>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarNomina();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
					<div class="row">
