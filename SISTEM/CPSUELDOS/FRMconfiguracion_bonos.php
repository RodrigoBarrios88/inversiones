    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Bonificaciones Regulares</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarBono();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarBono();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
					</form>
					<br>
					<div class="row">
						<div class="col-lg-12">
							<?php
								echo tabla_personal_bonos_regurlaes($dpi);
							?>
						</div>
					</div>
				</div>
