    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Descuentos Emergentes para la Nomina # <?php echo $nomina; ?></label></div>
                <div class="panel-body" id = "formulario">
				<div class="row">
					<div class="col-lg-6">
						<div class="alert alert-info"><i class="fa fa-tags"></i> <label>Descuentos Emergentes del Empleado</label></div>
						...
						<div class="row">
							<div class="col-xs-12"><label>DPI:  </label> <span class="text-danger">*</span></div>
						</div>
						<div class="row">
							<div class="col-xs-12"><label class="text-info"><?php echo $dpi; ?></label></div>
						</div>
						<div class="row">
							<div class="col-xs-12"><label>Nombres y Apellidos:  </label> <span class="text-danger">*</span></div>
						</div>
						<div class="row">
							<div class="col-xs-12"><label class="text-info"><?php echo $nombres; ?></label></div>
						</div>
						<hr>
						<div class="row">
							<div class="col-xs-4"><label>Monto:  </label> <span class="text-danger">*</span></div>
							<div class="col-xs-4"><label>Moneda:  </label> <span class="text-danger">*</span></div>
							<div class="col-xs-4"><label>Tipo de Cambio:  </label> <span class="text-danger">*</span></div>
						</div>
						<div class="row">
							<div class="col-xs-4">
						...
						<div class="row">
							<div class="col-xs-12"><label>Descripci&oacute;n:  </label> <span class="text-danger">*</span></div>
						</div>
						<div class="row">
							<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								...
								<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarDescuentoEmergente();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
								<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarDescuentoEmergente();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							</div>
						</div>
						</form>
					</div>
					<div class="col-lg-6">
						<div class="alert alert-success"><i class="fa fa-check"></i> <label>Descuentos Regulares del Empleado</label></div>
						<div class="col-lg-12">
								<?php
									echo tabla_base_descuentos($nomina,$dpi);	
								?>
						</div>
					</div>
				</div>	
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								echo tabla_personal_descuentos($nomina,$dpi);
							?>
						</div>
					</div>
				</div>
