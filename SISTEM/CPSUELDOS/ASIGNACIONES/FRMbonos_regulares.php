    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Bonificaciones Regulares (Bonificaciones Periodicas)</label></div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="panel panel-info">
								<div class="panel-heading"><i class="fa fa-tags"></i> <label>Bonificariones Regulares del Empleado</label></div>
								<div class="panel-body">
								<?php
									echo tabla_base_bonificaciones_regulares($nomina,$cui);	
								?>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="panel panel-success">
								<div class="panel-heading"><i class="fa fa-check"></i> <label>Bonificaciones Asignadas a esta Nomina</label></div>
								<div class="panel-body">
								<?php
									echo tabla_bonificaciones_regulares($nomina,$cui);
								?>
								</div>
							</div>
						</div>
