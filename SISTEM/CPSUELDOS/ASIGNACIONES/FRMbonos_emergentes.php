    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["PLANILLA"] == 1){ ?>
                                <li>
									<a href="../FRMstatusnomina.php" onclick="window.history.back();">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Bonificaciones Emergentes para la Nomina # <?php echo $nomina; ?></label></div>
                <div class="panel-body" id = "formulario">
					<form id='f1' name='f1' action='#' method='get'>
					<div class="row">
						<div class="col-xs-6">
							<a class="btn btn-default" href="../FRMstatusnomina.php" onclick="window.history.back();" title="Regresar"><i class="fa fa-chevron-left"></i> &nbsp; Atras</a>
						</div>
					...
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarBonoEmergente();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarBonoEmergente();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
					</form>
					<br>
					<div class="row">
						<div class="col-lg-12">
							<?php
								echo tabla_personal_bonos_emergentes($nomina,$dpi);
							?>
						</div>
					</div>
				</div>
