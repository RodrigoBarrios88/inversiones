    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Asignaci&oacute;n de Horas Extras</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-6">
							<?php
								echo tabla_configuracion_horas_extras($nomina,$cui);	
							?>
						</div>
						<div class="col-lg-6">
							<?php
								echo tabla_horas_extras($nomina,$cui);	
							?>
						</div>
					</div>
				</div>
