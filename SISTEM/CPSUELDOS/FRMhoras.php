    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-clock-o"></i> Asignaci&oacute;n de Horas Laboradas y Horas Extras</div>
                <div class="panel-body" id = "formulario">
					<form id='f1' name='f1' action='#' method='get'>
					<div class="row">
						<div class="col-xs-6">
							<a class="btn btn-default" href="FRMstatusnomina.php" title="Regresar"><i class="fa fa-chevron-left"></i> &nbsp; Atras</a>
						</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								if($sit == 1){
									echo tabla_personal_horas($nomina,$tipo);
								}else{
