                ...
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<input type = "text" class = "form-control" name = " desc" id = "desc" onkeyup = "texto(this)" maxlength = "150"/>
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<textarea class = "form-control" name = " obs" id = "obs" onkeyup = "textoLargo(this)"></textarea>
						</div>	
					</div>
					<br>
					<div class="row">
						<div class="col-xs-12 text-center">
							...
							<button type="button" class="btn btn-primary" id = "gra" onclick = "GrabarTipo();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
							<button type="button" class="btn btn-primary hidden" id = "mod" onclick = "ModificarTipo();"><span class="glyphicon glyphicon-floppy-disk"></span> Grabar</button>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_tipo_nomina($codigo,$desc,$sit); ?>
						</div>
					</div>
				</div>
            </div>
