    ...
    <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level collapse in">
                                ...
                                <li class="active">
									...
									<ul class="nav nav-third-level collapse in">
                                        <li>
											<a href="FRMrevisar.php">
												<i class="fa fa-magic"></i> Solicitar Revisi&oacute;n
											</a>
										</li>
                                        <li>
											<a href="FRMaprobar.php">
												<i class="fa fa-check-square-o"></i> Aprobar Nomina
											</a>
										</li>
										<li>
											<a href="FRMpagar.php">
												<i class="fa fa-money"></i> Pagar Nomina
											</a>
										</li>
                                    </ul>
                                </li>
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Formulario Gestor de Tipo de Nominas</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Status:  </label> <span class="text-danger">*</span></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<select class = "form-control" name = "sit" id = "sit" onchange="Submit();">
								<option value = "1" selected>NOMINA EN EDICI&Oacute;N</option>
								<option value = "2">NOMINA PENDIENTE DE APROBACI&Oacute;N</option>
								<option value = "3">NOMINA APROBADA - PENDIENTE DE PAGO</option>
								<option value = "4">NOMINA PAGADA</option>
								<option value = "0">NOMINA DENEGADA (RECHAZADA)</option>
							</select>
							<script type = "text/javascript">
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								if($tipo != "" || $clase != "" || $periodo != "" || $sit != ""){
									echo tabla_status_nomina($codigo,$tipo,$clase,$periodo,$sit);
								}
							?>
						</div>
					</div>
