<?php
	...
	$acc = $_REQUEST["acc"];
	if($acc == 1){
		$titulo = "Asignaci&on de Bonificaciones Regulares";
	}else if($acc == 2){
		$titulo = "Asignaci&on de Descuentos Regulares";
	}
if($pensum != "" && $nombre != ""){ 	
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label><?php echo $titulo; ?></label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12">
							<?php
								echo tabla_personal_configuracion($acc);
							?>
						</div>
					</div>
				</div>
