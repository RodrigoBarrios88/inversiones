...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<form name = "f1" id = "f1" action="REPusuarios.php" method="post" target = "_blank">
				<br>
				<div id = "cuerpo" class="panel panel-default">
					<div class="panel-heading"><label><i class="glyphicon glyphicon-print"></i> Reporte de Proveedores</label></div>
					<div class="panel-body">
						<div class="row">
							<div class="col-xs-12 col-xs-12 text-right"><label class = " text-info">* Campos de Busqueda</label></div>
						</div>
                        <div class="row">
							<div class="col-xs-2 text-right"><label>Nit:  </label> <span class="text-info">*</span></div>
							<div class="col-xs-3">
								<input type = "text" class = "form-control" name = " nit" id = "nit"  onkeyup = "texto(this)"/>
								<input type = "hidden" name = "cod" id = "cod" />
							</div>	
							<div class="col-xs-2 text-right"><label>Nombre:  </label> <span class="text-info">*</span></div>
