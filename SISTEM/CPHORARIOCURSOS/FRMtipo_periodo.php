...
<body>
            ...
            <form name = "f1" id = "f1" method="get">
				<div id = "cuerpo" class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-th"></i>
						<label>Gestor de Tipo de Periodos para Cursos Libres</label>
					</div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/horario/tipoperiodocurso.js"></script>
