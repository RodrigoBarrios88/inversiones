<?php
	...
	$titulo = "HORARIO DE $grado_desc SECCI&Oacute;N $seccion_desc DEL D&Iacute;A $dia_desc";
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-file-text fa-fw"></i> Horario Diario por Secci&oacute;n
					...
					<div class="panel-body">
						...
						<div class = "row">
							<div class = "col-xs-12">
								<?php
									if($pensum != "" && $nivel != "" && $grado != "" && $seccion != "" && $dia != ""){
										echo tabla_horario_dia_seccion($dia,$pensum,$nivel,$grado,$seccion,$tipo);
									}
								?>
							</div>
						</div>
	...
	$(document).ready(function() {
		$('#dataTables-example').DataTable({
			...
			buttons: [
				'copyHtml5',
				'csvHtml5',
				 {extend: 'pdf', title: 'Horario Diario por Seccion'},
				 {extend: 'excel', title: 'Horario Diario por Seccion'}
			]
		} );
	} );
    </script>	
