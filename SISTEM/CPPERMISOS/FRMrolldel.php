    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMrolldel.php"><i class="glyphicon glyphicon-briefcase"></i> Roles<span class="glyphicon arrow"></span></a>
									<ul class="nav nav-third-level collapse">
										<li>
		...
		<form name = "f1" name = "f1" method="post" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-floppy-remove"></i> Formulario de Deshabilitaci&oacute;n de Roles </label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-12" id = "result">
						<?php echo tabla_roles('','D') ?>
						</div>
					</div>
                </div>
				<!-- /.panel-body -->
