...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="FRMgrupo.php"><i class="glyphicon glyphicon-briefcase"></i> Permisos<span class="glyphicon arrow"></span></a>
		...
		<div class="panel-heading"><label><i class="glyphicon glyphicon-king"></i> Formulario Gestor de Permisos</label></div>
			...
			<div class="row">
			    <div class="col-xs-12 col-xs-12 text-right"><label class = " text-danger">* Campos Obligatorios</label> <label class = " text-info">* Campos de Busqueda</label></div>
                        ...
                        <div class="row">
                            <div class="col-xs-3 text-right"><label>Nombre del Grupo: </label> <span class="text-danger">*</span> <span class="text-info">*</span></div>
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php echo tabla_grupos($cod,$desc,$clv); ?>
					</div>
				</div>
            </div>
             <!-- /.panel-default -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/seguridad/grupo.js"></script>
