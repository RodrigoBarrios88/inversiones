    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-print"></i> Reporte de Roles de Permiso</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"> <label class = " text-info">* Campos de Busqueda</label></div>
					</div>
                    <div class="row">
                        <div class="col-xs-3 text-right"><label>Nombre del Rol: <span class="text-info">*</span></div>
                        <div class="col-xs-3"><input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this)" /></div>
                        <div class="col-xs-2 text-right"><label>Descripci&oacute;n: <span class="text-info">*</span></div>
