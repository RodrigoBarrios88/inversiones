    ...
    <div id="wrapper">
		...
		<form name = "f1" id = "f1" action="REPgrupo.php" method="post" target = "_blank">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-print"></i> Reporte de Grupos de Permiso</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"> <label class = " text-info">* Campos de Busqueda</label></div>
					</div>
                    <div class="row">
                        <div class="col-xs-3 text-right"><label>Nombre del Grupo: <span class="text-info">*</span></div>
                        ...
                        <div class="col-xs-2 text-right"><label>Clave: <span class="text-info">*</span></div>
