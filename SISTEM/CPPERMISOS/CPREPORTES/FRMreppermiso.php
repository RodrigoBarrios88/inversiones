    ...
    <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									...
									<ul class="nav nav-third-level collapse">
										...
										<li>
										<a href="FRMrepgrupo.php"><i class="glyphicon glyphicon-print"></i> Reporte Grupo/Permisos</a>
										</li>
										<li>
										<a href="FRMreppermiso.php"><i class="glyphicon glyphicon-print"></i> Reporte de Permisos</a>
										</li>
									</ul>
									<!-- /.nav-second-level -->
								</li>
								<li>
									...
									<ul class="nav nav-third-level collapse">
										...
										<a href="../FRMrolldel.php"><i class="glyphicon glyphicon-floppy-remove"></i> Deshabilitar Roles</a>
										 ...
										 <li>
										<a href="FRMreproll.php"><i class="glyphicon glyphicon-print"></i> Reporte de Roles</a>
										</li>
									</ul>
									<!-- /.nav-second-level -->
								</li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-print"></i> Reporte de Permisos</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"> <label class = " text-info">* Campos de Busqueda</label></div>
					</div>
                    <div class="row">
                        <div class="col-xs-2 text-right"><label>Grupo: </label> <span class="text-info">*</span></div>
                        <div class="col-xs-4"><?php echo Grupos_html("gru"); ?><input type = "hidden" name = "cod" id = "cod" /></div>
                        <div class="col-xs-2 text-right"><label>Clave: </label> <span class="text-info">*</span></div>
