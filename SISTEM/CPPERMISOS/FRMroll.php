    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMroll.php"><i class="glyphicon glyphicon-briefcase"></i> Roles<span class="glyphicon arrow"></span></a>
									<ul class="nav nav-third-level collapse">
										<li>
		...
		<form name = "f1" name = "f1" method="post" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-copy"></i> Formulario Gestor de Roles de Permisos</label></div>
                <div class="panel-body">
					...
					<div class="row">
                            ...
                            <div class="col-xs-9"><textarea type = "text" class="form-control" name = "desc" id = "desc" onkeyup = "texto(this)"></textarea></div>
                    </div>
                    <br>
                </div>
                <!-- /.panel-body -->
