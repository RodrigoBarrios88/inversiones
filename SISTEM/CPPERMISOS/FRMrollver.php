    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMrollver.php"><i class="glyphicon glyphicon-briefcase"></i> Roles<span class="glyphicon arrow"></span></a>
									<ul class="nav nav-third-level collapse">
										<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-eye-open"></i> Visualizaci&oacute;n de Roles de Permiso</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-12" id = "result">
						<?php echo tabla_roles('','V') ?>
						</div>
					</div>
            	</div>		
                <!-- /.panel-body -->
