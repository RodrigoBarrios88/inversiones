...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="FRMpermiso.php"><i class="glyphicon glyphicon-briefcase"></i> Permisos<span class="glyphicon arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="glyphicon glyphicon-pawn"></i>  Formulario Gestor de Permisos</label></div>
                <form id = "f1" name = "f1" method="get">
				    <div class="panel-body">
                     ...
                     <div class="row">
                            <div class="col-xs-2 text-right"><label>Grupo: </label> <span class="text-danger">*</span> <span class="text-info">*</span></div>
                            <div class="col-xs-4">
								<?php echo Grupos_html("gru","Submit();"); ?>
								<input type = "hidden" name = "cod" id = "cod" />
								<script>
									document.getElementById("gru").value = '<?php echo $grupo; ?>';
								</script>
							</div>
                            <div class="col-xs-2 text-right"><label>Clave: </label> <span class="text-danger">*</span> <span class="text-info">*</span></div>
                            <div class="col-xs-4 text-left"><input type = "text" class="form-control" name = "clv" id = "clv" onkeyup = "texto(this)" maxlength = "10" /></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2 text-right"><label>Descripci&oacute;n: </label> <span class="text-danger">*</span> &nbsp;</div>
                            <div class="col-xs-10"><input type = "text" class="form-control" name = "desc" id = "desc" onkeyup = "texto(this)" /></div>
                        </div>
                        <br>
                        <div class="row">
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php echo tabla_permisos($id,$grupo,$desc,$clv); ?>
					</div>
				</div>
            </div>
             <!-- /.panel-default -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/seguridad/permiso.js"></script>
