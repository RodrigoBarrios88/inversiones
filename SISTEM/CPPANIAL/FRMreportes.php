<?php
	include_once('xajax_funct_panial.php');
...
<body>
      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la Secci&oacute;n a publicar el Reporte de Pa&ntilde;al
				</div>
				<div class="panel-body">
				<?php
					$ClsPan = new ClsPanial();
					$result = $ClsPan->get_panial('',$pensum,$info_nivel,$info_grado,$info_seccion,'','','');
					if(is_array($result)){
				?>
					<ul class="notes">
					<?php
						foreach($result as $row){
							//grado
							$grado = utf8_decode($row["pan_grado_desc"]);
							$seccion = utf8_decode($row["pan_seccion_desc"]);
							//target
					...
					?>
						<li>
							<div>
								...
								<h5>Reporte de Pa&ntilde;al</h5>
								<p>Deseamos informar que el d&iacute;a de hoy cambiamos el pa&ntilde;al de su hijo(a): <strong><?php echo $alumno; ?></strong>.</p>
								<p>
									Veces con pipi: <strong><?php echo $pipi; ?></strong>.<br>
									Veces con popo: <strong><?php echo $popo; ?></strong>.<br>
									Consistencia: <strong><?php echo $tipo; ?></strong>.<br>
									Observaciones: <strong><?php echo $obs; ?></strong>.
								</p>
   ...
   <!-- //////////////////////////////////////////////////////// -->
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/app/panal.js"></script>
