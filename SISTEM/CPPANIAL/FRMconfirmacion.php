<?php
	...
	if(is_array($result_alumnos)){
		$combo_alumnos = combos_html_onclick($result_alumnos,"target","alu_cui","alu_nombre","");
	}else{
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body">
					<?php
						echo tabla_reportes_confirmacion($cod,$pensum,$nivel,$grado,$seccion,$desde,$fecha,$sit);
					?>
				</div>
			</div>
	    <!-- /.panel-default -->
