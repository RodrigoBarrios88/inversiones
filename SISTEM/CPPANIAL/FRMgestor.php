         ...
         <br>
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Gestor de Reporte de Pa&ntilde;al
				</div>
				<div class="panel-body"> 
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<input type = "hidden" id="texto" name = "texto" value = "Reporte de Pa&ntilde;al" />
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Cantidad de Veces (cambios) de Pipi:</label> <span class="text-danger">*</span>
							<input type = "text" class = "form-control" name = "pipi" id = "pipi" value = "0" onkeyup="enteros(this)" maxlength="2" />
						</div>
						<div class="col-xs-5">
							<label>Cantidad de Veces (cambios) de Popo:</label> <span class="text-danger">*</span>
							<input type = "text" class = "form-control" name = "popo" id = "popo" value = "0" onkeyup="enteros(this)" maxlength="2" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<label>Consistencia:</label> <span class="text-danger">*</span>
							<select class = "form-control" name = "tipo" id = "tipo">
								<option value="">Seleccione</option>
								<option value="Normal">Normal</option>
								<option value="Aguado">Aguado</option>
								<option value="Estre&ntilde;ido">Estre&ntilde;ido</option>
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							...
							<textarea class="form-control" id = "obs" name = "obs" onkeyup="texto(this)" maxlength="250"></textarea>
						</div>
					</div>
					<br>
					<div class="row">
