<?php
	...
	$codigo = $ClsPan->decrypt($hashkey, $id);
	
	$result = $ClsPan->get_panial($codigo);
	if(is_array($result)){
		foreach($result as $row){
			$cod = $row["pan_codigo"];
			$titulo = utf8_decode($row["pan_titulo"]);
			$target = $row["pan_target"];
			$tipo = $row["pan_tipo_target"];
			$fecha = trim($row["pan_fecha_registro"]);
	...
	$alerta = "Titulo: Reporte de Pa&ntilde;al, de fecha $fecha";
      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
            ...
            <div class="panel-body">
					...
					<?php echo tabla_lectura(7,$codigo,$nivel,$grado,$seccion); ?>
				</div>
			</div>
			<!-- /.panel-default -->
			<br>
