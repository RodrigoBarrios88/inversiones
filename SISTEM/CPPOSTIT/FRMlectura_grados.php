      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el grado a reisar lectura
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-3 text-center">
							<?php if($tipo_usuario == 1 || $tipo_usuario == 5 ){ ?>
							<a class="btn btn-primary btn-outline" href="FRMlectura_niveles.php">
						...
						<div class="col-lg-3 text-center">
							<a class="btn btn-primary active" href="FRMlectura_grados.php">
						...
						<?php
							if(is_array($result_grados)){
								...
								foreach($result_grados as $row){
									...
									$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMconfirmacion.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
									$salida.= '</td>';
									//--
									$salida.= '</tr>';
									$i++;
