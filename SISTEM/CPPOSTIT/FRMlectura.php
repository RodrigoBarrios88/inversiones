      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la Secci&oacute;n a revisar las lecturas
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-3 text-right">
							<a class="btn btn-primary active" href="FRMlectura.php">
						...
						<?php
							if(is_array($result_secciones)){
								...
								foreach($result_secciones as $row){
									...
									$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMconfirmacion.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
									$salida.= '</td>';
									//--
									$salida.= '</tr>';
									$i++;
