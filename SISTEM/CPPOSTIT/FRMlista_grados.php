<?php
	...
	if($tipo_usuario == 2){ //// MAESTRO - DIRECTORA
		$result_grados = $ClsAcadem->get_grado_maestro($pensum,'','',$tipo_codigo);
	}else if($tipo_usuario == 1){ ////// 
		$result_grados = $ClsAcadem->get_grado_otros_usuarios($pensum,'','',$tipo_codigo);
	}else if($tipo_usuario == 5){
		$result_grados = $ClsPen->get_grado($pensum,'','',1);
	}else{
		$valida = "";
	}
      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el grado a publicar la Notificaci&oacute;n
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-3 text-left">
							<?php if($tipo_usuario == 1 || $tipo_usuario == 5 ){ ?>
							<a class="btn btn-primary btn-outline" href="FRMgestorglobal.php">
						...
						<div class="col-lg-3 text-center">
							<?php if($tipo_usuario == 1 || $tipo_usuario == 5 ){ ?>
							<a class="btn btn-primary btn-outline" href="FRMlista_niveles.php">
						...
						<div class="col-lg-3 text-center">
							<a class="btn btn-primary active" href="FRMlista_grados.php">
								<i class="fa fa-paste"></i> <i class="fa fa-tags"></i> Postit para todo un Grado
							</a>
						</div>
						<div class="col-lg-3 text-right">
							<a class="btn btn-primary btn-outline" href="FRMpostit.php">
					...
					<div class="dataTable_wrapper">
						...
						<thead>
							...
							<th width = "200px" class = "text-center">Grados</td>
						...
						<?php
							if(is_array($result_grados)){
								...
								foreach($result_grados as $row){
									...
									//grado
									$salida.= '<td class = "text-left">'.$grado_desc.'</td>';
									//boton
									$salida.= '<td class = "text-center">';
									$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMgestorgrados.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
									$salida.= '</td>';
									//--
									$salida.= '</tr>';
									$i++;
