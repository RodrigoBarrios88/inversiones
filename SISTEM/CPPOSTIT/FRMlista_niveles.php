      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el nivel a publicar la Notificaci&oacute;n
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-3 text-center">
							<?php if($tipo_usuario == 1 || $tipo_usuario == 5 ){ ?>
							<a class="btn btn-primary active" href="FRMlista_niveles.php">
						...
						<?php
							if(is_array($result_niveles)){
								...
								foreach($result_niveles as $row){
									...
									$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMgestornivel.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
									$salida.= '</td>';
									//--
									$salida.= '</tr>';
									$i++;
