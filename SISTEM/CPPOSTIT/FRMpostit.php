      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la Secci&oacute;n a publicar la Notificaci&oacute;n
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-3 text-center">
							<a class="btn btn-primary btn-outline" href="FRMlista_grados.php">
								<i class="fa fa-paste"></i> <i class="fa fa-tags"></i> Postit para todo un Grado
							</a>
						</div>
						<div class="col-lg-3 text-right">
							<a class="btn btn-primary active" href="FRMpostit.php">
						...
						<?php
							if(is_array($result_secciones)){
								...
								foreach($result_secciones as $row){
									...
									$salida.= '<a type="button" class="btn btn-primary btn-block" href="FRMgestorpostit.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';   
									$salida.= '</td>';
									//--
									$salida.= '</tr>';
									$i++;
