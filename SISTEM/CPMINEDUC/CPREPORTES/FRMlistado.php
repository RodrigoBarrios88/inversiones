				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Listado Auxiliar (Listado de Alumnos por Secci&oacute;n)
						</div>
    ...
    <script>
		...
		function Excel(){
			...
			if(pensum.value !=="" && nivel.value !=="" && grado.value !== "" && seccion.value !== ""){
				myform = document.forms.f1;
				myform.target ="_blank";
				myform.action ="EXCELlistado_seccion.php";
				myform.submit();
				myform.action ="";
				myform.target ="";
			}else{
