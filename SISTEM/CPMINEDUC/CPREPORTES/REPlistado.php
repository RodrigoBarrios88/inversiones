	...
	<nav class="navbar navbar-default navbar-fixed-top" style = "z-index:500;">
        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text fa-fw"></i> Listado Auxiliar de Alumnos (<strong><?php echo $grado_desc; ?></strong>)
			</div>
			<div class="panel-body">
				<div class = "row">
					<?php
						if($pensum != "" && $nivel != ""){
							echo tabla_alumnos_auxiliar($pensum,$nivel,$grado,$seccion);
						}else{
        ...
        $(document).ready(function(){
           $('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'pdf', title: '<?php echo $grado_desc; ?>'},
