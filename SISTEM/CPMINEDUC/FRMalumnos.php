    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPALUMNOS/FRMgestor_secciones.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPALUMNOS/FRMficha_secciones.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
									<a class="active" href="FRMficha_secciones.php">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
									<a href="../CPALUMNOS/FRMasignacion_secciones.php">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-list-alt"></i> Listado de Alumnos de <?php echo $titulo; ?></label></div>
                    <div class="panel-body">
						<div class="row">
							<div class="col-lg-12" id = "result">
								<?php echo tabla_alumnos($pensum,$nivel,$grado,$seccion); ?>
							</div>
						</div>
					</div>
                    <hr>
