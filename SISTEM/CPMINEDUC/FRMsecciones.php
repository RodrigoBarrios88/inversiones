							...
							<tr>
								...
								<?php
									...
									foreach($result_secciones as $row){
										...
										$salida.= '<a class="btn btn-primary btn-block" href="FRMeditcodigo.php?hashkey1='.$pensum.'&hashkey2='.$nivel.'&hashkey3='.$grado.'&hashkey4='.$seccion.'" title = "Seleccionar Secci&oacute;n" ><span class="fa fa-chevron-right"></span></a>';
										$salida.= '</td>';
										$salida.= '</tr>';
										$i++;
									}
