<?php
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			$suc = utf8_decode($row["pol_sucursal"]);
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<?php if($_SESSION["CONTAPAR"] == 1){ ?>
                                <li>
									<a class="active" href="FRMmodpoliza.php?hashkey=<?php echo $hashkey; ?>">
										<i class="fa fa-pencil"></i> Actualizar Poliza
									</a>
								</li>
								<?php } ?>
								<?php if($_SESSION["CONTAPAR"] == 1){ ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
					<label><i class="fa fa-pencil"></i> Actualizar Poliza Contable</label>
				</div>
					...
					<form id='f1' name='f1' method='get'>
						...
						<div class="row">
                            <div class="col-xs-5 col-xs-offset-1">
								...
								<input type = "hidden" name = "cod" id = "cod" value="<?php echo $poliza; ?>" />
								<script>
							...
							<div class="col-xs-5">
								...
								<input type = "text" class = "form-control" name = "doc" id = "doc" value="<?php echo $documento; ?>" onkeyup = "texto(this);" />
							</div>
                        </div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								<div class="form-group" id="data_1">
									<label>Fecha Contable: </label> <span class="text-danger">*</span> 
						...
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1">
								...
								<textarea class = "form-control" name = "desc" id = "desc" onkeyup = "textoLargo(this);"><?php echo $descripcion; ?></textarea>
							</div>
						</div>
                        <br>
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-primary" id = "gra" onclick = "Modificar();"><span class="fa fa-save"></span> Grabar</button>
                            </div>
                        </div>
					</form>	
                </div>
