<?php
	...
	$codigo = $ClsGol->decrypt($hashkey, $id);
	
	$result = $ClsGol->get_golpe($codigo);
	if(is_array($result)){
		foreach($result as $row){
			$cod = $row["gol_codigo"];
			$titulo = utf8_decode($row["gol_titulo"]);
			$target = $row["gol_target"];
			$desc = $row["gol_descripcion_target"];
			$fecha = trim($row["gol_fecha_registro"]);
	...
	$alerta = "Titulo: Reporte de Golpe, de fecha $fecha";
	    ...
	    <br>
         <div class="panel panel-default">
            ...
            <div class="panel-body">
					...
					<?php echo tabla_lectura(8,$codigo,$nivel,$grado,$seccion); ?>
				</div>
			</div>
			<!-- /.panel-default -->
			<br>
