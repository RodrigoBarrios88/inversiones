<?php
	include_once('xajax_funct_golpe.php');
...
<body>
				...
				<div class="panel-body"> 
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							...
							<input type = "hidden" id="texto" name = "texto" value = "(Reporte de Golpe)
							Estimados Se&ntilde;ores:
							Nos dirigimos a ustedes para informarles con mucha pena que su hijo(a) se lastim&oacute;, a continuaci&oacute;n los detalles (click)" />
						</div>
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Lugar del accidente:</label> <span class="text-danger">*</span>
							<input type = "text" class = "form-control" name = "lugar" id = "lugar" onkeyup="texto(this)" maxlength="50" />
						</div>
						<div class="col-xs-5">
							<label>Hora del suceso:</label> <span class="text-danger">*</span>
					...
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<label>Parte del Cuerpo lastimada y Descripci&oacute;n del Golpe:</label> <span class="text-danger">*</span>
							<input type = "text" class = "form-control" name = "desc" id = "desc" onkeyup="texto(this);" maxlength="100" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-10 col-xs-offset-1">
							<label>Medida tomada de inmediato y medicamento autorizado:</label> <span class="text-danger">*</span>
							<input type = "text" class = "form-control" name = "medida" id = "medida" onkeyup="texto(this);" maxlength="100" />
						</div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<label>Dosis:</label> <em class="text-muted">(no obligatorio)</em>
   ...
   <script src="../assets.3.6.2/js/plugins/clockpicker/clockpicker.js"></script>
	...
	<script type="text/javascript" src="../assets.3.6.2/js/modules/app/golpe.js"></script>
