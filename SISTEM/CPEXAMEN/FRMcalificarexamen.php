<?php
	...
	$examen = $ClsExa->decrypt($hashkey, $usuario);
	$result = $ClsExa->get_det_examen($examen);
	if(is_array($result)){
	    foreach($result as $row){
	    $tardesc = utf8_decode($row["exa_titulo"]);
	    $fechatar = utf8_decode($row["exa_fecha_limite"]);
	    }
	}
            ...
            <br>
           	<div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Revisi&oacute;n y Calificaci&oacute;n de Evaluaciones
				</div>
				<br>
				<div class="panel-body"> 
				<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Examen:</label></div>
					...
					<div class="row">
						<div class="col-lg-3 col-lg-offset-9 text-right">
							<a class="btn btn-default" href="FRMreenviar.php?hashkey=<?php echo $hashkey; ?>" ><i class="fa fa-envelope-o"></i> <i class="fa fa-send-o"></i> Reenviar Evaluaciones </a>
						</div>
					</div>
					<div class="row">
						<?php echo tabla_examen_alumnos($examen); ?>
					</div>
					<br>
				</div>
				<!-- /.panel-default -->
