                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a <?php echo $active1; ?> href="FRMlista_secciones.php?acc=gestor">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
                                    <a <?php echo $active2; ?> href="FRMlista_secciones.php?acc=calificar">
								...
								<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
                                    <a <?php echo $active3; ?> href="FRMlista_secciones.php?acc=ver">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione la materia donde se asignar&aacute; la Evaluacion
				</div>
						...
						<div class="col-xs-12">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									...
									<th width = "150px" class = "text-center">MATERIA</td>
									<th width = "150px" class = "text-center">TIPO</td>
									<th width = "50px" class = "text-center"><span class="fa fa-cogs"></span></td>
									</tr>
								</thead>
								<?php
									if(is_array($result_materias)){
										...
										foreach($result_materias as $row){
											if($tipo_usuario == 2){ //// MAESTRO - DIRECTORA
												...
												$nombre = utf8_decode($row["materia_descripcion"]);
											...
											$usu = $_SESSION["codigo"];
											$hashkey5 = $ClsAcadem->encrypt($materia, $usu);
											//No.
											$salida.= '<td class = "text-center">'.$i.'. </td>';
											//nombre
											$salida.= '<td class = "text-left">'.$nombre.'</td>';
											//tipo
											$tipo = utf8_decode($row["mat_tipo"]);
											switch($tipo){
												case "A": $tipo = "ACAD&Eacute;MICA"; break;
												case "P": $tipo = "PR&Aacute;CTICA"; break;
												case "D": $tipo = "DEPORTIVA"; break;
												default: $tipo = "ACAD&Eacute;MICA";
											}
											$salida.= '<td class = "text-center">'.$tipo.'</td>';
											//boton
											$salida.= '<td class = "text-center">';
											if($acc == "gestor"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMgestorexamen.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "calificar"){
											$salida.= '<a class="btn btn-primary btn-block" href="FRMlistarexamen.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'&acc=calificar" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}else if($acc == "ver"){
											$salida.= '<a class="btn btn-primary btn-block" href="IFRMexamen.php?hashkey1='.$hashkey1.'&hashkey2='.$hashkey2.'&hashkey3='.$hashkey3.'&hashkey4='.$hashkey4.'&hashkey5='.$hashkey5.'" target = "_blank" title = "Seleccionar Tema" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											}
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
