<?php
	...
	if($tipo_usuario == 2){ //// MAESTRO
		$results = $ClsCur->get_maestro("",$tipo_codigo);
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Seleccione el Curso a asignar Evaluaciones
				</div>
						...
						<div class="col-xs-10 col-xs-offset-1">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									...
									<th width = "150px" class = "text-center">CURSO</td>
								...
								<?php
									if(is_array($results)){
										...
										foreach($results as $row){
											...
											$salida.= '<a class="btn btn-primary btn-block" href="FRMtemaexamen.php?hashkey='.$hashkey.'&acc='.$acc.'" title = "Seleccionar Curso" ><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></a>';
											$salida.= '</td>';
											$salida.= '</tr>';
											$i++;
										}
