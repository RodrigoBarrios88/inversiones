    ...
    <div id="wrapper">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="FRMclientes.php">
										<i class="fa fa-user"></i> Gestor de Clientes
									</a>
								</li>
								<li>
									<a href="CPREPORTES/FRMreplistado.php">
										<i class="glyphicon glyphicon-print"></i> Reporte de Clientes
									</a>
								</li>
								<hr>
								<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-user"></i>  Formulario Gestor de Clientes</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Telefono 1:  </label> </div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php echo tabla_clientes($cod,$nit,$nom); ?>
					</div>
				</div>
			</div>
	    </div>
