...
<body>
    ...
    <div class="row">
		<div class="col-xs-12">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h5><i class="fa fa-history"></i> Historial de Compras del Cliente</h5>		
				</div>
				<div class="panel-body">
				<?php echo tabla_historial_compra($cliente); ?>
				</div>
			</div>
		</div>
	</div>
...
function tabla_historial_compra($cliente){
	...
	if(is_array($result)){
		...
		foreach($result as $row){
			...
			$salida.= '<td class = "text-center" >';
			$salida.= '<a class="text-success" href = "FRMdetalle_historial.php?hashkey='.$hashkey.'" title = "Ver Detalle de Compra" ><span class="fa fa-paste fa-2x"></span></a> ';
			$salida.= '</td>';
			//--
			$salida.= '</tr>';
			//--
