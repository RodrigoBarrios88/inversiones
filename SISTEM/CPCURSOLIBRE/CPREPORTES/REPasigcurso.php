	...
	<nav class="navbar navbar-default navbar-fixed-top" style = "z-index:500;">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text fa-fw"></i> Listado de Alumnos por Curso (<strong><?php echo $curso_desc; ?></strong>)
			</div>
			<div class="panel-body">
				<div class = "row">
					<div class = "col-xs-12">
						<?php
							if($curso != ""){
								echo tabla_alumno_asignacion_cursos($curso);
							}
						?>
					</div>
				</div>
