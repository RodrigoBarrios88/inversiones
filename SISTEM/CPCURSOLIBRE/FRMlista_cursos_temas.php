	...
	if($tipo_usuario == 2){ //// MAESTRO
		...
		if(is_array($result_cursos)){
			...
			foreach($result_cursos as $row){
				$arrcursos.= $row["cur_codigo"].",";
			}
			$arrcursos = substr($arrcursos, 0, -1);
		}
      ...
      <div id="page-wrapper">
	    <br>
			<div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-tag"></i> Listado y Asignaci&oacute;n de Alumnos a Cursos Libres</div>
         ...
         <!-- /.panel-default -->
			...
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_cursos_para_temas($arrcursos,$sede,$clase,"","","",$fini,$ffin); ?>
				</div>
			</div>
		</div>
      <!-- /#page-wrapper -->
