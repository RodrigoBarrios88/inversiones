                  ...
                  <ul class="nav" id="side-menu">
							<li class="active">
								...
								<ul class="nav nav-second-level">
									...
									<li>
										<a class="active" href="FRMlista_cursos_temas.php">
									...
									<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
									<li>
										<a href="CPREPORTES/FRMrepcurso.php">
									...
									<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
									<li>
										<a href="CPREPORTES/FRMesquema.php">
									...
									<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
									<li>
										<a href="CPREPORTES/FRMrepasigcurso.php">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Gestor de Temas (Dosificaci&oacute;n del Curso)
						</div>
						<br>
						<div class="row">
							<div class="col-xs-4 col-xs-offset-1"><label>Curso:</label></div>
							<div class="col-xs-4"><label>Sede:</label></div>
							<div class="col-xs-3"><label>Fechas (Inicio y Final):</label></div>
						</div>
						<div class="row">
							<div class="col-xs-4 col-xs-offset-1">
								<label class = "text-info"><?php echo $nombre; ?></label>
							...
							<div class="col-xs-4">
								<label class = "text-info"><?php echo $sede; ?></label>
							</div>
							<div class="col-xs-3">
								<label class = "text-info"><?php echo $fechas; ?></label>
							</div>
						</div>
						<hr>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Nombre:</label></div>
							<div class="col-xs-5"><label>Cantidad de Per&iacute;odos:</label></div>
						</div>
						<div class="row">
							...
							<div class="col-xs-5">
								<input type = "text" class = "form-control" name = "periodos" id = "periodos" onkeyup="decimales(this);" maxlength="6" />
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1">
								<textarea class = "form-control" name = "desc" id = "desc" rows="4" onkeyup="textoLargo(this)" ></textarea>
							</div>
						</div>
						<br>
						<div class="row">
