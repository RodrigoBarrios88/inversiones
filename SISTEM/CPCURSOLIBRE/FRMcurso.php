...
<body>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Gestor de Cursos Libres
						</div>
						<br>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Nombre:</label></div>
							<div class="col-xs-5"><label>Sede:</label></div>
						</div>
						<div class="row">
							...
							<div class="col-xs-5">
								<?php echo sede_html("sede",""); ?>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Clasificaci&oacute;n:</label></div>
							<div class="col-xs-5"><label>Cupo M&aacute;ximo de Alumno:</label></div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
							...
							<div class="col-xs-5">
								<input type = "text" class = "form-control" name = "cupo" id = "cupo" onkeyup="enteros(this)" />
							</div>
						</div>
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1"><label>Periodo de Curso (Desde - Hasta):</label> <span class="text-success">*</span></div>
						</div>
						<div class="row">
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/lms/curso.js"></script>
