      ...
      <div id="page-wrapper">
         ...
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-tag"></i> Listado de Alumnos Asignados a Cursos Libres
				</div>
            <div class="panel-body">
				<form name = "f1" id = "f1" method="get">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Sede:</label></div>
						<div class="col-xs-5"><label>Curso:</label></div>
					</div>
					<div class="row">
						...
						<div class="col-xs-5">
							<?php echo cursos_libres_html("curso",$sede,"Submit();"); ?>
							<script type = "text/javascript">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Rango de Inicio de Curso:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
         ...
         <!-- /.panel-default -->
			...
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_cursos_para_asignar($curso,$sede,$clase,"","","",$fini,$ffin); ?>
				</div>
			</div>
		</div>
      <!-- /#page-wrapper -->
