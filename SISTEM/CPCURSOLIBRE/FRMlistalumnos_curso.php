...
<body>
    <div id="wrapper">
                  ...
                  <ul class="nav" id="side-menu">
							<li class="active">
								...
								<ul class="nav nav-second-level">
									...
									<?php if($tipo_usuario == 1 || $tipo_usuario == 2 || $tipo_usuario == 5){ ?>
									<li>
										<a class="active" href="FRMlista_cursos.php">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-tag"></i> <label>Listado y Asignaci&oacute;n de Alumnos a Cursos Libres</label></div>
                <div class="panel-body">
					<form name = "f1" id = "f1" method="get">
						...
						<div class="row">
							<div class="col-xs-3 col-xs-offset-1"><label>Curso:</label></div>
							<div class="col-xs-3"><label>Sede:</label></div>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_alumno_asignacion_cursos($codigo,$cui,$nom,$ape,$sit); ?>
						</div>
					</div>
                </div>
                <!-- /.panel-body -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/lms/asignacion.js"></script>
