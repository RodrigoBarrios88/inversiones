<?php
	...
	$ClsExa = new ClsExamen();
    $result = $ClsExa->get_examen_curso($examen);
	
	if(is_array($result)){
		foreach($result as $row){
			$curso_nombre = trim(utf8_decode($row["cur_nombre"]));
			$examen_nombre = trim(utf8_decode($row["exa_titulo"]));
		}	
	}
	
	$puntos_total = $ClsExa->get_examen_sumatoria_preguntas_curso($examen);
    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-edit"></i> <label>Gestor de Preguntas</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<a href="javascript:void(0)" onclick="window.history.back();"><i class="fa fa-arrow-left text-info"></i> &nbsp; Regresar a Evaluaciones</a>
						</div>
					</div>
					<br>
					<div class="row">
