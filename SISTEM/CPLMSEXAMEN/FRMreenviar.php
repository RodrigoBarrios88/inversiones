<?php
	...
	$examen = $ClsCur->decrypt($hashkey, $usuario);
	...
	if(is_array($result)){
		foreach($result as $row){
			...
			//descripcion
			$examen_nombre = utf8_decode($row["exa_titulo"]);
		}	
	}	
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="FRMcursoexamen.php?acc=gestor">
								...
								<?php if($tipo_usuario == 2 || $tipo_usuario == 5){ ?>
								<li>
                                    <a href="FRMreenviar.php?hashkey=<?php echo $hashkey; ?>">
									<i class="fa fa-send"></i> Reenviar Evaluaciones
									</a>
                                </li>
                                <?php } ?>
								<hr>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"> 
					...
					Re-Envio de Evaluaciones a Alumno
				</div>
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-3 col-lg-offset-9 text-right">
							<button type="button" class="btn btn-info btn-outline" onclick = "ReEnviarTodos(<?php echo $curso; ?>,<?php echo $examen; ?>);" ><i class="fa fa-group"></i> <i class="fa fa-send-o"></i> a Todos </button>
						</div>
					</div>
					<div class="row">
						<?php echo tabla_reenvio_examen($curso,$examen); ?>
					</div>
					<br>
				</div>
			</div>
