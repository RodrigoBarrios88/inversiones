                    ...
                    <div class="caption-full">
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1">
								<h4><a href="javascript:void(0);"><?php echo $titulo; ?></a> &nbsp; <label class="text-danger">(Clave de Evaluacion)</label></h4>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-10 col-xs-offset-1">
					...
					<?php
						...
						if(is_array($result)){
							...
							foreach ($result as $row){
								...
								$result_respuesta = $ClsExa->get_clave_directa_curso($examen,$codigo);
								...
								if($tipo == 1){
									...
									$salida.='<div class="form-group">';
										$salida.='<label class="radio-inline">';
											$salida.='<input type="radio" name="radio'.$i.'" id="radioA'.$i.'" value="1" onclick = "xajax_Grabar_Clave(\''.$examen.'\',\''.$codigo.'\',1,this.value,\'\');" /> 1';
										$salida.='</label>';
										$salida.='<label class="radio-inline">';
									...
									$salida.='<div class="form-group">';
										$salida.='<label class="radio-inline">';
											$salida.='<input type="radio" name="radio'.$i.'" id="radioV'.$i.'" value="5" onclick = "xajax_Grabar_Clave(\''.$examen.'\',\''.$codigo.'\',2,this.value,\'\');" /> VERDADERO';
										$salida.='</label>';
										$salida.='<label class="radio-inline">';
											$salida.='<input type="radio" name="radio'.$i.'" id="radioF'.$i.'" value="1" onclick = "xajax_Grabar_Clave(\''.$examen.'\',\''.$codigo.'\',2,this.value,\'\');" /> FALSO';
										$salida.='</label>';
									$salida.='</div>';
									$salida.='<script>';
									if($elemento != ''){
