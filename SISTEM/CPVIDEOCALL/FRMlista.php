...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> Historial de Videoclases
				</div>
				<div class="panel-body" id="result">
					...
					<div class="tab-content">
						<div class="tab-pane fade active in" id="home">
							...
							<?php echo historial_videoclase($desde,$hasta,$usuario); ?>
						</div>
						<div class="tab-pane fade" id="profile">
							<h4>Videoclases desde app externa</h4>
							<?php echo historial_videoclase_otros($desde,$hasta,$usuario); ?>
						</div>
					</div>
				</div>
			</div>
    ...
    <script>
		$(document).ready(function() {
			$('#dataTables-kaltura').DataTable({
				pageLength: 50,
				responsive: true
			});

			$('#dataTables-otra').DataTable({
				pageLength: 50,
				responsive: true
			});
