	...
	if($tipo_usuario == 2){ //// MAESTRO
		...
		if(is_array($result_secciones)){
			foreach($result_secciones as $row){
				...
				$codigosInfo.= $ClsVid->get_codigos_secciones($pensum,$nivel,$grado,$seccion);
			}
		}
		...
		if(is_array($result)){
		   ...
		   foreach($result as $row){
			  ...
			  $codigosInfo.= $ClsVid->get_codigos_grupos($grupos);
		   }
		}
		...
		if(is_array($result)){
			foreach($result as $row){
				...
				$codigosInfo.= $ClsVid->get_codigos_secciones($pensum,$nivel,$grado,'');
			}
		}
...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="#"><i class="fa fa-paste"></i> Videoclase</a>
					</li>
					<li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                <p class="lead"><i class="fa fa-group-item"></i> Informaci&oacute;n de Videoclasees</p>
                <div class="list-group">
					<a href="../CPINFO/IFRMvideoclase.php" class="list-group-item active"><i class="fa fa-video-camera"></i> Informaci&oacute;n de Videoclasees</a>
                    <a href="../CPENCUESTAS/IFRMencuestas.php" class="list-group-item"><i class="fa fa-paste"></i> Encuestas</a>
				    <a href="../CPTAREAS/IFRMvideoclase.php" class="list-group-item"><i class="fa fa-paste"></i> Tareas</a>
            ...
            <div class="col-xs-9">
                <div class="well">
                    ...
                    <div class="text-right">
                        <a class="btn btn-success"><i class="fa fa-thumbs-up"></i> Videoclasees </a>
                    </div>

                    <?php
						//////////////////////////////////////// GENERAL ///////////////////////////////////////////
						$result = $ClsVid->get_videoclase($codigosInfo);
						if(is_array($result)){
							foreach($result as $row){
								$cod = $row["vid_codigo"];
								$usu = $_SESSION["codigo"];
								$hashkey = $ClsVid->encrypt($cod, $usu);
								$nombre = utf8_decode($row["vid_nombre"]);
								$tlink = trim($row["vid_link"]);
								...
								$salida.=' <div class="row">';
									$salida.='<div class="col-xs-12">';
										...
										$salida.='<div class="pull-right">';
											$salida.='<a href="ICSvideoclase.php?codigo='.$cod.'" target = "_blank" class="btn btn-default">';
												$salida.='<i class="fa fa-video-camera"></i>';
											$salida.='</a> ';
