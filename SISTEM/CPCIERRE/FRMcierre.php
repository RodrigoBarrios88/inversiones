<?php
	...
	//$_Post
	$suc = $_REQUEST["suc"];
	$tipo = ($_REQUEST["tipo"] != "")?$_REQUEST["tipo"]:"T";
	$pv = $_REQUEST["pv"];
	$caja = $_REQUEST["caja"];
...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="FRMcierre.php">
										<i class="fa fa-tasks"></i> Cierre Diario
									</a>
								</li>
								<hr>
								<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-tasks"></i>  Cierre de Operaciones Diarias</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						...
						<div class="col-xs-5"><label>Tipo de Unidades:</label></div>
					</div>
					<div class="row">
						...
						<div class="col-xs-5">
							<select class = "form-control" id = "tipo" name = "tipo" onchange="Submit();">
								...
								<option value = "C">CAJAS MONETARIAS</option>
								<option value = "P">PUNTOS DE VENTA</option>
					...
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1"><label>Cajas Monetarias:</label></div>
						<div class="col-xs-5"><label>Puntos de Venta:</label></div>
					</div>
					<div class="row">
						<div class="col-xs-5 col-xs-offset-1">
							<?php
								if($suc != "" && ($tipo == "C" || $tipo == "T")){
									echo caja_sucursal_html($suc,"caja","");
								}else{
									echo combos_vacios("caja");
								}
							?>
							<script type="text/javascript">
								document.getElementById("caja").value = "<?php echo $caja; ?>";
							</script>
						</div>	
						<div class="col-xs-5" id = "spv">
							<?php
								if($suc != "" && ($tipo == "P" || $tipo == "T")){
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            <a type="button" class="btn btn-default" href = "FRMcierre.php"><span class="glyphicon glyphicon-erase"></span> Limpiar</a> 
                            <button type="button" class="btn btn-primary" onclick = "Reporte();"><span class="glyphicon glyphicon-print"></span> Imprimir</button> 
                        </div>
                    </div>
					<br>
				</div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/finanzas/cierre.js"></script>
