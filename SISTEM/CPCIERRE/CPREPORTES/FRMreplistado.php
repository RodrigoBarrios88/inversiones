...
<body>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
								   <a href="FRMreplistado.php">
									   <i class="glyphicon glyphicon-print"></i> Reporte de &Aacute;reas
								   </a>
                                </li>
								<li>
									<a href="../../menu.php">
	...
	<form name = "f1" id = "f1" action="REPlista.php" method="post" target = "_blank">
		...
		<div class="panel-heading"><label>REPORTES DE &Aacute;REAS</label></div>
                    <div class="panel-body">
			<div class="row">
			    <div class="col-xs-12 col-xs-12 text-right"><label class = " text-info">* Campos de Busqueda</label></div>
			</div>
                        <div class="row">
                            <div class="col-xs-2 text-right"><label>Nombre (&Aacute;rea): </label>  <span class="text-info">*</span></div>
                            ...
                            <div class="col-xs-3 text-right"><label>A&ntilde;o: </label>  <span class="text-info">*</span></div>
                            <div class="col-xs-3"><input type = "text" class="form-control" name = "anio" id = "anio" onkeyup = "texto(this)" /></div>
                        </div>
                        <br>
                        <div class="row">
