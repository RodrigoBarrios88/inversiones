...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="../FRMsegmentos.php">
										<i class="fa fa-book"></i> Segmentos
									</a>
								</li>
								<li>
									<a href="FRMreplistado.php">
										<i class="glyphicon glyphicon-print"></i> Reporte de Segmentos
									</a>
								</li>
								<hr>
								<li>
		...
		<form name = "f1" id = "f1" action="REPlista.php" method="post" target = "_blank">
			...
			<div class="panel-heading"><label><i class="glyphicon glyphicon-print"></i> Reporte de Segmentos</label></div>
                    <div class="panel-body">
						<div class="row">
							<div class="col-xs-12 col-xs-12 text-right"><label class = " text-info">* Campos de Busqueda</label></div>
						</div>
                        <div class="row">
                            <div class="col-xs-2 text-right"><label>&Aacute;rea: </label>  <span class="text-info">*</span></div>
                            <div class="col-xs-3">
								<?php echo Area_html("area",""); ?>
							</div>
							<div class="col-xs-3 text-right"><label>Nombre (Segmento): </label>  <span class="text-info">*</span></div>
                            <div class="col-xs-3 text-left"><input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this)" /><input type = "hidden" name = "cod" id = "cod" /></div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <button type="button" class="btn btn-info" id = "busc" onclick = "ReporteLista();"><span class="glyphicon glyphicon-search"></span> Buscar</button>
		...
		<div class="container">
		      <img src = "../../../CONFIG/images/logo.png" width = "28px" >
		      <p>
    ...
    <script type="text/javascript" src="../../assets.3.6.2/js/modules/extracurri/segmentos.js"></script>
