<?php
	include_once('ajax_funct_segmentos.php');
	$id = $_SESSION["codigo"];
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-book"></i> Formulario Gestor de Segmentos</div>
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xs-5">
							<label>Nombre (Segmento): </label> <span class="text-danger">*</span>
