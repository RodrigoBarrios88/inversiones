...
?>
		<tr>
			...
			<td>
			<input type="text" class="form-control" id="nomhijo<?php echo $i; ?>" name="nomhijo<?php echo $i; ?>" onkeyup = "texto(this);">
			</td>
			<td>
			<input type="text" class="form-control" id="apehijo<?php echo $i; ?>" name="apehijo<?php echo $i; ?>" onkeyup = "texto(this);">
			</td>
			<td>
			<?php echo Paises_html("paishijo$i",""); ?>
			</td>
			<td>
			<input type="text" class="form-control" id="religionhijo<?php echo $i; ?>" name="religionhijo<?php echo $i; ?>" onkeyup = "texto(this);">
			</td>
			<td>
			<div class="input-group date" id="groupfecnachijo<?php echo $i; ?>">
				<input type="text" class="form-control" id = "fecnachijo<?php echo $i; ?>" name="fecnachijo<?php echo $i; ?>"  />
...
?>
		<tr>
			...
			<input type="date" class="form-control" id="fecnachijo1" name="fecnachijo1" title="Click para seleccionar la fecha" style="cursor:pointer" readonly >
