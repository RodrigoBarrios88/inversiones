    ...
    <div id="wrapper">
	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label>Planificador de Ingresos</label></div>
                    <div class="panel-body">
					<form id='f1' name='f1' action='FRMingresos.php' method='get'>
						<div class="row">
						...
						<div class="row">
                            ...
                            <div class="col-xs-5">
								<select class="form-control" name = "clase" id = "clase" onchange ="Submit();">
									...
									<option value = "I">INVENRSIONES</option>
						...
						<div class="col-lg-12" id = "result">
							<?php
								if($clase != "" && $suc != "" && $anio != "" && $mes != ""){
									echo tabla_reglones('','',"I",$clase,$suc,$anio,$mes);
								}
							?>
						</div>
					</div>
