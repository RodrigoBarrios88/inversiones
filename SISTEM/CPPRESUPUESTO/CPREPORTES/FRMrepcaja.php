    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Listado de Cajas </h3>
					<table>
						<tr>
						...
						<tr>
							...
							<td><?php echo Empresas_html(); ?><input type = "hidden" name = "cod" id = "cod" /></td>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<a class="button" href="FRMreppv.php" id = "limp" ><img src="../../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
