...
<body>
    <div id="wrapper">
		...
		<div class="panel-heading"><label>Listado y Busqueda de Monitores de Buses</label></div>
			...
			<div class="row">
			    <div class="col-xs-12 col-xs-12 text-right text-danger">* Campos Obligatorios</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2 text-right"><label>Apellido: </label> <span class="text-info">*</span></div>
                            <div class="col-xs-4"><input type = "text" class="form-control" name = "ape" id = "ape" onkeyup = "texto(this)" /></div>
                        </div>
                        <br>
                        <div class="row">
