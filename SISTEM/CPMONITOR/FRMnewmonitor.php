...
<body>
    <div id="wrapper">
		...
		<div class="panel-heading"><label>Formulario Gestor de Monitores de Buses</label></div>
                    <div class="panel-body" id = "formulario">
			<div class="row">
			    <div class="col-xs-12 col-xs-12 text-right text-danger">* Campos Obligatorios</div>
			</div>
			<div class="row">
				<div class="col-xs-2 text-right"><label>CUI:  </label> <span class="text-danger">*</span></div>
				<div class="col-xs-3"><input type = "text" class = "form-control" name = " cui" id = "cui"  value = "<?php echo $cui; ?>" onkeyup = "enteros(this)" maxlength = "15"/></div>	
			</div>
			<div class="row">
				<div class="col-xs-2 text-right"><label>Nombre:  </label><span class="text-danger">*</span></div>
				<div class="col-xs-3"><input type = "text" class = "form-control" name = "nom" id = "nom"  value = "<?php echo $nom; ?>" onkeyup = "texto(this)" /></div>	
				<div class="col-xs-2 text-right"><label>Apellido:  </label><span class="text-danger">*</span></div>
				<div class="col-xs-3"><input type = "text" class = "form-control" name = "ape" id = "ape" onkeyup = "texto(this)" /></div>	
			</div>
			<div class="row">
			</div>
			<div class="row">
				<div class="col-xs-2 text-right"><label>e-mail:  </label><span class="text-danger">*</span></div>
				<div class="col-xs-3"><input type = "text" class = "form-control text-libre" name = "mail" id = "mail" onkeyup = "texto(this)" /></div>	
				<div class="col-xs-2 text-right"><label>Telefono:  </label><span class="text-danger">*</span></div>
				<div class="col-xs-3"><input type = "text" class = "form-control" name = "tel" id = "tel" onkeyup = "texto(this)" /></div>	
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-12" id = "result">
					<?php echo tabla_monitores_buses($cod,$nom,$ape,$sit,1); ?>
				</div>
			</div>
            </div>
             <!-- /.panel-default -->
