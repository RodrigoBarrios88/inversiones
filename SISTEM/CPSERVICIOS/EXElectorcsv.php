<?php
	...
	$result = $ClsSer->get_grupo($grupo,"",1);
	if(is_array($result)){
		foreach($result as $row){
			$gru_desc = $row["gru_nombre"];
		}
	}
	$titulo = "LISTADO DE SERVICIOS A CARGAR EN BLOQUE DEL GRUPO $gru_desc";
?>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<div class="row">
        <div class="col-xs-3 col-xs-offset-3 text-center">
		 ...
		 <div class="col-xs-3 text-center">
			<a type="button" class="btn btn-default" href = "FRMservicios.php"><span class="fa fa-arrow-left"></span> Regresar</a>
		</div>
    </div>
	<div class="row">
...
if ($status != 1) {	
	...
	echo "<script type='text/javascript' >AlertasJs('$msj','window.location=\'FRMservicios.php\'');</script>";
	...
	$salida.= '<table class="table table-striped table-bordered table-hover">';
		...
		$salida.= '<th class = "text-center" width = "100px">NOMBRE DEL SERVICIO</th>';
		$salida.= '<th class = "text-center" width = "150px">DESCRIPCI&Oacute;N</th>';
		$salida.= '<th class = "text-center" width = "60px">PRECIO/COSTO</th>';
		$salida.= '<th class = "text-center" width = "60px">PRECIO/VENTA</th>';
		$salida.= '<th class = "text-center" width = "40px">MONEDA</th>';
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div id = "ModalDialog" class="modal-dialog">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary" onclick = "window.location='FRMservicios.php';" data-dismiss="modal"><span class="fa fa-check"></span> Aceptar</button>
		</div>
	      </div>
