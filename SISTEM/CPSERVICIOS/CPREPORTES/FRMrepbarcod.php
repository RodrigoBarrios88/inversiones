    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-barcode"></i> <label>Generar Codigos de Barra para Impresi&oacute;n</label></div>
					...
					<form id='f1' name='f1' method='get'>
                        ...
                        <div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Grupo:</label> <label class = " text-info">*</label></div>
							<div class="col-xs-5"><label>Cantidad:</label> <label class = " text-danger">*</label></div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-xs-offset-1">
								<?php echo grupo_serv_html("gru","Submit()"); ?>
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php
							if($gru != "" && $cant != ""){
								echo tabla_servicios_barcode($gru,$cant);
							}
						?>
					</div>
				</div>
