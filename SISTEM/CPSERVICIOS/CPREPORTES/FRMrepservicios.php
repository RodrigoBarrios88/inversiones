    ...
    <div id="main2" align = "center">
		<div id="cuerpo" align = "center">
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<h3 class="encabezado"> Listado de Servicios </h3>
					<table>
						<tr>
						...
						<tr>
							...
							<td><?php echo Grupo_Serv_html(); ?><input type = "hidden" name = "cod" id = "cod" /></td>
							<td class = "celda" align = "right">Cod. Interno: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "barc" id = "barc" onkeyup = "texto(this)" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteServicio(1)" ><img src="../../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "ReporteServicio(2)" ><img src="../../../CONFIG/images/icons/excel.png" class="icon" > Exportar</a>
