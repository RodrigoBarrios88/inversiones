    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-file-text-o"></i> <label>Catalogo de Servicios</label></div>
				...
				<div class="row">
					<div class="col-lg-12" id = "result">
						<?php
							echo tabla_catalogo_servicios($grup);
						?>
					</div>
				</div>
            </div>
        ...
        $(document).ready(function(){
            $('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Catalogo de Servicios'},
                    {extend: 'print',
