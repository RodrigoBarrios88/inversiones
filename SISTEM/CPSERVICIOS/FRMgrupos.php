...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-th"></i> Gestor de Grupos de Servicios</label></div>
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_grupo_servicios($cod,$nom,$sit);?>
						</div>
					</div>
            </div>
             <!-- /.panel-default -->
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/inventario/grupserv.js"></script>
