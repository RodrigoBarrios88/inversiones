    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-sign-out"></i> Retiro o Egreso Monetario a Puntos de Venta</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_punto_venta($cod,$suc,$nom,$sit,"ACR"); ?>
						</div>
					</div>
				</div>
            </div>
