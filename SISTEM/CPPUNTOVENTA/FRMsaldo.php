    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-money"></i> Saldo de Puntos de Venta</label></div>
                <div class="panel-body">
				<form id='f1' name='f1' method='get'>
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right text-danger">* Criterios de Busqueda</div>
					</div>
					<div class="row">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
                            <a type="button" class="btn btn-default" href = "FRMsaldo.php"><span class="glyphicon glyphicon-erase"></span> Limpiar</a>
                        </div>
                    </div>
					<br><br>
					<div class="row">
