    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-credit-card"></i> Formulario Gestor de Puntos de Venta</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_punto_venta($cod,$suc,$nom,$sit,"MOD"); ?>
						</div>
					</div>
				</div>
            </div>
