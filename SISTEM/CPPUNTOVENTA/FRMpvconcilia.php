<?php
	include_once('xajax_funct_pv.php');
	$id = $_SESSION["codigo"];
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label>Puntos de Venta (Movimientos de Caja)</label></div>
                <div class="panel-body" id = "formulario">
					...
					<div class="row">
                        <div class="col-xs-12 text-center">
							<a class="btn btn-default" href = "FRMpvconcilia.php" ><span class="glyphicon glyphicon-erase"></span> Limpiar</a>
				...
				<div class="row">
					<div class="col-lg-12">
						<?php
							if($cod != "" || ($suc != "" && $pv != "")){
								echo tabla_pv_movimiento($pv,$suc,$desde,$hasta);
							}
						?>
					</div>
				</div>
    ...
    <script type="text/javascript" src="../assets.3.6.2/js/modules/finanzas/movpv.js"></script>
