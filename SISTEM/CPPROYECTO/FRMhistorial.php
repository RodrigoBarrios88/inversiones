  ...
  <div id="contentarea2"> <a name="mainmenu" id="mainmenu"></a>
    ...
    <div id="main2" align = "center" style="width:835px;">
		<div id="cuerpo" align = "center">
			<h3 class="encabezado">Historial de Presupuestos </h3>
				<form name = "f1" name = "f1" method="post" target="_blank" enctype="multipart/form-data">
					<table>
						...
						<tr>
							...
							<td><input type = "text" class = "text" name = "fini" id = "fini" onclick="displayCalendar(this,'dd/mm/yyyy', this)" readonly /></td>
							<td class = "celda" align = "right">Hasta: <span class = "busca">*</span></td>
							<td><input type = "text" class = "text" name = "ffin" id = "ffin" onclick="displayCalendar(this,'dd/mm/yyyy', this)" readonly /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan = "4" align = "center">
								...
								<br>
								<a class="button" href="javascript:void(0)" id = "busc" onclick = "BuscarHist()" ><img src = "../../CONFIG/images/icons/search.png" class="icon" > Buscar</a>
								<a class="button" href="javascript:void(0)" id = "limp" onclick = "Limpiar2()" ><img src = "../../CONFIG/images/icons/refresh.png" class="icon" > Limpiar</a>
								</div>
							</td>
						</tr>
					</table>
