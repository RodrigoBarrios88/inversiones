<?php
	...
	$dpi = $ClsOtro->decrypt($hashkey, $usuario);
	$result = $ClsOtro->get_otros_usuarios($dpi);
	if(is_array($result)){
		foreach($result as $row){
			$dpi = $row["otro_cui"];
			$titulo = utf8_decode($row["otro_titulo"]);
			$nombre = utf8_decode($row["otro_nombre"]);
			$apellido = utf8_decode($row["otro_apellido"]);
			$mail = strtolower($row["otro_mail"]);
			$tel = $row["otro_telefono"];
		}
	}
	
	$ClsUsu = new ClsUsuario();
	$result = $ClsUsu->get_usuario_tipo_codigo(1,$dpi);
	if(is_array($result)){
		foreach($result as $row){
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a class="active" href="#">
										<i class="fa fa-list-alt"></i> Ficha Autoridades
									</a>
                                </li>
								<?php if($tipo_usuario == 1 || $tipo_usuario == 5){ ?>
								<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
				<div class="panel-heading"><label><i class="fa fa-list-alt"></i> Ficha del Usuario</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-lg-4 col-xs-12 text-center">
							 <div class="panel panel-default">
								<div class="panel-heading"><i class="fa fa-user"></i> <label>Fotograf&iacute;a</label></div>
								<div class="panel-body">
						...
						<div class="col-lg-8 col-xs-12 ext-center">
							<div class="panel panel-default">
								<div class="panel-heading"><i class="fa fa-file-text-o"></i> <label>Datos Generales</label></div>
								<div class="panel-body">
									<div class="row">
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="fa fa-book"></i> <label>Asignaciones de Grado</label>
				</div>
				<div class="panel-body">
					<?php echo tabla_usuario_grados($dpi); ?>
				</div>
			</div>
			<!-- /.panel-info -->
			<!-- .panel-info -->
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="fa fa-book"></i> <label>Asignaciones de Grupos</label>
				</div>
				<div class="panel-body">
					<?php echo tabla_usuario_grupos($dpi); ?>
				</div>
			</div>
			<!-- /.panel-info -->
			<!-- .panel-info -->
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="fa fa-book"></i> <label>Asignaciones a Cursos Libres</label>
				</div>
				<div class="panel-body">
					<?php echo tabla_usuario_cursos($dpi); ?>
				</div>
			</div>
			<!-- /.panel-info -->
        </div>
