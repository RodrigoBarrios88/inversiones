	    ...
	    <br>
         <div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-search"></i> Listado y Busqueda de Directores o Autoridades
				</div>
            <div class="panel-body">
					<div class="row">
						<div class="col-lg-12" id = "result">
							<?php echo tabla_otros_usuarios($cod,$nom,$ape,$sit,3); ?>
						</div>
					</div>
            </div>
            <!-- /.panel-body -->
        ...
        $(document).ready(function(){
            $('#dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Reporte de Autoridades'},
                    {extend: 'print',
