	    ...
	    <br>
            <div class="panel panel-default">
				<div class="panel-heading">
					<i class="glyphicon glyphicon-print"></i> Reporte y Listado de Directores y Autoridades
				</div>
                <div class="panel-body">
				<form name = "f1" id = "f1" action="REPlista.php" method="post" target = "_blank">
					<div class="row">
						<div class="col-xs-11 col-xs-11 text-right text-danger">* Campos Obligatorios</div>
					</div>
                    <div class="row">
                        <div class="col-xs-5 col-xs-offset-1"><label>Nombre: </label> <span class="text-info">*</span></div>
                        <div class="col-xs-5"><label>Apellido: </label> <span class="text-info">*</span></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-5 col-xs-offset-1"><input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this);" /></div>
                        <div class="col-xs-5"><input type = "text" class="form-control" name = "ape" id = "ape" onkeyup = "texto(this)" /></div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <button type="button" class="btn btn-default" id = "limp" onclick = "Limpiar();"><span class="fa fa-eraser"></span> Limpiar</button>
                            <button type="button" class="btn btn-primary" id = "busc" onclick = "Submit();"><span class="glyphicon glyphicon-search"></span> Buscar</button>
                        </div>
                    </div>
					<br>
				</form>
