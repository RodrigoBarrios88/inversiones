    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div id = "cuerpo" class="panel panel-default">
				<div class="panel-heading"><label>Reporte de Empresas</label></div>
                    <div class="panel-body">
						<div class="row">
							<div class="col-xs-12 col-xs-12 text-right"><label class = " text-info">* Campos de Busqueda</label></div>
						</div>
                       <div class="row">
							<div class="col-xs-5 col-xs-offset-1"><label>Nombre (Empresa o Entidad):</label> <span class="text-info">*</span></div>
							<div class="col-xs-5"><label>Nombre del Contacto:</label> <span class="text-info">*</span></div>
						</div>
						<div class="row">
							...
							<div class="col-xs-5">
								<input type = "text" class="form-control" name = "contact" id = "contact" onkeyup = "texto(this)" />
							</div>
						</div>
                        <br>
                        <div class="row">
