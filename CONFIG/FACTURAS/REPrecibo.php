<?php
   ...
   // $hashkey3 = $_REQUEST["hashkey3"];
	...
	// $referenciabol = $ClsBol ->decrypt($hashkey3, $usuario);
   ...
   $pdf->Cell(20,5,$serie.' '.Agrega_Ceros($numero),0,1,'');
   $pdf->SetTextColor(42,90,138); // azul
   ...
   $pdf->Output("Recibo No. $serie $numero.pdf","I");
   //$pdf->Output("Encuesta No. C$codigo-T$tipo.pdf","D");
