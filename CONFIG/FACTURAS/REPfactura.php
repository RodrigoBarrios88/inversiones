...
if(is_array($result)){
    foreach($result as $row){
      ...
      $pdf->Image('../images/logo.png' , 17 ,5, 25 , 25,'PNG', '');//logo
      ...
      $pdf->setXY(53,19);
      $pdf->MultiCell(60, 4, utf8_decode('Direccion de la organización'), 0 , 'L' , 0);
      $pdf->setXY(53,23);
      ...
      $pdf->setXY(110,15);
      $pdf->MultiCell(100, 5, utf8_decode('DOCUMENTO TRIBUTARIO ELECTRONICÓ'), 1 , 'C' , 1);
      $pdf->SetFont('Arial','',8);
      ...
      $pdf->setXY(130,20);
      $pdf->MultiCell(80, 5, $boleta, 1 , 'L' , 0);
      $pdf->setXY(130,25);
      $pdf->MultiCell(30, 5, '1', 1 , 'L' , 0);
      $pdf->setXY(130,30);
      $pdf->MultiCell(30, 5, $fecha, 1 , 'L' , 0);
      $pdf->setXY(160,25);
      $pdf->MultiCell(20, 5, utf8_decode('NÚMERO'), 1 , 'R' , 0);
      $pdf->setXY(160,30);
      ...
      if($situacion == 0){ 
			$pdf->Image("../images/anulada.jpg",90,150,40,40,"JPG");
		}
      ...
      $pdf->setXY(5,60);
      $pdf->MultiCell(35, 5, utf8_decode('DIERCCIÓN:'), 1 , 'L' , 1);
      $pdf->SetFont('Arial','',7);
      $pdf->setXY(40,50);
      ...
      $pdf->Ln(10);
      ////////////////////////////////////// ENCABEZADOS ///////////////////////////////////////////
      $pdf->SetWidths(array(20, 110, 25, 25, 25));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
      ...
      $pdf->Row(array('Cantidad', utf8_decode('Descripción'), 'Precio Unitario', 'Descuento','Total'));
      
      $pdf->SetWidths(array(20, 110, 25, 25, 25));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
      $pdf->SetAligns(array('C', 'L', 'R', 'R', 'R'));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
      ...
      //$result_detalle = $ClsVent->get_det_venta('',$CodVentas); 
        ...
        if(is_array($result_detalle)){
            ...
            $pdf->Ln(2);
            $pdf->SetWidths(array(102,103));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            $pdf->SetAligns(array('L', 'L'));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            ...
            $pdf->Ln(10);
            $pdf->SetWidths(array(205));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            $pdf->SetAligns(array('L'));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            $pdf->SetFont('Arial','B',8);  	// ASIGNO EL TIPO Y TAMAÑO DE LA LETRA
            $pdf->SetFillColor(255,255,255);
            $pdf->Row(array("Observaciones:",""),'',0,4); // AGREGO LOS DATOS A LA FILA, VIENE REPERESENTADO POR UN ARRAY
            
            $pdf->SetWidths(array(205));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            $pdf->SetAligns(array('J'));  // AQUÍ LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
            $pdf->SetFont('Arial','',6);  	// ASIGNO EL TIPO Y TAMAÑO DE LA LETRA
            $pdf->SetFillColor(255,255,255);
