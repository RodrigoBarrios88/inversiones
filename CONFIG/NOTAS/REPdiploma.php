...
include_once('html_fns_reportes.php');
	...
	//$_POST
	$cui = trim($_REQUEST["cui"]);
	
	$ClsAcad = new ClsAcademico();
	$result = $ClsAcad->get_seccion_alumno($pensum,'','','',$cui,'','',1);
	if(is_array($result)){
	...
	$pdf->Image('../images/diploma_fondo.jpg' , 0 , 0, 280 , 216,'JPG', '');
	
	///// LOGO ///////
	$pdf->Image('../images/replogo.jpg' , 117 ,5, 40 , 40,'JPG', '');
	...
	$pdf->SetXY(25,175);
	$pdf->Cell(69,8,'Direcci�n General','T','','C',false);
	$pdf->SetXY(185,175);
	$pdf->Cell(69,8,'Direcci�n '.$nivel,'T','','C',false);
