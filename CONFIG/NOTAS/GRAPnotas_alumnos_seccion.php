...
<head>
	...
	<!-- Bootstrap Core CSS -->
    <link href="../../css.3.6.2/formulario.css" rel="stylesheet">
    ...
    <!-- c3 Charts -->
    <link href="../../css.3.6.2/plugins/c3/c3.min.css" rel="stylesheet">
...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			Estad&iacute;sticas de Alumnos con Materias Aprobadas y Reprobadas por Secci&oacute;n
		</div>
		<div class="panel-body">
			<div class = "row">
				<div class = "col-xs-10 col-xs-offset-1">
					<div class = "row">
						<h5 class="text-center"> Listado de Alumnos </h5>
						<hr>
						<?php
							$json = "";
							...
							if(is_array($result)){
								...
								foreach($result as $row){
									...
									for($z = 1; $z <= $mat_count; $z++){
										...
										$result = $ClsNot->get_notas_alumno_tarjeta($alumno,$pensum,$nivel,$grado,$seccion,$materia_codigo[$z],$num);
										if(is_array($result)){
											$total = 0;
											foreach($result as $row){
												$zona = $row["not_zona"];
									...
									//--
									echo '<div class = "col-xs-4 text-left"><strong>'.$i.'.</strong> '.$alumno_nombre.'</div>';
									$i++;
								}
							}
							//// limpia la cadena
							...
							$arrpendientes = substr($arrpendientes,0,-1);
						?>
					</div>
				</div>
			</div>
	...
	<!-- d3 and c3 charts -->
    <script src="../../js.3.6.2/plugins/d3/d3.min.js"></script>
    <script src="../../js.3.6.2/plugins/c3/c3.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="../../dist/js/sb-admin-2.js"></script>
    
    <!-- Custom Theme JavaScript -->
    <script type="text/javascript" src="../../js.3.6.2/modules/academico/notas.js"></script>
    <script type="text/javascript" src="../../js.3.6.2/core/util.js"></script>
    ...
    <script>
		$(document).ready(function () {
			c3.generate({
                ...
                data:{
                    columns: [
                        ['aprobadas', <?php echo $arraprobadas; ?>],
                        ['reprobadas', <?php echo $arrreprobadas; ?>],
						['pendientes', <?php echo $arrpendientes; ?>]
                    ],
                    colors:{
                        aprobadas: '#2A79AA',
						reprobadas: '#A82A2A',
