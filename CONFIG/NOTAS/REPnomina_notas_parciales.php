...
include_once('html_fns_reportes.php');
	...
	if(is_array($result)){
		foreach($result as $row){
			$pensum_desc = utf8_decode($row["pen_descripcion"]);
	...
	$titulo = utf8_decode("Informe de Notas para $grado_desc Sección $seccion_desc");
	//--
	//--- logo
	$x = 0;
	$y = 0;
	...
	$pdf->Image('../images/replogo.jpg' , $x ,$y, $w , $h,'JPG', '');
	//$pdf->Rect($x ,$y, $w , $h);
	...
	$pdf->Output('Notas Parciales.pdf','I');
