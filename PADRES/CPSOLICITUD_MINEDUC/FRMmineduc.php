				...
				<div class="container">
					...
					if (is_array($resultado)) {
						foreach ($resultado as $row) {
							$arr_cui = $row["alu_cui"];
							$result = $ClsAcad->get_grado_alumno($pensum, '', '', $arr_cui, '', 1);
							if (is_array($result)) {
									...
									<div class="col-xs-12 ">
										<div class="row">
											<ul class="nav nav-list">
												<?php if ($info_nivel == 1 && $info_grado == 2) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 1 && $info_grado == 3) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 2 && $info_grado == 2) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 2 && $info_grado == 3) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 2 && $info_grado == 4) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 2 && $info_grado == 5) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 3 && $info_grado == 2) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 3 && $info_grado == 3) { ?>
												...
												<?php } ?>
												<?php if ($info_nivel == 4 && $info_grado == 2) { ?>
													<li><i class="fa fas fa-folder"></i>&nbsp;<label class="tree-toggler nav-header glyphicon glyphicon-folder-close"> CUARTO BACHILLERATO</label>
														<ul class="nav nav-list tree" style="display: none;">
															<div class="col-xs-12 ">
																...
																<?php if ($info_nivel == 4 && $info_grado == 3) { ?>
