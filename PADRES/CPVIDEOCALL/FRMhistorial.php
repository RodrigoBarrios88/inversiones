<?php
	...
	if(is_array($result_secciones)){
		foreach($result_secciones as $row){
			...
			$codigosVideo.= ($codigo != "")?$codigo.',':'';
			$nombre_grupo = "N".$nivel."G".$grado."S".$seccion; //FILTRO DE CLASES
		}
	}
		...
		<div class="panel" style ="margin: 5px">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h5><i class="fas fa-video"></i> Video Clases de <?php echo $nombres; ?></label></h5>
				</div>
				<div class="panel-body">
					<div class = "row">
						...
						<div class="col-md-4 text-right">
							<a class="btn btn-default" href="FRMvideoclases.php?hashkey=<?php echo $hashkey; ?>"><i class="fa fa-video-camera"></i> Video Clases Activas</a>
						</div>
					</div>
					<br>
					<div class = "row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a href="#home" data-toggle="tab" aria-expanded="true">ASMS Videoclases</a></li>
								<li class=""><a href="#profile" data-toggle="tab" aria-expanded="false">Videoclases desde app externa</a></li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
								<div class="tab-pane fade active in" id="home">
									<br>
									<h4>ASMS Videoclases</h4>
									<br>
									<?php echo historial_videoclase($desde,$hasta,$nombre_grupo); ?>
								</div>
								<div class="tab-pane fade" id="profile">
									<br>
									<h4>Videoclases desde app externa</h4>
									<br>
									<?php echo historial_videoclase_otros($codigosVideo); ?>
								</div>
							</div>
						</div>
					</div>
