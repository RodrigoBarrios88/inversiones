...
class ClsInventario extends ClsConex{
...
/* Clase C = COMPRA, P = PRODUCCIÓN, D = DONACIÓN, V = VENTA, D2 = DESCARGA POR DESECHO */
    function get_inventario($cod,$tipo = '',$clase = '',$doc = '',$suc = '',$quien = '',$fini = '',$ffin = '',$sit = '') {
        ...
        $sql= "SELECT * ";
		$sql.= " FROM inv_inventario,mast_sucursal";
	...
	function insert_inventario($cod,$tipo,$clase,$doc,$suc,$fec,$sit) {
		...
		$usu = $_SESSION["codigo"];
		//--
		$sql = "INSERT INTO inv_inventario (inv_codigo,inv_tipo,inv_clase,inv_documento,inv_sucursal,inv_quien,inv_fechor,inv_situacion)";
	...
	function devuelve_producto_inventario($cod,$tipo,$sit){
	    ...
	    $sql.= " FROM inv_inventario,inv_det_inventario";
   ...
   //---------- Detalle de Inventario ---------//
    function get_det_inventario($cod,$inv,$tipo,$grup = '',$art = '',$lote = '',$suc = '',$clase = '',$doc = '',$fini = '',$ffin = '',$sit = ''){
        ...
        $sql= "SELECT * ";
		$sql.= " FROM inv_inventario, inv_det_inventario, inv_lote, inv_articulo, inv_grupo_articulos, inv_unidad_medida, fin_proveedor";
		$sql.= " WHERE det_inventario = inv_codigo";
	...
	function get_det_inventario_kardex($art = '',$grup = '',$suc = ''){
        ...
        $sql= "SELECT * ";
		$sql.= " FROM inv_inventario, inv_det_inventario, inv_lote, inv_articulo, inv_grupo_articulos, inv_unidad_medida, fin_proveedor, fin_moneda, mast_sucursal";
		$sql.= " WHERE det_inventario = inv_codigo";
		$sql.= " AND det_tipo = inv_tipo";
		$sql.= " AND art_grupo = gru_codigo";
		$sql.= " AND lot_grupo = art_grupo";
	...
	function insert_det_inventario($cod,$inv,$tipo,$grup,$art,$lote,$cant){
		...
		$sql = "INSERT INTO inv_det_inventario (det_codigo,det_inventario,det_tipo,det_grupo,det_articulo,det_lote,det_cantidad)";
    ...
    function get_costo($cod,$lot = '',$art = '',$gru = '',$comp = '',$mon = '',$sit = ''){
        ...
        $sql= "SELECT * ";
		$sql.= " FROM inv_costos, inv_lote, inv_articulo, inv_grupo_articulos, fin_moneda, comp_compra, comp_det_compra";
	...
	function get_lote_tcambio($art,$gru) {
		...
		$sql.= " FROM inv_articulo,fin_moneda";
