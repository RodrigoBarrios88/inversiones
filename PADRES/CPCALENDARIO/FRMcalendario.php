<?php
	include_once('html_fns_calendario.php');
...
<body>
        ...
        <div id="pad-wrapper">
                <div class="row calendar-wrapper">
                    <div class="col-md-12">
						...
						<?php $json = json_calendario($codigos); ?>
    ...
    <script src='../assets.3.5.20/js/fullcalendar.min.js'></script>
    ...
    <script type="text/javascript" src="../assets.3.5.20/js/modules/calendario/calendario.js"></script>
