//funciones javascript y validaciones
	...
	function Responder(pregunta,tipo,ponderacion,texto){
		...
		if(examen !=="" && pregunta !=="" && alumno !==""){
			xajax_Grabar_Respuesta_Cursos(examen,pregunta,alumno,tipo,ponderacion,texto,feclimit);	
		}
	}
	...
	function FinalizarExamen(){
		...
		if(examen !=="" && alumno !=="" && feclimit !==""){
			...
			loadingBtn(boton);
			xajax_Finalizar_Examen_Cursos(examen,alumno,feclimit);	
		}
	}
...
//////////////// ARCHIVOS RESPUESTA DEL EXAMEN //////////////////////
	...
	function Eliminar_Archivo(codigo,examen,alumno,archivo){
		swal({
			...
			switch (value) {
				case true:
					xajax_Delete_Archivo_Cursos(codigo,examen,alumno,archivo);
					break;
				default:
				  return;
			}
