				...
				<div class="col-lg-10 col-md-offset-1">
					...
					<div class="panel panel-default">
						<div class="panel-heading"> 
							...
							Tablero de Notificaciones (Reporte de Pa&ntilde;al)
						</div>
						<div class="panel-body">
						<?php
							if($pensum != ""){
								$ClsPan = new ClsPanial();
								$result = $ClsPan->get_panial('',$pensum,$info_nivel,$info_grado,$info_seccion,$arr_cui,'','');
								if(is_array($result)){
						?>
							<ul class="notes">
								<?php
