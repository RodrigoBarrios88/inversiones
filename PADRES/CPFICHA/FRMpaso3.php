							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila1"><a href="FRMpaso3.php?hashkey=<?php echo $hashkey; ?>" ><label>3. Parto</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1">
													<h5 class="alert alert-info">
														<i class="fas fa-hospital"></i> &nbsp;  Parto
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Tipo de Parto</label> <span class = "text-danger">*</span><br>
													<select class="form-control" id = "tipo" name = "tipo" >
														<option value = "">Seleccione</option>
														<option value = "N">Normal</option>
														<option value = "C">Ces&eacute;rea</option>
													</select>
													<script>
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Con anestesia?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "anestesiasi" name = "anestesia" /><label for="anestesiasi" id = "lanestesiasi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "anestesiano" name = "anestesia" /><label for="anestesiano" id = "lanestesiano" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $anestesia; ?>');
														if(sino == 1){
															document.getElementById("anestesiasi").checked = true;
														}else{
															document.getElementById("anestesiano").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Inducido?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "inducidosi" name = "inducido" /><label for="inducidosi" id = "linducidosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "inducidono" name = "inducido" /><label for="inducidono" id = "linducidono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $inducido; ?>');
														if(sino == 1){
															document.getElementById("inducidosi").checked = true;
														}else{
															document.getElementById("inducidono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Con f&oacute;rceps?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "forcepssi" name = "forceps" /><label for="forcepssi" id = "lforcepssi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "forcepsno" name = "forceps" /><label for="forcepsno" id = "lforcepsno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $forceps; ?>');
														if(sino == 1){
															document.getElementById("forcepssi").checked = true;
														}else{
															document.getElementById("forcepsno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Otra m&eacute;todo?</label> <br>
											...
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso2.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso3();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
