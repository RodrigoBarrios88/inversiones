										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o duerme tranquilamente?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "duermesi" name = "duerme" /><label for="duermesi" id = "lduermesi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "duermeno" name = "duerme" /><label for="duermeno" id = "lduermeno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $duerme; ?>');
														if(sino == 1){
															document.getElementById("duermesi").checked = true;
														}else{
															document.getElementById("duermeno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Se despierta con frecuencia?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "despiertasi" name = "despierta" /><label for="despiertasi" id = "ldespiertasi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "despiertano" name = "despierta" /><label for="despiertano" id = "ldespiertano" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $despierta; ?>');
														if(sino == 1){
															document.getElementById("despiertasi").checked = true;
														}else{
															document.getElementById("despiertano").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o padece de terror nocturno?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "terrorsi" name = "terror" /><label for="terrorsi" id = "lterrorsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "terrorno" name = "terror" /><label for="terrorno" id = "lterrorno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $terror; ?>');
														if(sino == 1){
															document.getElementById("terrorsi").checked = true;
														}else{
															document.getElementById("terrorno").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o padece de insomnio?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "insomniosi" name = "insomnio" /><label for="insomniosi" id = "linsomniosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "insomniono" name = "insomnio" /><label for="insomniono" id = "linsomniono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $insomnio; ?>');
														if(sino == 1){
															document.getElementById("insomniosi").checked = true;
														}else{
															document.getElementById("insomniono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o padece de crujir los dientes?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "crujidosi" name = "crujido" /><label for="crujidosi" id = "lcrujidosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "crujidono" name = "crujido" /><label for="crujidono" id = "lcrujidono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $crujido; ?>');
														if(sino == 1){
															document.getElementById("crujidosi").checked = true;
														}else{
															document.getElementById("crujidono").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Cuantas horas duerme en la noche? (cantidad de horas)</label> <span class = "text-danger">*</span> <br>
													<input class="form-control text-libre" type="text" id = "horas" name = "horas" value="<?php echo $horas; ?>" onkeyup="enteros(this);" maxlength = "2" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">El ni&ntilde;o duerme acompa&ntilde;ado &iquest;con quien?</label> <span class = "text-danger">*</span><br>
													<select class="form-control" id = "duermecon" name = "duermecon" >
														<option value = "">Seleccione</option>
														<option value = "Solo">Duerme Solo</option>
													...
													<script>
														document.getElementById("duermecon").value = '<?php echo $duerme_con; ?>';
													</script>
												</div>
											</div>
											<hr>
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso6.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso7();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
