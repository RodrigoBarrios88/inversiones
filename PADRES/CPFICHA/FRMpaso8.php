							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila2"><a href="FRMpaso8.php?hashkey=<?php echo $hashkey; ?>" ><label>8. Alimentaci&oacute;n</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1">
													<h5 class="alert alert-info">
														<i class="fas fa-utensils"></i> &nbsp; Alimentaci&oacute;n
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come solo?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "solosi" name = "solo" /><label for="solosi" id = "lsolosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "solono" name = "solo" /><label for="solono" id = "lsolono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $solo; ?>');
														if(sino == 1){
															document.getElementById("solosi").checked = true;
														}else{
															document.getElementById("solono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come en exceso?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "excesosi" name = "exceso" /><label for="excesosi" id = "lexcesosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "excesono" name = "exceso" /><label for="excesono" id = "lexcesono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $exceso; ?>');
														if(sino == 1){
															document.getElementById("excesosi").checked = true;
														}else{
															document.getElementById("excesono").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o come poco?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "pocosi" name = "poco" /><label for="pocosi" id = "lpocosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "pocono" name = "poco" /><label for="pocono" id = "lpocono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $poco; ?>');
														if(sino == 1){
															document.getElementById("pocosi").checked = true;
														}else{
															document.getElementById("pocono").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Al ni&ntilde;o lo obligan a comer?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "obligadosi" name = "obligado" /><label for="obligadosi" id = "lobligadosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "obligadono" name = "obligado" /><label for="obligadono" id = "lobligadono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $obligado; ?>');
														if(sino == 1){
															document.getElementById("obligadosi").checked = true;
														}else{
															document.getElementById("obligadono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o le exigen h&aacute;bitos en la mesa?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "habitossi" name = "habitos" /><label for="habitossi" id = "lhabitossi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "habitosno" name = "habitos" /><label for="habitosno" id = "lhabitosno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $habitos; ?>');
														if(sino == 1){
															document.getElementById("habitossi").checked = true;
														}else{
															document.getElementById("habitosno").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Peso (en libras): </label> <span class = "text-danger">*</span> <br>
													<input class="form-control text-libre" type="text" id = "talla" name = "talla" value="<?php echo $talla; ?>" onkeyup="decimales(this);" maxlength = "6" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Talla (en metros):</label> <span class = "text-danger">*</span> <br>
													<input class="form-control text-libre" type="text" id = "peso" name = "peso" value="<?php echo $peso; ?>" onkeyup="decimales(this);" maxlength = "6" />
												</div>
											</div>
											<hr>
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso7.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso8();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
