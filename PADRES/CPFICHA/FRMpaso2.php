							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila1"><a href="FRMpaso2.php?hashkey=<?php echo $hashkey; ?>" ><label>2. Embarazo</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Fue planificado?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "planificadosi" name = "planificado" /><label for="planificadosi" id = "lplanificadosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "planificadono" name = "planificado" /><label for="planificadono" id = "lplanificadono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $planificado; ?>');
														if(sino == 1){
															document.getElementById("planificadosi").checked = true;
														}else{
															document.getElementById("planificadono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Respecto a la duraci&oacute;n</label> <span class = "text-danger">*</span><br>
													<select class="form-control" id = "duracion" name = "duracion" >
														<option value = "">Seleccione</option>
														<option value = "Normal">Normal</option>
														<option value = "Prematuro">Prematuro</option>
														<option value = "Postmaturo">Postmaturo</option>
													</select>
													<script>
														document.getElementById("duracion").value = '<?php echo $duracion; ?>';
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tuvo complicaciones durante el embarazo?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "complicacionessi" name = "complicaciones" /><label for="complicacionessi" id = "lcomplicacionessi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "complicacionesno" name = "complicaciones" /><label for="complicacionesno" id = "lcomplicacionesno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $complicaciones; ?>');
														if(sino == 1){
															document.getElementById("complicacionessi").checked = true;
														}else{
															document.getElementById("complicacionesno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Tipo de complicaciones</label> <br>
													<select class="form-control" id = "tipocomplicaciones" name = "tipocomplicaciones" >
														<option value = "">Ninguna</option>
														<option value = "Rubeola">Rubeola</option>
														<option value = "Varicela">Varicela</option>
														<option value = "Sarampión">Sarampi&oacute;n</option>
														<option value = "Otros">Otros</option>
													</select>
													<script>
														document.getElementById("tipocomplicaciones").value = '<?php echo $tipo_complicaciones; ?>';
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tomaron radiograf&iacute;as o rayos "X"?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "rayosxsi" name = "rayosx" /><label for="rayosxsi" id = "lrayosxsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "rayosxno" name = "rayosx" /><label for="rayosxno" id = "lrayosxno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $rayos_x; ?>');
														if(sino == 1){
															document.getElementById("rayosxsi").checked = true;
														}else{
															document.getElementById("rayosxno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Sufri&oacute; depresi&oacute;n o exceso de tensi&oacute;n?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "depresionsi" name = "depresion" /><label for="depresionsi" id = "ldepresionsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "depresionno" name = "depresion" /><label for="depresionno" id = "ldepresionno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $depresion; ?>');
														if(sino == 1){
															document.getElementById("depresionsi").checked = true;
														}else{
															document.getElementById("depresionno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Otra Afecci&oacute;n?</label> <br>
													<input class="form-control text-libre" type="text" id = "otros" name = "otros" value="<?php echo $otros; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<hr>
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso1.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso2();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
