<?php
	...
	$ClsFic = new ClsFicha();
	$result = $ClsFic->get_conducta_caracter($cui);
	if(is_array($result)){
		foreach($result as $row){
			$actualizo = utf8_decode($row["con_fecha_actualiza"]);
		}	
	}
							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila2"><a href="FRMpaso11.php?hashkey=<?php echo $hashkey; ?>" ><label>11. Caracter</label></a></li>
									</ul>
									<!-- TABS -->
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1">
													<h5 class="alert alert-info">
														<i class="fa fa-child"></i> &nbsp; Caracter
											...
											<div class = "row">
												...
												<?php
													...
													$cols = 1;
													if(is_array($result)){
														$salida.= '<table class="table table-checks">';
														foreach($result as $row){
															...
															$salida.= '<td class = "table-checks-td text-left">';
															$salida.= '<input type="checkbox" name="chk'.$i.'" id="chk'.$i.'" value="'.$caracter.'" '.$conducta.'> <label>'.$caracter_desc.'</label> &nbsp; ';
															$salida.= '</td>';
															$i++;
															$cols++;
															if($cols > 2){
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1 text-right text-info">
													<label>* Seleccione las correspondientes</label>
											...
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso10.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow success" onclick = "Paso11();" ><i class="fa fa-save"></i> Guardar y Finalizar <i class="fa fa-check-square-o"></i></button>
												</div>
											</div>
										</div>	
									</div>
