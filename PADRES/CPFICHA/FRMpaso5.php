							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila1"><a href="FRMpaso5.php?hashkey=<?php echo $hashkey; ?>" ><label>5. Desarrollo Motor</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1">
													<h5 class="alert alert-info">
														<i class="fa fa-cogs"></i> &nbsp;  Desarrollo Motor
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad mantuvo firme la cabeza? (meses)</label> <br>
													<input class="form-control text-libre" type="text" id = "cabeza" name = "cabeza" value="<?php echo $cabeza; ?>" onkeyup="enteros(this);" maxlength = "2" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad se sent&oacute; sin apoyo? (meses)</label> <br>
													<input class="form-control text-libre" type="text" id = "sento" name = "sento" value="<?php echo $sento; ?>" onkeyup="enteros(this);" maxlength = "2" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;A que edad camin&oacute;? (meses)</label> <br>
													<input class="form-control text-libre" type="text" id = "camino" name = "camino" value="<?php echo $camino; ?>" onkeyup="enteros(this);" maxlength = "2" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o gateo?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "gateosi" name = "gateo" /><label for="gateosi" id = "lgateosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "gateono" name = "gateo" /><label for="gateono" id = "lgateono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $gateo; ?>');
														if(sino == 1){
															document.getElementById("gateosi").checked = true;
														}else{
															document.getElementById("gateono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Manifest&oacute; balance&oacute; corporal con frecuencia?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "balanceosi" name = "balanceo" /><label for="balanceosi" id = "lbalanceosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "balanceono" name = "balanceo" /><label for="balanceono" id = "lbalanceono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $balanceo; ?>');
														if(sino == 1){
															document.getElementById("balanceosi").checked = true;
														}else{
															document.getElementById("balanceono").checked = true;
														}
													</script>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o babe&oacute; con exceso?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "babeosi" name = "babeo" /><label for="babeosi" id = "lbabeosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "babeono" name = "babeo" /><label for="babeono" id = "lbabeono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $babeo; ?>');
														if(sino == 1){
															document.getElementById("babeosi").checked = true;
														}else{
															document.getElementById("babeono").checked = true;
														}
													</script>
												</div>
											</div>
											...
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso4.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso5();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
