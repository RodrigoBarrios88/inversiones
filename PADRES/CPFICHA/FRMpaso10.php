							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila2"><a href="FRMpaso10.php?hashkey=<?php echo $hashkey; ?>" ><label>10. O&iacute;do</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-md-offset-1">
													<h5 class="alert alert-info">
														<i class="fa fa-music"></i> &nbsp; O&iacute;do
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Afecciones y padecimientos del o&iacute;do?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "afeccionessi" name = "afecciones" /><label for="afeccionessi" id = "lafeccionessi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "afeccionesno" name = "afecciones" /><label for="afeccionesno" id = "lafeccionesno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $afecciones; ?>');
														if(sino == 1){
															document.getElementById("afeccionessi").checked = true;
														}else{
															document.getElementById("afeccionesno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Cuales? especifique</label> <br>
													<input class="form-control text-libre" type="text" id = "cuales" name = "cuales" value="<?php echo $cuales; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Hace esfuerzos para escuchar?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "esfuerzosi" name = "esfuerzo" /><label for="esfuerzosi" id = "lesfuerzosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "esfuerzono" name = "esfuerzo" /><label for="esfuerzono" id = "lesfuerzono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $esfuerzo; ?>');
														if(sino == 1){
															document.getElementById("esfuerzosi").checked = true;
														}else{
															document.getElementById("esfuerzono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Responde cuando no esta viendo a la persona?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "respondesi" name = "responde" /><label for="respondesi" id = "lrespondesi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "respondeno" name = "responde" /><label for="respondeno" id = "lrespondeno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $responde; ?>');
														if(sino == 1){
															document.getElementById("respondesi").checked = true;
														}else{
															document.getElementById("respondeno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Manifiesta frecuentemente no haber escuchado una orden o instrucci&oacute;n?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "escuchasi" name = "escucha" /><label for="escuchasi" id = "lescuchasi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "escuchano" name = "escucha" /><label for="escuchano" id = "lescuchano" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $no_escucha; ?>');
														if(sino == 1){
															document.getElementById("escuchasi").checked = true;
														}else{
															document.getElementById("escuchano").checked = true;
														}
											...
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso9.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso10();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
