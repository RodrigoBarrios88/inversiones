							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila2"><a href="FRMpaso9.php?hashkey=<?php echo $hashkey; ?>" ><label>9. Vista</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;El ni&ntilde;o usa lentes?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "lentessi" name = "lentes" /><label for="lentessi" id = "llentessi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "lentesno" name = "lentes" /><label for="lentesno" id = "llentesno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $lentes; ?>');
														if(sino == 1){
															document.getElementById("lentessi").checked = true;
														}else{
															document.getElementById("lentesno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">Si usa, &iquest;para que los usa?</label> <br>
													<select class="form-control" id = "uso" name = "uso" >
														<option value = "No usa">No Usa</option>
														<option value = "Fijos">Fijos</option>
														<option value = "Solo para leer">Solo para leer</option>
													</select>
													<script>
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padece de ojos irritados?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "irritacionsi" name = "irritacion" /><label for="irritacionsi" id = "lirritacionsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "irritacionno" name = "irritacion" /><label for="irritacionno" id = "lirritacionno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $irritacion; ?>');
														if(sino == 1){
															document.getElementById("irritacionsi").checked = true;
														}else{
															document.getElementById("irritacionno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Secreci&oacute;n en los ojos?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "secrecionsi" name = "secrecion" /><label for="secrecionsi" id = "lsecrecionsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "secrecionno" name = "secrecion" /><label for="secrecionno" id = "lsecrecionno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $rayos_x; ?>');
														if(sino == 1){
															document.getElementById("secrecionsi").checked = true;
														}else{
															document.getElementById("secrecionno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Se acerca demasiado al papel?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "acercasi" name = "acerca" /><label for="acercasi" id = "lacercasi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "acercano" name = "acerca" /><label for="acercano" id = "lacercano" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $acerca; ?>');
														if(sino == 1){
															document.getElementById("acercasi").checked = true;
														}else{
															document.getElementById("acercano").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padece de dolor de cabeza?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "dolorsi" name = "dolor" /><label for="dolorsi" id = "ldolorsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "dolorno" name = "dolor" /><label for="dolorno" id = "ldolorno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $dolor; ?>');
														if(sino == 1){
															document.getElementById("dolorsi").checked = true;
														}else{
															document.getElementById("dolorno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Desviaciones oculares?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "desviacionsi" name = "desviacion" /><label for="desviacionsi" id = "ldesviacionsi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "desviacionno" name = "desviacion" /><label for="desviacionno" id = "ldesviacionno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $desviacion; ?>');
														if(sino == 1){
															document.getElementById("desviacionsi").checked = true;
														}else{
															document.getElementById("desviacionno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Otras afecciones?</label> <br>
													<input class="form-control text-libre" type="text" id = "otro" name = "otro" value="<?php echo $otro; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<hr>
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso8.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso9();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
