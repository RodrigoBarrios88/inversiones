							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li class="active fila1"><a href="FRMpaso4.php?hashkey=<?php echo $hashkey; ?>" ><label>4. Lactancia</label></a></li>
										...
										<div role="tabpanel" class="tab-pane active col-md-10 col-md-offset-1" id="unidades">
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tom&oacute; pecho?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "pechosi" name = "pecho" /><label for="pechosi" id = "lpechosi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "pechono" name = "pecho" /><label for="pechono" id = "lpechono" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $pecho; ?>');
														if(sino == 1){
															document.getElementById("pechosi").checked = true;
														}else{
															document.getElementById("pechono").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Tom&oacute; biber&oacute;n o pacha?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "pachasi" name = "pacha" /><label for="pachasi" id = "lpachasi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "pachano" name = "pacha" /><label for="pachano" id = "lpachano" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $pacha; ?>');
														if(sino == 1){
															document.getElementById("pachasi").checked = true;
														}else{
															document.getElementById("pachano").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padeci&oacute; de v&oacute;mitos?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "vomitossi" name = "vomitos" /><label for="vomitossi" id = "lvomitossi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "vomitosno" name = "vomitos" /><label for="vomitosno" id = "lvomitosno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $vomitos; ?>');
														if(sino == 1){
															document.getElementById("vomitossi").checked = true;
														}else{
															document.getElementById("vomitosno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-lg-10 col-lg-offset-1 col-xs-12">
													<label class = "etiqueta">&iquest;Padeci&oacute; de c&oacute;licos?</label> <span class = "text-danger">*</span><br>
													&nbsp; <label><input type="radio" id = "colicossi" name = "colicos" /><label for="colicossi" id = "lcolicossi" > Si</label></label>
													&nbsp; <label><input type="radio" id = "colicosno" name = "colicos" /><label for="colicosno" id = "lcolicosno" > No</label></label>
													<script>
														var sino = parseInt('<?php echo $colicos; ?>');
														if(sino == 1){
															document.getElementById("colicossi").checked = true;
														}else{
															document.getElementById("colicosno").checked = true;
														}
											...
											<div class = "row">
												<div class="col-md-12 text-center">
													<a  href="FRMpaso3.php?hashkey=<?php echo $hashkey; ?>" class="btn-glow default" ><i class="fa fa-arrow-left"></i> Atras (Paso Anterior)</a> 
													<button class="btn-glow primary" onclick = "Paso4();" ><i class="fa fa-save"></i> Guardar y Siguiente <i class="fa fa-arrow-right"></i></button>
												</div>
											</div>
										</div>	
									</div>
