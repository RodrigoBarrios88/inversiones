		...
		foreach($result as $row){
			...
			if(strlen($cliente)>0){
				...
				if(is_array($result)){
                    foreach($result as $row){
                        //$cliente = $row["cli_id"];
                        $_REQUEST["nit$i"] = $row["cli_nit"];
                        $_REQUEST["cliente$i"] = utf8_decode($row["cli_nombre"]);
                    }
				}
			}		
				...
				<div class="row-fluid">
                    <div class="span12">
                                ...
                                <div class="">
									...
									<div class="panel panel-default">
										<div class="panel-heading"> 
											<h5><span class="fa fa-ambulance" aria-hidden="true"></span> Informaci&oacute;n de Seguro</h5>
										</div>
										<div class="panel-body">
											...
											<hr>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>El ni&ntilde;o(a) tiene seguro?</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													&nbsp; <label><input type="radio" id = "segurosi<?php echo $i; ?>" name = "seguro<?php echo $i; ?>" /><label for="segurosi<?php echo $i; ?>" id = "labelsi<?php echo $i; ?>" > Si</label></label> 
													&nbsp; <label><input type="radio" id = "segurono<?php echo $i; ?>" name = "seguro<?php echo $i; ?>" /><label for="segurono<?php echo $i; ?>" id = "labelno<?php echo $i; ?>" > No</label></label>
													<script>
														var sino = '<?php echo $_REQUEST["seguro$i"]; ?>';
														//alert(sino);
														if(sino == 1){
											...
											<br>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>No. de Poliza:</label> </div>
												<div class="col-lg-6">
													<input class="form-control" type="text" id = "poliza<?php echo $i; ?>" name = "poliza<?php echo $i; ?>" value="<?php echo $_REQUEST["poliza$i"]; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Aseguradora:</label> </div>
												<div class="col-lg-6">
													<input class="form-control" type="text" id = "aseguradora<?php echo $i; ?>" name = "aseguradora<?php echo $i; ?>" value="<?php echo $_REQUEST["aseguradora$i"]; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Plan:</label> </div>
												<div class="col-lg-6">
													<input class="form-control" type="text" id = "plan<?php echo $i; ?>" name = "plan<?php echo $i; ?>" value="<?php echo $_REQUEST["plan$i"]; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Asegurado Principal:</label> </div>
												<div class="col-lg-6">
													<input class="form-control" type="text" id = "asegurado<?php echo $i; ?>" name = "asegurado<?php echo $i; ?>" value="<?php echo $_REQUEST["asegurado$i"]; ?>" onkeyup="texto(this);" />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Instrucciones:</label> </div>
												<div class="col-lg-6">
													<textarea class="form-control" id = "instrucciones<?php echo $i; ?>" name = "instrucciones<?php echo $i; ?>" onkeyup="texto(this);" ><?php echo $_REQUEST["instrucciones$i"]; ?></textarea>
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Comentarios:</label> </div>
												<div class="col-lg-6">
													<textarea class="form-control" id = "comentarios<?php echo $i; ?>" name = "comentarios<?php echo $i; ?>" onkeyup="texto(this);" ><?php echo $_REQUEST["comentarios$i"]; ?></textarea>
												</div>
											</div>
										</div>
									</div>
                        ...
                        <div class="wizard-actions">
                            <a href="FRMpaso1C.php" class="btn-glow primary btn-prev"> 
                                <i class="fa fa-chevron-left"></i> Antes
                            </a>
                            <button type="button" class="btn-glow primary" onclick="ActualizaSeguro();">
