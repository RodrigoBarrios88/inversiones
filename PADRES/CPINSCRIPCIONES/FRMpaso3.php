		...
		<ul id="dashboard-menu">
			...
			<li class="active">
                ...
                <ul class="submenu" style="display: block;">
                    ...
                    <li><a href="FRMpaso3.php"> <label>Paso # 3</label></a></li>
		...
		<div class="container-fluid">
            <div id="pad-wrapper">
                <div class="row-fluid head">
                    ...
                    <div class="span12">
                        <h3>PASO # 3:</h3>
						<h5>Solicitud de Verificaci&oacute;n de Datos para Validar el Contrato</h5>
					</div>
                </div>
				<hr><br>
                <div class="row-fluid">
                    <div class="panel panel-default">
						...
						<div class="panel-body">
							<?php echo tabla_hijos_verificacion($dpi); ?>
						</div>
					</div>	
                </div>
            </div>
