...
<body>
		...
		<ul id="dashboard-menu">
			...
			<li class="active">
                ...
                <ul class="submenu" style="display: block;">
                    <li><a href="FRMpaso1.php"> Paso # 1</a></li>
                    <li><a href="FRMpaso2.php"> Paso # 2</a></li>
                    <li><a href="FRMpaso3.php"> Paso # 3</a></li>
                    <li><a href="FRMpaso4.php"> <label>Paso # 4</label></a></li>
                </ul>
            </li>
		...
		<div class="container-fluid">
            <div id="pad-wrapper">
                <div class="row-fluid head">
                    ...
                    <div class="span12">
                        <h3>PASO # 4:</h3>
						<h5>Impresi&oacute;n de Contrato</h5>
					</div>
                </div>
				<hr><br>
                <div class="row-fluid">
                    <div class="panel panel-default">
						<div class="panel-heading"> 
							<h5><i class="icon-users"></i> Listado de Hijos</h5>
						</div>
						<div class="panel-body">
							<div class="alert alert-info alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                Al ser aprobada la informaci&oacute;n registrada para contrato, por favor dar "click" al bot&oacute;n azul para visualizar e imprimir el contrato, luego <b>debe ser FIRMADO y entregado en el colegio, con los documentos requeridos adjuntos</b></a>.
                            </div>
							<?php echo tabla_hijos_contrato($dpi); ?>
						</div>
					</div>	
                </div>
            </div>
    ...
    <script type="text/javascript" src="../assets.3.5.20/js/modules/inscripcion/pasos2a4.js"></script>
