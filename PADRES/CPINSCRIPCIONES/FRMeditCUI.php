...
header("Access-Control-Allow-Origin: *");
    ...
    $cui = $ClsIns->decrypt($hashkey, $usuario);
				...
				<div class="row-fluid">
                    <div class="span12">
                                ...
                                <div class="">
									<div class="panel panel-default">
										<div class="panel-heading"> 
											<h5><i class="fa fa-edit"></i> Actualizaci&oacute;n de CUI</h5>
										</div>
										<div class="panel-body">
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>CUI registrado:</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													<input type="text" class="form-info" id = "cui" name = "cui" value="<?php echo $cui; ?>" readonly />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Tipo de ID:</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													<input type="text" class="form-info" id = "tipocui" name = "tipocui" value="<?php echo $tipocui; ?>" readonly />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Nombres:</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													<input class="form-info" type="text" id = "nombre" name = "nombre" value="<?php echo $nombre; ?>" readonly />
												</div>
											</div>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Apellidos:</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													<input class="form-info" type="text" id = "apellido" name = "apellido" value="<?php echo $apellido; ?>" readonly />
												</div>
											</div>
											<hr>
											<div class = "row">
												<div class="col-lg-4 col-md-offset-1"><label>Nuevo CUI a registrar:</label> <span class = "text-danger">*</span></div>
												<div class="col-lg-6">
													<input class="form-control" type="text" id = "cuinew" name = "cuinew" onkeyup="enteros(this);" onblur = "CompareCuiBloqueado('');" />
												</div>
											</div>
										</div>
									</div>
                        ...
                        <div class="wizard-actions">
                            <a <a href="FRMpaso1B.php" class="btn-glow default"> 
                                <i class="fa fa-times"></i> Cancelar
                            </a>
                            <button type="button" class="btn-glow primary" id="btnnext" onclick="CambiaCUI();">
                                Cambiar <i class="fa fa-save"></i>
                            </button>
                        </div>
                    </div>
                </div>
