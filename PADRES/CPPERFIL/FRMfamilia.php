                ...
                <div class="col-md-9 personal-info">
					...
					<div class="row">
						...
						<div class="col-lg-6 text-right">
							<a class="btn-glow primary pull-right" href = "FRMnew-user.php" title = "+ Agregar familiar"><i class="fa fa-plus"></i> Agregar Familiar</a>
						</div>
					</div>
					<br>
					<div class="panel panel-default">
						<div class="panel-heading"> 
							<h5><span class="fa fa-group" aria-hidden="true"></span> Listado de hijos con familiares o responsables registrados</label></h5>
						</div>
