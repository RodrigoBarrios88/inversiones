                ...
                <div class="col-lg-9 personal-info">
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<div class = "row">
								<div class="col-lg-6">
									<h4 class="text-success"><i class="fas fa-users"></i> Hijos</h4>
								</div>
								<div class="col-lg-6 text-right">
									<a class="btn btn-default" href="../CPHIJOS/FRMhijos.php" ><i class="fas fa-pencil-alt"></i> Actualizar Datos de Hijos</a>
								</div>
							</div>
							<?php echo tabla_hijos_mod($dpi); ?>
							<hr>
