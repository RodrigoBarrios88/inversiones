...
/////////////////////////////  RESPUESTA DE EXAMENES ACADEMICOS  //////////////////////////////////////
	...
	function insert_respuesta($examen,$pregunta,$alumno,$tipo,$ponderacion,$respuesta,$puntos){
        $respuesta = trim($respuesta);
		
		$sql = "INSERT INTO academ_examen_respuestas";
		$sql.= " VALUES ('$examen','$pregunta','$alumno','$tipo','$ponderacion','$respuesta','$puntos')";
		$sql.= " ON DUPLICATE KEY UPDATE resp_ponderacion = '$ponderacion', resp_respuesta = '$respuesta', resp_puntos = '$puntos'; ";
		//echo $sql;
		return $sql;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	function get_resolucion_examen_archivo($codigo,$examen,$alumno){
		$nom = trim($nom);
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	function get_multiple2($codigo,$examen) {
	    $sql= "SELECT * ";
		$sql.= "FROM academ_examen_preguntas,academ_examen_multiple";
		$sql.= " WHERE  pre_examen=mult_examen ";
		$sql.= " AND pre_codigo = mult_codigo";
	...
	function inicio_examen($examen,$alumno){
		$fechini = date("Y-m-d H:i:s");
		$sql = "INSERT INTO academ_resolucion_examen";
		$sql.= " VALUES ($examen,'$alumno','$fechini','','0'); ";
		$sql.= " ON DUPLICATE KEY UPDATE reexa_examen = '$examen' ";
		//echo $sql;
		return $sql;
	}
	
	function fin_examen($examen,$alumno){
		$fechfin = date("Y-m-d H:i:s");
		$sql = "UPDATE academ_resolucion_examen SET ";
		$sql.= "reexa_fecha_entrega = '$fechfin',"; 
		$sql.= "reexa_situacion = 1"; 
		
		$sql.= " WHERE reexa_examen = $examen";
		$sql.= " AND reexa_alumno = '$alumno'; "; 	
		//echo $sql;
		return $sql;
	}
