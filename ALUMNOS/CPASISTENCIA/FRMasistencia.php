...
<body onload="Lista_Multiple();">
	  ...
	  <div id = "ModalDialog" class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
			<h4 class="modal-title text-left" id="myModalLabel"><img src="../images/escudo.png" width = "40px;" /> ASMS</h4>
	      </div>
    ...
    <!-- Custom Theme JavaScript -->
    <script type="text/javascript" src="../js/core/ejecutaModal.js"></script>
