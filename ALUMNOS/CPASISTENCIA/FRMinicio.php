...
<body>
			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 
						<h5><span class="icon-asms icon-2x" aria-hidden="true"></span> </label></h5>
					</div>
					<div class="panel-body">
						<br>
						<p class="text-center"> Seleccione la opci&oacute;n de Asistencia</p>
						<hr>
						<div class = "row">
							<div class="col-md-6 text-center">
								<a class="btn btn-default" href="FRMdetalle_asistencia_materias.php"><i class="fa fa-flask fa-5x"></i></a>
								<h5>Revisar Asistencia de Clases Regulares</h5>
							</div>
							<div class="col-md-6 text-center">
								<a class="btn btn-default" href="FRMdetalle_asistencia_cursos.php"><i class="fa fa-book fa-5x"></i></a>
								<h5>Revisar Asistencia de Cursos Libres</h5>
							</div>
							<!--div class="col-md-4 text-center">
								<a class="btn btn-default" href="FRMreservar_cursos.php"><i class="fa fa-clock-o fa-5x"></i></a>
								<h5>Reservar Cupo en Cursos Libres</h5>
							</div-->
						</div>
						<br>
					</div>
    ...
    <script type="text/javascript" src="../js/modules/notas/notas.js"></script>
