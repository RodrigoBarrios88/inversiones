<?php
	...
	if(is_array($result)){
		foreach($result as $row){
            ...
            $nombres = ucwords(strtolower($nombre." ".$apellido));
			//
	...
	if($diferencia <= 0){
		...
		if($anio_actual == $anio_periodo){
			...
			if($fecha_programdo < $hoy){
				...
				$diferencia = $mons ." ".number_format($diferencia, 2);
				$solvencia = '<h6 class="alert alert-default text-center">';
			    $solvencia.= 'Visualizacion de Notas Pendientes';
							...
							<div class = "row">
								<div class = "col-md-12">
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation" class="active"><a href="#unidades" aria-controls="unidades" role="tab" data-toggle="tab"><label><i class="fa fa-paste"></i>  &nbsp; Notas por Unidades</label></a></li>
										<li role="presentation"><a href="#materias" aria-controls="materias" role="tab" data-toggle="tab"><label><i class="fa fa-paste"></i>  &nbsp; Notas Por Materias</label></a></li>
									</ul>
									<!-- TABS -->
									<div class="tab-content">
										<!--br><h5 class="alert alert-info text-center"><i class="fa fa-info-circle"></i> Pendientes de P&uacute;blicar...</h5-->
										<!---- POR UNIDADES -->
										<div role="tabpanel" class="tab-pane active col-md-12" id="unidades">
											<br>
											<div class="panel-group" id="accordion">
												<div class="panel panel-default">
													...
													<div id="collapse1" class="panel-collapse collapse in">
														<div class="panel-body">
															<?php
																if($solvente == true){
																	echo lista_notas_por_unidad($cui,1);
																}else{
																	echo $solvencia;
																}
															?>
												...
												<div class="panel panel-default">
													...
													<div id="collapse2" class="panel-collapse collapse">
														<div class="panel-body">
															<?php
																if($solvente == true){
																	echo lista_notas_por_unidad($cui,2);
																}else{
																	echo $solvencia;
																}
															?>
												...
												<div class="panel panel-default">
													...
													<div id="collapse3" class="panel-collapse collapse">
														<div class="panel-body">
															<?php
																if($solvente == true){
																	echo lista_notas_por_unidad($cui,3);
																}else{
																	echo $solvencia;
																}
															?>
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<h6 class="panel-title">
															<a data-toggle="collapse" data-parent="#accordion" href="#collapse4" title="Click para ver detalle">
																4. Cuarta Unidad
															</a>
														</h6>
													</div>
													<div id="collapse4" class="panel-collapse collapse">
														<div class="panel-body">
															<?php
																if($solvente == true){
																	echo lista_notas_por_unidad($cui,4);
																}else{
																	echo $solvencia;
																}
															?>
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<h6 class="panel-title">
															<a data-toggle="collapse" data-parent="#accordion" href="#collapse5" title="Click para ver detalle">
																5. Quinta Unidad
															</a>
														</h6>
													</div>
													<div id="collapse5" class="panel-collapse collapse">
														<div class="panel-body">
															<?php
																if($solvente == true){
																	echo lista_notas_por_unidad($cui,5);
																}else{
																	echo $solvencia;
																}
															?>
										...
										<div role="tabpanel" class="tab-pane" id="materias">
											<?php
												if($solvente == true){
													echo lista_notas_por_materia($cui);
												}else{
													echo $solvencia;
												}
											?>
