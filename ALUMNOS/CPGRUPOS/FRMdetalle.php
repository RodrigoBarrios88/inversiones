...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           <div class="col-md-3">
                <p class="lead"><i class="fa fa-paste"></i> Grupo</p>
                <div class="list-group">
					<a href="#" class="list-group-item active"><i class="fa fa-flask"></i> Informaci&oacute;n del Grupo</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
				<div class="well">
				    <div class="row">
				        <div class="col-md-6">
				            <h4 class="alert alert-info"><?php echo $grupo_descripcion; ?></h4>
    						<label>Maestro:</label>
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<?php //echo lista_notas($cui,$pensum,$nivel,$grado,$seccion,$materia); ?>
