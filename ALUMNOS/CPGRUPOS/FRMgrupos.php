...
<body>
			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 
						<h5><i class="fas fa-file-invoice"></i> Grupos donde est&aacute; asignado <?php echo $nombres; ?></label></h5>
					</div>
    ...
    <script type="text/javascript" src="../assets.3.5.20/js/modules/grupos/grupos.js"></script>
