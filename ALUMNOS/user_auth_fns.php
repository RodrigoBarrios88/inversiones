			...
			<div class="wrap-login100">
               ...
               ?>
                  <h4 class="text-orange w-full text-center" role="alert">
                     Su usuario no pertenece al grupo de <b>Alumnos</b>,<br>Por favor ingrese desde el portal del colegio... <br>
                     <a href="../ROOT/"> <i class="fa fa-desktop"></i> Ir a la p&aacute;gina principal</a>
                  </h4>
               <?php
                  }	
               ?>
