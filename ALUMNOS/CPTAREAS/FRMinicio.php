			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<br>
						<p class="text-center"> Seleccione la opci&oacute;n de LMS (Learning Management System) a consultar</p>
						<hr>
						<div class = "row">
							<div class="col-md-5 col-md-offset-1 text-center">
								<a class="btn btn-default" href="FRMtareas_materias.php"><i class="fa fa-flask fa-5x"></i></a>
								<h5>Materias</h5>
							</div>
							<div class="col-md-5 text-center">
								<a class="btn btn-default" href="FRMtareas_cursos.php" ><i class="fa fa-book fa-5x"></i></a>
								<h5>Cursos Libres</h5>
							</div>
						</div>
						<br>
