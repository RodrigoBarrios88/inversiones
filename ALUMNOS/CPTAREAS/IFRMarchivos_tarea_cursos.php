									...
									<div class="panel panel-default">
										...
										<div class="panel-footer">
											<div class="pull-right">
												...
												<a  class="btn btn-primary btn-xs" href="EXEdownload_archivo_tarea_curso.php?archivo=<?php echo $arrdoc[$i]["archivo"]; ?>" title="Descargar Archivo"><i class="fas fa-file-download"></i></a>
											</div>
									...
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<div>
												...
												<a class="btn btn-primary btn-xs" role="button" disabled ><i class="fas fa-file-download"></i></a>
											</div>
										</div>
									</div>
								</div>
