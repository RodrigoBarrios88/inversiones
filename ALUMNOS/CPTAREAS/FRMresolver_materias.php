			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 
						<h5><i class="fas fa-file-signature"></i> Resolver Tarea de Materias</h5>
					</div>
					...
					<div class="panel-body">
						...
						<?php
							if($tipo == "OL"){ /// Requiere respuesta Online
								$result = $ClsTar->get_respuesta_directa($codigo,$tipo_codigo);
								if(is_array($result)){
									foreach($result as $row){
						...
						<div class="row">
							...
							<div class="col-md-3">
								<a class="btn btn-default btn-block" href = "IFRMarchivos_tarea.php?tarea=<?php echo $codigo; ?>&alumno=<?php echo $tipo_codigo; ?>" target = "_blank" title="Ver Documentos Cargados" ><i class="fa fa-search"></i> <i class="fas fa-file-pdf-o"></i> Ver</a>
							</div>
						</div>
						<br>
						<div class="row">
						<?php
							$result = $ClsTar->get_respuesta_tarea_archivo('',$codigo,$tipo_codigo,'');
							$cantidad = 0;
							$salida = "";
							if(is_array($result)){
								foreach($result as $row){
									...
									$salida.='<div class="col-md-1">';
										$salida.='<a class="btn btn-default" href="EXEdownload_archivo_tarea.php?archivo='.$archivo.'" class="btn btn-default btn-xs" title = "Descargar Archivo"><i class="fas fa-file-download"></i></a>';
									$salida.='</div>';
									$salida.='<div class="col-md-1">';
