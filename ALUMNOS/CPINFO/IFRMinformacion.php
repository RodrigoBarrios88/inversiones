        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="../CPTEST/FRMinicio.php" class="list-group-item"><i class="fas fa-thumbtack"></i> Pin Board</a>
                ...
                <div class="thumbnail">
					<div class="caption-full">
                        <h4 class="alert alert-info">
							<i class="fas fa-calendar"></i> Calendarizaci&oacute;n de Actividades
						</h4>
					
						<?php
							//////////////////////////////////////// GENERAL ///////////////////////////////////////////
							$result = $ClsInfo->get_informacion("","","0","");
							if(is_array($result)){
								foreach($result as $row){
									$cod = $row["inf_codigo"];
									$usu = $_SESSION["codigo"];
							...
							//////////////////////////////////////// GRADOS Y SECCIONES ///////////////////////////////////////////
							$result = $ClsInfo->get_det_informacion_secciones('',$pensum,$info_nivel,$info_grado,$info_seccion);
							if(is_array($result)){
								foreach($result as $row){
									$cod = $row["inf_codigo"];
									$usu = $_SESSION["codigo"];
							...
							//////////////////////////////////////// GRUPOS ///////////////////////////////////////////
							$result = $ClsInfo->get_det_informacion_grupos('',$info_grupo);
							if(is_array($result)){
								foreach($result as $row){
									$cod = $row["inf_codigo"];
									$usu = $_SESSION["codigo"];
