...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="#"><i class="fa fa-calendar"></i> Actividades</a>
					</li>
					<li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead"><i class="fas fa-calendar"></i> Actividades</p>
                <div class="list-group">
					<a href="../CPINFO/IFRMinformacion.php" class="list-group-item active"><i class="fas fa-calendar"></i> Actividades</a>
                	...
                	<a href="../CPASISTENCIA/FRMinicio.php" class="list-group-item"><i class="fas fa-check-square"></i> Asistencia</a>
