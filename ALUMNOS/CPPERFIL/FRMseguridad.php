    ...
    <header class="navbar navbar-inverse" role="banner">
        ...
        <nav class="collapse navbar-collapse" role="navigation">
            <ul class="nav navbar-nav">
				...
				<li class="active"><a href="FRMseguridad.php"><i class="fas fa-shield-alt"></i> Seguridad</a></li>
        ...
        <div class="settings-wrapper" id="pad-wrapper">
            <div class="row">
                ...
                <div class="col-md-9 personal-info">
					<h5 class="personal-title"><i class="fas fa-shield-alt"></i> Bloqueo del App en Dispositivos (Seguridad)</h5>
					<div class="row">
						<div class="col-lg-6">
					...
					<div class="panel panel-default">
						<div class="panel-heading"> 
							<i class="fa fa-mobile fa-2x"></i> Listado de Tel&eacute;fonos y Tablets Asociados al App
						</div>
						<div class="panel-body">
							<div class = "row">
								<div class="col-md-12 text-center">
									<?php echo tabla_telefonos($dpi); ?>
								</div>
							</div>
						</div>
					</div>
