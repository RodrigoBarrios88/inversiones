...
///////// Pregunta Clave /////////////
	function ModificarPerfil(){
		...
		redesociales = document.getElementById("redsoc");
		//-- radiobutton
		...
		if(cui.value !== "" && nombre.value !== "" && apellido.value !== "" && genero.value !== "" && fecnac.value !== "" && sangre.value !== "" && emergencia.value !== "" &&
		   emetel.value !== "" && nit.value !== "" && clinombre.value !== "" && clidireccion.value !== "" && usu.value !== ""){
			////////------------------
			if(pass1.value === pass2.value){
				abrir();
				xajax_Modificar_Perfil(cui.value,tipocui.value,codigo.value,nombre.value,apellido.value,genero.value,fecnac.value,nacionalidad.value,religion.value,idioma.value,mail.value,sangre.value,alergia.value,
										emergencia.value,emetel.value,recoge.value,redesociales.value,seguro,nit.value,clinombre.value,clidireccion.value,poliza.value,asegura.value,plan.value,asegurado.value,
										instruc.value,comment.value,usuid.value,nompant.value,usu.value,pass1.value,preg.value,resp.value);
			}else{
				pass1.className = " form-danger";
				pass2.className = " form-danger";
				swal("Ohoo!", "Contrase\u00F1a y la Confirmaci\u00F3n no son iguales...", "error");
			}
		}else{
			if(cui.value ===""){
