$(function () {
  ...
  $(window).resize(function() { 
    ...
    $(this).width() > 769 && $("#second-menu").removeClass("hidden-menu");  
    $(this).width() > 769 && $("#second-menu").toggleClass("collapse");  
  })
  
  
  // mobile second-menu slide
  /*var $menu = $("#second-menu-toggler");
  
  $("#second-menu").click(function () {
    alert("entro1");
    if ($(this).hasClass("nav navbar-nav pull-right hidden-menu")) {
      $(this).removeClass("nav navbar-nav pull-right hidden-menu");
    }
  });
  ...
  $("#second-menu").click(function (e) {
    alert("entro2");
    e.stopPropagation();
    $("#second-menu").toggleClass("nav navbar-nav pull-right");
  });*/
