					...
					<div class="panel-body">
						...
						<div class = "row">
							<div class="col-md-5 col-md-offset-1 text-center">
								<a class="btn btn-default" href="FRMexamen_materias.php"><i class="fa fa-flask fa-5x"></i></a>
								<h5>Materias</h5>
							</div>
							<div class="col-md-5 text-center">
								<a class="btn btn-default" href="FRMexamen_cursos.php" ><i class="fa fa-book fa-5x"></i></a>
								<h5>Cursos Libres</h5>
							</div>
						</div>
						<br>
