			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 
						<h5><i class="icon-spell-check"></i> Ex&aacute;menes o Evaluaciones de Cursos Libres</h5>
					</div>
					<div class="panel-body">
						<form id='f1' name='f1' method='get'>
							<div class="row">
								<div class="col-md-4"><label>Curso:</label></div>
								<div class="col-md-4"><label>Sede:</label></div>
								<div class="col-md-4"><label>T&iacute;po de Resoluci&oacute;n:</label></div>
							</div>
							<div class="row">
								<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<a href="javascript:void(0);" onclick="OrderBy('ASC');"><i class="fa fa-sort-up"></i> Ascendente</a>
								</div>
								<div class="col-md-2">
									<a href="javascript:void(0);" onclick="OrderBy('DESC');"><i class="fa fa-sort-down"></i> Descendente</a>
								</div>
							</div>
						</form>
						<?php
