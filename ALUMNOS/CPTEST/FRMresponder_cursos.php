...
<body>
			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
						<?php
							$result = $ClsExa->get_resolucion_examen_archivo_curso('',$examen,$tipo_codigo,'');
							$cantidad = 0;
							$salida = "";
							if(is_array($result)){
								foreach($result as $row){
									...
									$salida.='<div class="col-md-1">';
										$salida.='<a href="EXEdownload_archivo_examen_curso.php?archivo='.$archivo.'" class="btn btn-default" title = "Descargar Archivo"><i class="fas fa-file-download"></i></a>';
									$salida.='</div>';
									$salida.='<div class="col-md-1">';
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<button type="button" class="btn btn-success" id = "btn-grabar" onclick="FinalizarExamen();" <?php echo $disabled; ?> ><i class="fa fa-check"></i> Listo !</button> &nbsp; 
	...
	<script type="text/javascript" src="../assets.3.5.20/js/modules/lms/examencurso.js"></script>
