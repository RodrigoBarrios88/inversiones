			...
			<div class="col-lg-10 col-md-offset-1">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> 
						<h5><i class="icon-spell-check"></i> Evaluaci&oacute;n</h5>
					</div>
								...
								foreach ($result as $row){
									...
									if(is_array($result_respuesta)){
										foreach ($result_respuesta as $row_respuesta){
											...
											$pregunta = utf8_decode($row_respuesta["resp_pregunta"]);
									   }
				...
				<div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-paste"></i> Archivos de Resoluci&oacute;n de Evaluaciones</div>
					<div class="panel-body">
						<br>
						<div class="row">
							<div class="col-md-9">
						...
						<div class="row">
						<?php
							$result = $ClsExa->get_resolucion_examen_archivo('',$codigo,$tipo_codigo,'');
							$cantidad = 0;
							$salida = "";
							if(is_array($result)){
								foreach($result as $row){
									...
									$salida.='<div class="col-md-1">';
										$salida.='<a href="EXEdownload_archivo_examen.php?archivo='.$archivo.'" class="btn btn-default btn-xs" title = "Descargar Archivo"><i class="fas fa-file-download fa-2x"></i></a>';
									$salida.='</div>';
								}
								echo $salida;
							}
