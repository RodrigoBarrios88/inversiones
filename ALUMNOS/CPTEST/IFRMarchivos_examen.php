...
<body>
						...
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<div>
									...
									<a href="EXEdownload_archivo_tarea.php?archivo=<?php echo $arrdoc[$i]["archivo"]; ?>" class="btn btn-primary btn-xs" role="button" title="Descargar Archivo"><i class="fas fa-file-download fa-2x"></i></a>
								</div>
							</div>
						</div>
					</div>
    ...
    <script type="text/javascript" src="../js/modules/lms/examen.js"></script>
